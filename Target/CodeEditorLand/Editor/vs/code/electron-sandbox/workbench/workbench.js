(function(){let u=b();performance.mark("code/didStartRenderer"),u.load(["vs/workbench/workbench.desktop.main","vs/css!vs/workbench/workbench.desktop.main"],function(e,o){return performance.mark("code/didLoadWorkbenchMain"),e.main(o)},{configureDeveloperSettings:function(e){return{forceDisableShowDevtoolsOnError:typeof e.extensionTestsPath=="string"||e["enable-smoke-test-driver"]===!0,forceEnableDeveloperKeybindings:Array.isArray(e.extensionDevelopmentPath)&&e.extensionDevelopmentPath.length>0,removeDeveloperKeybindingsAfterLoad:!0}},canModifyDOM:function(e){B(e)},beforeLoaderConfig:function(e){e.recordStats=!0},beforeRequire:function(e){performance.mark("code/willLoadWorkbenchMain"),Object.defineProperty(window,"vscodeWindowId",{get:()=>e.windowId}),window.requestIdleCallback(()=>{let o=document.createElement("canvas");o.getContext("2d")?.clearRect(0,0,o.width,o.height),o.remove()},{timeout:50})}});function b(){return window.MonacoBootstrapWindow}function B(e){performance.mark("code/willShowPartsSplash");let o=e.partsSplash;o&&(e.autoDetectHighContrast&&e.colorScheme.highContrast?(e.colorScheme.dark&&o.baseTheme!=="hc-black"||!e.colorScheme.dark&&o.baseTheme!=="hc-light")&&(o=void 0):e.autoDetectColorScheme&&(e.colorScheme.dark&&o.baseTheme!=="vs-dark"||!e.colorScheme.dark&&o.baseTheme!=="vs")&&(o=void 0)),o&&e.extensionDevelopmentPath&&(o.layoutInfo=void 0);let a,s,l;o?(a=o.baseTheme,s=o.colorInfo.editorBackground,l=o.colorInfo.foreground):e.autoDetectHighContrast&&e.colorScheme.highContrast?e.colorScheme.dark?(a="hc-black",s="#000000",l="#FFFFFF"):(a="hc-light",s="#FFFFFF",l="#000000"):e.autoDetectColorScheme&&(e.colorScheme.dark?(a="vs-dark",s="#1E1E1E",l="#CCCCCC"):(a="vs",s="#FFFFFF",l="#000000"));let n=document.createElement("style");if(n.className="initialShellColors",document.head.appendChild(n),n.textContent=`body {
			...
			`),d.appendChild(c),r.titleBarBorder&&t.titleBarHeight>0){let i=document.createElement("div");i.setAttribute("style",`
					position: absolute;
					width: 100%;
					height: 1px;
					left: 0;
				...
				`),c.appendChild(i)}let h=document.createElement("div");if(h.setAttribute("style",`
				position: absolute;
			...
			`),d.appendChild(h),r.activityBarBorder&&t.activityBarWidth>0){let i=document.createElement("div");i.setAttribute("style",`
					position: absolute;
					width: 1px;
					height: 100%;
					top: 0;
				...
				`),h.appendChild(i)}if(e.workspace){let i=document.createElement("div");if(i.setAttribute("style",`
					position: absolute;
				...
				`),d.appendChild(i),r.sideBarBorder&&t.sideBarWidth>0){let m=document.createElement("div");m.setAttribute("style",`
						position: absolute;
						width: 1px;
						height: 100%;
						top: 0;
					...
					`),i.appendChild(m)}}let p=document.createElement("div");if(p.setAttribute("style",`
				position: absolute;
				width: 100%;
			...
			`),d.appendChild(p),r.statusBarBorder&&t.statusBarHeight>0){let i=document.createElement("div");i.setAttribute("style",`
					position: absolute;
					width: 100%;
					height: 1px;
					top: 0;
