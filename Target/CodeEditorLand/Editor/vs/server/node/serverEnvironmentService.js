...
const IServerEnvironmentService = refineServiceDecorator(IEnvironmentService);
class ServerEnvironmentService extends NativeEnvironmentService {
  static {
    __name(this, "ServerEnvironmentService");
  }
...
__decorateClass([
  memoize
], ServerEnvironmentService.prototype, "userRoamingDataHome", 1);
export {
