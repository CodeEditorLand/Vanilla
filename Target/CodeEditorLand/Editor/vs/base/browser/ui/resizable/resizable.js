...
class ResizableHTMLElement {
  ...
  constructor() {
    ...
    this._eastSash = new Sash(
      this.domNode,
      { getVerticalSashLeft: /* @__PURE__ */ __name(() => this._size.width, "getVerticalSashLeft") },
      { orientation: Orientation.VERTICAL }
    );
    this._westSash = new Sash(
      this.domNode,
      { getVerticalSashLeft: /* @__PURE__ */ __name(() => 0, "getVerticalSashLeft") },
      { orientation: Orientation.VERTICAL }
    );
    this._northSash = new Sash(
      this.domNode,
      { getHorizontalSashTop: /* @__PURE__ */ __name(() => 0, "getHorizontalSashTop") },
      {
    ...
    this._southSash = new Sash(
      this.domNode,
      { getHorizontalSashTop: /* @__PURE__ */ __name(() => this._size.height, "getHorizontalSashTop") },
      {
        orientation: Orientation.HORIZONTAL,
