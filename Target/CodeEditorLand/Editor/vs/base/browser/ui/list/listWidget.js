...
class DefaultStyleController {
  ...
  style(styles) {
    ...
    if (styles.listActiveSelectionIconForeground) {
      content.push(
        `@layer monaco-list { .monaco-list${suffix}:focus .monaco-list-row.selected .codicon { color: ${styles.listActiveSelectionIconForeground}; } }`
      );
    }
    ...
    if (styles.listInactiveSelectionIconForeground) {
      content.push(
        `@layer monaco-list { .monaco-list${suffix} .monaco-list-row.focused .codicon { color:  ${styles.listInactiveSelectionIconForeground}; } }`
      );
    }
