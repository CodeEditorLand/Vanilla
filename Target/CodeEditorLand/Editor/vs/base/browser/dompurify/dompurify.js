...
const getGlobal = /* @__PURE__ */ __name(() => typeof window === "undefined" ? null : window, "getGlobal");
...
function createDOMPurify() {
  ...
  const _parseConfig = /* @__PURE__ */ __name(function _parseConfig2(cfg) {
  ...
  const _createIterator = /* @__PURE__ */ __name(function _createIterator2(root) {
  ...
  const _isValidAttribute = /* @__PURE__ */ __name(function _isValidAttribute2(lcTag, lcName, value) {
    ...
    if (ALLOW_DATA_ATTR && !FORBID_ATTR[lcName] && regExpTest(DATA_ATTR2, lcName)) ;
      ...
      if (
        ...
        _basicCustomElementTest(lcTag) && (CUSTOM_ELEMENT_HANDLING.tagNameCheck instanceof RegExp && regExpTest(
  ...
  const _basicCustomElementTest = /* @__PURE__ */ __name(function _basicCustomElementTest2(tagName) {
