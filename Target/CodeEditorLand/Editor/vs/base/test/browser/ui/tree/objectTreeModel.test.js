...
suite("ObjectTreeModel", () => {
  ...
  test("collapse state is preserved with strict identity", () => {
    ...
    assert.deepStrictEqual(toArray(list), ["father", "child"]);
    const data2 = [
      { element: "father", children: [{ element: "child" }] },
      { element: "uncle" }
    ];
  ...
  test("sorter", () => {
    ...
    const data = [
      ...
      {
        element: "airplanes",
        children: [{ element: "passenger" }, { element: "jet" }]
      },
      {
        element: "bicycles",
        children: [
        ...
        children: [
          {
            element: 10,
            children: [
              { element: 100, children: [{ element: 1e3 }] }
            ]
          },
          { element: 11 },
          { element: 12 }
  ...
  test("issue #95641", async () => {
    ...
    const disposable = bindListToModel(list, model);
    model.setChildren(null, [
      { element: "file", children: [{ element: "hello" }] }
    ]);
