...
import {
  ...
  ObjectTree
} from "../../../../browser/ui/tree/objectTree.js";
...
function getRowsTextContent(container) {
  ...
  rows.sort(
    (a, b) => Number.parseInt(a.getAttribute("data-index")) - Number.parseInt(b.getAttribute("data-index"))
  );
  return rows.map(
...
suite("ObjectTree", () => {
  ...
  test("traits are preserved according to string identity", () => {
    const container = document.createElement("div");
    container.style.width = "200px";
    container.style.height = "200px";
  ...
  test.skip("swap model TreeError uses updated user", () => {
    const container = document.createElement("div");
    container.style.width = "200px";
    container.style.height = "200px";
    const delegate = new Delegate();
...
suite("CompressibleObjectTree", () => {
  ...
  test("swapModel", () => {
    ...
    const newModel = new CompressibleObjectTreeModel(
      "test",
      {}
    );
    newModel.setChildren(null, [
