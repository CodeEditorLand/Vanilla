...
suite("Grid", function() {
  ...
  test("hasMaximizedView", function() {
    ...
    __name(checkIsMaximized, "checkIsMaximized");
...
class TestSerializableView extends TestView {
  ...
  static {
    __name(this, "TestSerializableView");
  }
  toJSON() {
...
class TestViewDeserializer {
  ...
  static {
    __name(this, "TestViewDeserializer");
  }
...
__name(nodesToNames, "nodesToNames");
    ...
    const deserializer = new class {
      fromJSON() {
        const view = {
          ...
          layout: /* @__PURE__ */ __name(() => null, "layout"),
          minimumWidth: 0,
