...
suite("keyCodes", () => {
  ...
  test("mapping for Minus", () => {
    ...
    assert.strictEqual(
      NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE["VK_OEM_MINUS"],
      KeyCode.Minus
    );
    assert.strictEqual(
      ScanCodeUtils.lowerCaseToEnum("minus"),
      ScanCode.Minus
    );
    ...
    assert.strictEqual(
      IMMUTABLE_CODE_TO_KEY_CODE[ScanCode.Minus],
      KeyCode.DependsOnKbLayout
    );
    assert.strictEqual(
      IMMUTABLE_KEY_CODE_TO_CODE[KeyCode.Minus],
      ScanCode.DependsOnKbLayout
    );
    ...
    assert.strictEqual(
      KeyCodeUtils.toUserSettingsGeneral(KeyCode.Minus),
      "OEM_MINUS"
    );
    assert.strictEqual(KeyCodeUtils.fromUserSettings("-"), KeyCode.Minus);
    assert.strictEqual(
      KeyCodeUtils.fromUserSettings("OEM_MINUS"),
      KeyCode.Minus
    );
    assert.strictEqual(
      KeyCodeUtils.fromUserSettings("oem_minus"),
  ...
  test("mapping for Space", () => {
    ...
    assert.strictEqual(
      NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE["VK_SPACE"],
      KeyCode.Space
    );
    assert.strictEqual(
      ScanCodeUtils.lowerCaseToEnum("space"),
      ScanCode.Space
    );
    ...
    assert.strictEqual(
      IMMUTABLE_CODE_TO_KEY_CODE[ScanCode.Space],
      KeyCode.Space
    );
    assert.strictEqual(
    ...
    assert.strictEqual(
      KeyCodeUtils.toUserSettingsUS(KeyCode.Space),
      "Space"
    );
    assert.strictEqual(
      KeyCodeUtils.toUserSettingsGeneral(KeyCode.Space),
      "Space"
    );
    assert.strictEqual(
      KeyCodeUtils.fromUserSettings("Space"),
      KeyCode.Space
    );
    assert.strictEqual(
      KeyCodeUtils.fromUserSettings("space"),
