...
suite("TwoKeyMap", () => {
  ...
  test("set and get", () => {
    ...
    assert.strictEqual(map.get("a", "d"), void 0);
  });
  test("clear", () => {
    const map = new TwoKeyMap();
    map.set("a", "b", 1);
    ...
    map.set("b", "c", 3);
    map.clear();
    assert.strictEqual(map.get("a", "b"), void 0);
    assert.strictEqual(map.get("a", "c"), void 0);
    assert.strictEqual(map.get("b", "c"), void 0);
  });
  test("values", () => {
    const map = new TwoKeyMap();
    map.set("a", "b", 1);
...
suite("ThreeKeyMap", () => {
  ...
  test("set and get", () => {
    ...
    assert.strictEqual(map.get("a", "d", "e"), void 0);
  });
  test("clear", () => {
    const map = new ThreeKeyMap();
    map.set("a", "b", "c", 1);
    ...
    map.set("b", "c", "e", 3);
    map.clear();
    assert.strictEqual(map.get("a", "b", "c"), void 0);
    assert.strictEqual(map.get("a", "c", "d"), void 0);
    assert.strictEqual(map.get("b", "c", "e"), void 0);
  });
  test("values", () => {
    const map = new ThreeKeyMap();
    map.set("a", "b", "c", 1);
