...
suite("Glob", () => {
  ...
  __name(assertGlobMatch, "assertGlobMatch");
  ...
  __name(assertNoGlobMatch, "assertNoGlobMatch");
  test("simple", () => {
    let p = "node_modules";
  ...
  test("expression support (single)", function() {
    ...
    const hasSibling = /* @__PURE__ */ __name((name) => siblings.indexOf(name) !== -1, "hasSibling");
    let expression = {
      "**/*.js": {
        when: "$(basename).ts"
      }
  ...
  __name(testOptimizationForBasenames, "testOptimizationForBasenames");
  ...
  __name(testOptimizationForPaths, "testOptimizationForPaths");
  function nativeSep(slashPath) {
    return slashPath.replace(/\//g, sep);
  }
  __name(nativeSep, "nativeSep");
  ...
  test("expression fails when siblings use promises (https://github.com/microsoft/vscode/issues/146294)", async function() {
    ...
    const hasSibling = /* @__PURE__ */ __name((name) => Promise.resolve(siblings.indexOf(name) !== -1), "hasSibling");
    const expression = {
