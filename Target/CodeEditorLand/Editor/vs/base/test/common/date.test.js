...
suite("Date", () => {
  ...
  suite("fromNow", () => {
    ...
    test("useFullTimeWords", () => {
      strictEqual(fromNow(Date.now() - 35e3), "35 secs");
      strictEqual(
        fromNow(Date.now() - 35e3, void 0, false),
        "35 secs"
      );
      strictEqual(
        fromNow(Date.now() - 35e3, void 0, true),
        "35 seconds"
      );
    });
    test("disallowNow", () => {
      ...
      strictEqual(
        fromNow(Date.now() - 5e3, void 0, void 0, false),
        "now"
      );
      strictEqual(
        fromNow(Date.now() - 5e3, void 0, void 0, true),
        "5 secs"
      );
    });
  });
