...
suite("Resources", () => {
  ...
  test("joinPath", () => {
    if (isWindows) {
      ...
      assert.strictEqual(
        joinPath(URI.file("c:\\"), "/file.js").toString(),
        "file:///c%3A/file.js"
      );
      assert.strictEqual(
    ...
    assert.strictEqual(
      joinPath(URI.parse("foo://a/"), "/file.js").toString(),
      "foo://a/file.js"
    );
    assert.strictEqual(
      joinPath(URI.parse("foo://a/foo/bar/"), "./file.js").toString(),
  ...
  test("normalizePath", () => {
    if (isWindows) {
      ...
      assert.strictEqual(
        normalizePath(URI.file("/foo/./bar")).toString(),
        "file:///foo/bar"
      );
      assert.strictEqual(
        normalizePath(URI.file("/foo/.")).toString(),
        "file:///foo"
      );
      assert.strictEqual(
        normalizePath(URI.file("/foo/./")).toString(),
      ...
      assert.strictEqual(
        normalizePath(URI.file("/foo/foo/../../bar")).toString(),
        "file:///bar"
      );
      assert.strictEqual(
        normalizePath(URI.file("/foo/foo/./../../bar")).toString(),
      ...
      assert.strictEqual(
        normalizePath(URI.file("/f")).toString(),
        "file:///f"
      );
    }
    assert.strictEqual(
  ...
  test("isAbsolute", () => {
    if (isWindows) {
      ...
      assert.strictEqual(isAbsolutePath(URI.file("C:\\foo\\")), true);
      assert.strictEqual(isAbsolutePath(URI.file("bar")), true);
    } else {
  ...
  function assertRemoveTrailingSeparator(u1, expected) {
    assertEqualURI(
      removeTrailingPathSeparator(u1),
      expected,
      u1.toString()
    );
  }
  ...
  function assertRelativePath(u1, u2, expectedPath, ignoreJoin, ignoreCase) {
    ...
    if (expectedPath !== void 0 && !ignoreJoin) {
      assertEqualURI(
  ...
  test("isEqual", () => {
    ...
    assertIsEqual(fileURI, fileURI, void 0, true);
    ...
    assertIsEqual(fileURI3, fileURI3, void 0, true);
  ...
  test("isEqualOrParent", () => {
    ...
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI, fileURI),
      true,
      "1"
    );
    assert.strictEqual(extUri.isEqualOrParent(fileURI, fileURI), true, "2");
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI, fileURI2),
      true,
      "3"
    );
    assert.strictEqual(
      extUri.isEqualOrParent(fileURI, fileURI2),
      true,
      "4"
    );
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI, fileURI2b),
      true,
      "5"
    );
    assert.strictEqual(
      extUri.isEqualOrParent(fileURI, fileURI2b),
      false,
      "6"
    );
    assert.strictEqual(
      extUri.isEqualOrParent(fileURI2, fileURI),
      false,
      "7"
    );
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI2b, fileURI2),
      true,
      "8"
    );
    ...
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI3, fileURI3, true),
      true,
      "11"
    );
    assert.strictEqual(
      extUri.isEqualOrParent(fileURI3, fileURI3),
      true,
      "12"
    );
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI3, fileURI4, true),
      true,
      "13"
    );
    assert.strictEqual(
      extUri.isEqualOrParent(fileURI3, fileURI4),
      true,
      "14"
    );
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI3, fileURI, true),
      false,
      "15"
    );
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI5, fileURI5, true),
      true,
      "16"
    );
    ...
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI6, fileURI5),
      false,
      "17"
    );
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI6, fileURI6),
      true,
      "18"
    );
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI7, fileURI6),
      true,
      "19"
    );
    assert.strictEqual(
      extUriIgnorePathCase.isEqualOrParent(fileURI7, fileURI5),
      false,
      "20"
    );
  });
