...
suite("Resources", () => {
  ...
  test("relativePath", () => {
    ...
    assertRelativePath(URI.parse("foo://"), URI.parse("foo://a/b"), void 0);
    assertRelativePath(URI.parse("foo://a2/b"), URI.parse("foo://a/b"), void 0);
    assertRelativePath(URI.parse("goo://a/b"), URI.parse("foo://a/b"), void 0);
    ...
    if (isWindows) {
      ...
      assertRelativePath(URI.file("\\\\server\\share\\some\\"), URI.file("\\\\server\\share2\\some\\path"), "../../share2/some/path", true);
    } else {
  ...
  __name(assertResolve, "assertResolve");
  test("resolve", () => {
    if (isWindows) {
  ...
  __name(assertIsEqual, "assertIsEqual");
  test("isEqual", () => {
    ...
    assertIsEqual(URI.parse("foo://server"), URI.parse("foo://server/"), true, false);
