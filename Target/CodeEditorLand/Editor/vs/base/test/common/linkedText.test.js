...
suite("LinkedText", () => {
  ...
  test("parses correctly", () => {
    ...
    assert.deepStrictEqual(parseLinkedText("hello there").nodes, [
      "hello there"
    ]);
    assert.deepStrictEqual(
      parseLinkedText("Some message with [link text](http://link.href).").nodes,
      [
        "Some message with ",
    ...
    assert.deepStrictEqual(
      parseLinkedText("Some message with [link text](random stuff).").nodes,
      ["Some message with [link text](random stuff)."]
    );
    assert.deepStrictEqual(
      parseLinkedText(
        "Some message with [https link](https://link.href)."
      ).nodes,
      [
        "Some message with ",
    ...
    assert.deepStrictEqual(
      parseLinkedText("Some message with [https link](https:).").nodes,
      ["Some message with [https link](https:)."]
    );
    assert.deepStrictEqual(
      parseLinkedText("Some message with [a command](command:foobar).").nodes,
      [
        "Some message with ",
    ...
    assert.deepStrictEqual(
      parseLinkedText("Some message with [a command](command:).").nodes,
