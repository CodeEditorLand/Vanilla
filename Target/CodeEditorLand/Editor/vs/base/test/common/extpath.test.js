...
suite("Paths", () => {
  ...
  test("getRoot", () => {
    ...
    assert.strictEqual(
      extpath.getRoot("\\\\server\\share\\some\\path"),
      "//server/share/"
    );
    assert.strictEqual(
      extpath.getRoot("//server/share/some/path"),
  ...
  (isWindows ? test : test.skip)("isUNC", () => {
  ...
  test("sanitizeFilePath", () => {
    if (isWindows) {
      assert.strictEqual(
        extpath.sanitizeFilePath(".", "C:\\the\\cwd"),
        "C:\\the\\cwd"
      );
      assert.strictEqual(
        extpath.sanitizeFilePath("", "C:\\the\\cwd"),
      ...
      assert.strictEqual(
        extpath.sanitizeFilePath("C:", "C:\\the\\cwd"),
        "C:\\"
      );
      assert.strictEqual(
        extpath.sanitizeFilePath("C:\\", "C:\\the\\cwd"),
      ...
      assert.strictEqual(
        extpath.sanitizeFilePath(".", "/the/cwd"),
        "/the/cwd"
      );
      assert.strictEqual(
        extpath.sanitizeFilePath("", "/the/cwd"),
      ...
      assert.strictEqual(
        extpath.sanitizeFilePath("/folder/my.txt", "/the/cwd"),
        "/folder/my.txt"
      );
      assert.strictEqual(
        extpath.sanitizeFilePath("/folder/my", "/the/cwd"),
        "/folder/my"
      );
      assert.strictEqual(
        extpath.sanitizeFilePath("/folder/../my", "/the/cwd"),
      ...
      assert.strictEqual(
        extpath.sanitizeFilePath("my.txt", "/the/cwd"),
        "/the/cwd/my.txt"
      );
      assert.strictEqual(
        extpath.sanitizeFilePath("my.txt/", "/the/cwd"),
  ...
  test("indexOfPath", () => {
    ...
    assert.strictEqual(
      extpath.indexOfPath("/some/long/path", "/some/long", false),
      0
    );
    assert.strictEqual(
      extpath.indexOfPath("/some/long/path", "/PATH", true),
      10
    );
  });
