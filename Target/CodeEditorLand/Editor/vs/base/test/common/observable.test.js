...
suite("observables", () => {
  ...
  suite("tutorial", () => {
    ...
    test("autorun that receives deltas of signals", () => {
      ...
      const disposable = autorunHandleChanges({
        ...
        createEmptyChangeSummary: /* @__PURE__ */ __name(() => ({ msgs: [] }), "createEmptyChangeSummary"),
  ...
  suite("from event", () => {
    function init() {
      ...
      return {
        log,
        setValue: /* @__PURE__ */ __name((newValue) => {
          value = newValue;
          eventEmitter.fire();
        }, "setValue"),
        observable
  ...
  suite("waitForState", () => {
    ...
    test("derived as lazy", () => {
      ...
      const d = derivedDisposable(() => {
        ...
        return {
          dispose: /* @__PURE__ */ __name(() => log.log(`disposed ${id}`), "dispose")
        };
      });
      d.get();
...
class LoggingObservableValue extends BaseObservable {
  ...
  static {
    __name(this, "LoggingObservableValue");
  }
  value;
