...
__name(assertKinds, "assertKinds");
...
__name(assertScanError, "assertScanError");
...
__name(assertValidParse, "assertValidParse");
...
__name(assertInvalidParse, "assertInvalidParse");
function assertTree(input, expected, expectedErrors = [], options) {
  ...
  const checkParent = /* @__PURE__ */ __name((node) => {
    if (node.children) {
