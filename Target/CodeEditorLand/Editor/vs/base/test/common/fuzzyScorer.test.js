...
class ResourceAccessorClass {
  static {
    __name(this, "ResourceAccessorClass");
  }
...
class ResourceWithSlashAccessorClass {
  static {
    __name(this, "ResourceWithSlashAccessorClass");
  }
  getItemLabel(resource) {
    return basename(resource.fsPath);
  }
...
class ResourceWithBackslashAccessorClass {
  static {
    __name(this, "ResourceWithBackslashAccessorClass");
  }
  getItemLabel(resource) {
    return basename(resource.fsPath);
  }
...
__name(compareItemsByScore, "compareItemsByScore");
