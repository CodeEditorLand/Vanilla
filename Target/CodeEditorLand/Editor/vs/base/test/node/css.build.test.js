...
suite("CSSPlugin", () => {
  ...
  test("Utilities.pathOf", () => {
    ...
    assert.strictEqual(
      CSSPluginUtilities.pathOf("http://a.com/a.css"),
      "http://a.com/"
    );
    assert.strictEqual(
      CSSPluginUtilities.pathOf("https://a.com/a.css"),
      "https://a.com/"
    );
    assert.strictEqual(
      CSSPluginUtilities.pathOf("http://a.com/a/b/c.css"),
      "http://a.com/a/b/"
    );
    assert.strictEqual(
      CSSPluginUtilities.pathOf("https://a.com/a/b/c.css"),
      "https://a.com/a/b/"
    );
  ...
  test("Utilities.joinPaths", () => {
    function mytest(a, b, expected) {
      assert.strictEqual(
        CSSPluginUtilities.joinPaths(a, b),
        expected,
        "<" + a + "> + <" + b + "> = <" + expected + ">"
      );
    }
    ...
    mytest(
      "https://a.com/x/y/z/",
      "../../a/b/c.css",
      "https://a.com/x/a/b/c.css"
    );
  });
  test("Utilities.commonPrefix", () => {
    function mytest(a, b, expected) {
      assert.strictEqual(
        CSSPluginUtilities.commonPrefix(a, b),
        expected,
        "prefix(<" + a + ">, <" + b + ">) = <" + expected + ">"
      );
      assert.strictEqual(
        CSSPluginUtilities.commonPrefix(b, a),
        expected,
        "prefix(<" + b + ">, <" + a + ">) = <" + expected + ">"
      );
    }
  ...
  test("Utilities.commonFolderPrefix", () => {
    function mytest(a, b, expected) {
      assert.strictEqual(
        CSSPluginUtilities.commonFolderPrefix(a, b),
        expected,
        "folderPrefix(<" + a + ">, <" + b + ">) = <" + expected + ">"
      );
      assert.strictEqual(
        CSSPluginUtilities.commonFolderPrefix(b, a),
        expected,
        "folderPrefix(<" + b + ">, <" + a + ">) = <" + expected + ">"
      );
    }
    mytest("", "", "");
    mytest("x", "", "");
  ...
  test("Utilities.relativePath", () => {
    function mytest(a, b, expected) {
      assert.strictEqual(
        CSSPluginUtilities.relativePath(a, b),
        expected,
  ...
  test("Utilities.rewriteUrls", () => {
    function mytest(originalFile, newFile, url, expected) {
      assert.strictEqual(
        rewriteUrls(
          originalFile,
          newFile,
          "sel { background:url('" + url + "'); }"
        ),
        "sel { background:url(" + expected + "); }"
      );
      assert.strictEqual(
        rewriteUrls(
          originalFile,
    ...
    mytest("/x/a.css", "/x/b.css", "img/img.png", "/x/img/img.png");
    mytest(
      "http://www.example.com/x/y/a.css",
      "b.css",
      "img/img.png",
      "http://www.example.com/x/y/img/img.png"
    );
    mytest(
      "http://www.example.com/x/y/a.css",
      "http://www.example2.com/b.css",
      "img/img.png",
      "http://www.example.com/x/y/img/img.png"
    );
    mytest(
      "https://www.example.com/x/y/a.css",
      "b.css",
      "img/img.png",
      "https://www.example.com/x/y/img/img.png"
    );
    mytest("a.css", "b.css", "../img/img.png", "../img/img.png");
    mytest("a.css", "t/b.css", "../img/img.png", "../../img/img.png");
    mytest("a.css", "x/y/b.css", "../img/img.png", "../../../img/img.png");
    ...
    mytest(
      ...
      "b.css",
      "../img/img.png",
      "http://www.example.com/x/img/img.png"
    );
    mytest(
      "http://www.example.com/x/y/a.css",
      "http://www.example2.com/b.css",
    ...
    mytest(
      ...
      "b.css",
      "../img/img.png",
      "https://www.example.com/x/img/img.png"
    );
    mytest("a.css", "b.css", "/img/img.png", "/img/img.png");
    mytest("a.css", "t/b.css", "/img/img.png", "/img/img.png");
    mytest("a.css", "x/y/b.css", "/img/img.png", "/img/img.png");
    ...
    mytest(
      ...
      "b.css",
      "/img/img.png",
      "http://www.example.com/img/img.png"
    );
    mytest(
      "http://www.example.com/x/y/a.css",
      "http://www.example.com/x/y/b.css",
      "/img/img.png",
      "http://www.example.com/img/img.png"
    );
    mytest(
      ...
      "b.css",
      "/img/img.png",
      "https://www.example.com/img/img.png"
    );
    mytest(
      "a.css",
      "b.css",
  ...
  test("Utilities.rewriteUrls - quotes and spaces", () => {
    assert.strictEqual(
      rewriteUrls(
        "x/y/a.css",
        "t/u/b.css",
        "sel { background:url('../img/img.png'); }"
      ),
      "sel { background:url(../../x/img/img.png); }"
    );
    assert.strictEqual(
      rewriteUrls(
        "x/y/a.css",
