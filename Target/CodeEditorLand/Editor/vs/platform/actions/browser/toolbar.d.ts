import { type IToolBarOptions, ToolBar } from "../../../base/browser/ui/toolbar/toolbar.js";
import { type IAction, type SubmenuAction } from "../../../base/common/actions.js";
...
import { type IMenuActionOptions, IMenuService, type MenuId } from "../common/actions.js";
export declare enum HiddenItemStrategy {
...
export declare class MenuWorkbenchToolBar extends WorkbenchToolBar {
    ...
    constructor(container: HTMLElement, menuId: MenuId, options: IMenuWorkbenchToolBarOptions | undefined, menuService: IMenuService, contextKeyService: IContextKeyService, contextMenuService: IContextMenuService, keybindingService: IKeybindingService, commandService: ICommandService, telemetryService: ITelemetryService);
    /**
