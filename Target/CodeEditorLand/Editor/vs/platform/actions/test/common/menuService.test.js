...
import { MenuId, MenuRegistry, isIMenuItem } from "../../common/actions.js";
...
suite("MenuService", () => {
  ...
  test("group sorting", () => {
    disposables.add(
      MenuRegistry.appendMenuItem(testMenuId, {
  ...
  test("in group sorting, by title", () => {
    disposables.add(
      MenuRegistry.appendMenuItem(testMenuId, {
  ...
  test("in group sorting, by title and order", () => {
    disposables.add(
      MenuRegistry.appendMenuItem(testMenuId, {
        command: { id: "a", title: "aaa" },
        group: "Hello",
  ...
  test("in group sorting, special: navigation", () => {
    disposables.add(
      MenuRegistry.appendMenuItem(testMenuId, {
        command: { id: "a", title: "aaa" },
        group: "navigation",
  ...
  test("Extension contributed submenus missing with errors in output #155030", () => {
