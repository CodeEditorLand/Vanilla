...
flakySuite("Native Modules (all platforms)", () => {
  (isMacintosh ? test.skip : test)("kerberos", async () => {
    ...
    assert.ok(
      typeof kerberos.initializeClient === "function",
  ...
  test("yauzl", async () => {
    ...
    assert.ok(
      typeof yauzl.ZipFile === "function",
      testErrorMessage("yauzl")
    );
  });
  test("yazl", async () => {
  ...
  test("native-watchdog", async () => {
    ...
    assert.ok(
      typeof watchDog.start === "function",
  ...
  test("@parcel/watcher", async () => {
    ...
    assert.ok(
      typeof parcelWatcher.subscribe === "function",
  ...
  test("vscode-regexpp", async () => {
    ...
    assert.ok(
      typeof regexpp.RegExpParser === "function",
  ...
  test("http-proxy-agent", async () => {
    ...
    assert.ok(
      typeof mod.HttpProxyAgent === "function",
  ...
  test("@vscode/proxy-agent", async () => {
    ...
    assert.ok(
      windowsCerts.length > 0,
      testErrorMessage("@vscode/proxy-agent")
    );
  });
});
(isWindows ? suite : suite.skip)("Native Modules (Windows)", () => {
  test("@vscode/windows-mutex", async () => {
    ...
    assert.ok(
      typeof mutex.isActive === "function",
      testErrorMessage("@vscode/windows-mutex")
    );
    assert.ok(
      typeof mutex.Mutex === "function",
      testErrorMessage("@vscode/windows-mutex")
    );
  });
