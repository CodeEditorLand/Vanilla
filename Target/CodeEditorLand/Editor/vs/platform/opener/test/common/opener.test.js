...
suite("extractSelection", () => {
  test("extractSelection with only startLineNumber", async () => {
    ...
    assert.deepStrictEqual(extractSelection(uri).selection, { startLineNumber: 73, startColumn: 1, endLineNumber: void 0, endColumn: void 0 });
  });
  ...
  test("extractSelection with startLineNumber and startColumn", async () => {
    ...
    assert.deepStrictEqual(extractSelection(uri).selection, { startLineNumber: 73, startColumn: 84, endLineNumber: void 0, endColumn: void 0 });
  });
...
//# sourceMappingURL=opener.test.js.map
