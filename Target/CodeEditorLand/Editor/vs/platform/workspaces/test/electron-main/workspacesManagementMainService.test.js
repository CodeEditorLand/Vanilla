...
flakySuite("WorkspacesManagementMainService", () => {
  class TestDialogMainService {
    static {
      __name(this, "TestDialogMainService");
    }
  ...
  __name(createUntitledWorkspace, "createUntitledWorkspace");
  ...
  __name(createWorkspace, "createWorkspace");
  let testDir;
  ...
  __name(assertPathEquals, "assertPathEquals");
