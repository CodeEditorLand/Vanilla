...
suite("Extension Version Validator", () => {
  ...
  test("parseVersion", () => {
    ...
    __name(assertParseVersion, "assertParseVersion");
  ...
  test("normalizeVersion", () => {
    ...
    __name(assertNormalizeVersion, "assertNormalizeVersion");
  ...
  test("isValidVersion", () => {
    ...
    __name(testIsValidVersion, "testIsValidVersion");
  ...
  test("isValidExtensionVersion", () => {
    ...
    __name(testExtensionVersion, "testExtensionVersion");
    ...
    __name(testIsInvalidExtensionVersion, "testIsInvalidExtensionVersion");
    ...
    __name(testIsValidExtensionVersion, "testIsValidExtensionVersion");
    function testIsValidVersion(version, desiredVersion, expectedResult) {
...
//# sourceMappingURL=extensionValidator.test.js.map
