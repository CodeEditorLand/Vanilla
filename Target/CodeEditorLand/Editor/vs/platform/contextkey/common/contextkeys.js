...
const IsIOSContext = new RawContextKey(
  "isIOS",
  isIOS,
  localize("isIOS", "Whether the operating system is iOS")
);
const IsMobileContext = new RawContextKey(
  "isMobile",
  isMobile,
  localize("isMobile", "Whether the platform is a mobile web browser")
);
const IsDevelopmentContext = new RawContextKey(
  "isDevelopment",
  false,
  true
);
const ProductQualityContext = new RawContextKey(
  "productQualityType",
  "",
  localize("productQualityType", "Quality type of VS Code")
);
const InputFocusedContextKey = "inputFocus";
const InputFocusedContext = new RawContextKey(
