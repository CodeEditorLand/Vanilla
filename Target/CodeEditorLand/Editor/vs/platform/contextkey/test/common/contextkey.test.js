...
suite("ContextKeyExpr", () => {
  ...
  test("evaluate", () => {
    ...
    __name(testExpression, "testExpression");
  ...
  test("false, true", () => {
    ...
    __name(testNormalize, "testNormalize");
  ...
  test("Greater, GreaterEquals, Smaller, SmallerEquals evaluate", () => {
    ...
    __name(checkEvaluate, "checkEvaluate");
  ...
  test("Greater, GreaterEquals, Smaller, SmallerEquals negate", () => {
    ...
    __name(checkNegate, "checkNegate");
    checkNegate("a > 1", "a <= 1");
