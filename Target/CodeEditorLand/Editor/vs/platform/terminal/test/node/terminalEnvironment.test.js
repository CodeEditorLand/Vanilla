...
const enabledProcessOptions = { shellIntegration: { enabled: true, suggestEnabled: false, nonce: "" }, windowsEnableConpty: true, windowsUseConptyDll: false, environmentVariableCollections: void 0, workspaceFolder: void 0 };
const disabledProcessOptions = { shellIntegration: { enabled: false, suggestEnabled: false, nonce: "" }, windowsEnableConpty: true, windowsUseConptyDll: false, environmentVariableCollections: void 0, workspaceFolder: void 0 };
const winptyProcessOptions = { shellIntegration: { enabled: true, suggestEnabled: false, nonce: "" }, windowsEnableConpty: false, windowsUseConptyDll: false, environmentVariableCollections: void 0, workspaceFolder: void 0 };
...
__name(deepStrictEqualIgnoreStableVar, "deepStrictEqualIgnoreStableVar");
    ...
    (getWindowsBuildNumber() < 18309 ? suite.skip : suite)("pwsh", () => {
      ...
      suite("should override args", () => {
        ...
        test("when undefined, []", () => {
          ...
          deepStrictEqualIgnoreStableVar(getShellIntegrationInjection({ executable: pwshExe, args: void 0 }, enabledProcessOptions, defaultEnvironment, logService, productService), enabledExpectedResult);
        });
        suite("when no logo", () => {
      ...
      suite("should not modify args", () => {
        test("when shell integration is disabled", () => {
          strictEqual(getShellIntegrationInjection({ executable: pwshExe, args: ["-l"] }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
          strictEqual(getShellIntegrationInjection({ executable: pwshExe, args: "-l" }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
          strictEqual(getShellIntegrationInjection({ executable: pwshExe, args: void 0 }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
        });
        test("when using unrecognized arg", () => {
          strictEqual(getShellIntegrationInjection({ executable: pwshExe, args: ["-l", "-NoLogo", "-i"] }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
        });
        test("when using unrecognized arg (string)", () => {
          strictEqual(getShellIntegrationInjection({ executable: pwshExe, args: "-i" }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
        });
      });
    });
    if (process.platform !== "win32") {
      suite("zsh", () => {
        suite("should override args", () => {
          ...
          __name(assertIsEnabled, "assertIsEnabled");
          test("when undefined, []", () => {
            ...
            const result2 = getShellIntegrationInjection({ executable: "zsh", args: void 0 }, enabledProcessOptions, defaultEnvironment, logService, productService);
          ...
          suite("should not modify args", () => {
            test("when shell integration is disabled", () => {
              strictEqual(getShellIntegrationInjection({ executable: "zsh", args: ["-l"] }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
              strictEqual(getShellIntegrationInjection({ executable: "zsh", args: void 0 }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
            });
            test("when using unrecognized arg", () => {
              strictEqual(getShellIntegrationInjection({ executable: "zsh", args: ["-l", "-fake"] }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
            });
          });
          suite("should incorporate global ZDOTDIR env variable", () => {
            ...
            test("when undefined", () => {
              const result1 = getShellIntegrationInjection({ executable: "zsh", args: [] }, enabledProcessOptions, void 0, logService, productService);
              deepStrictEqual(result1?.newArgs, ["-i"]);
              assertIsEnabled(result1);
            });
          });
      ...
      suite("bash", () => {
        suite("should override args", () => {
          test("when undefined, [], empty string", () => {
            ...
            deepStrictEqualIgnoreStableVar(getShellIntegrationInjection({ executable: "bash", args: "" }, enabledProcessOptions, defaultEnvironment, logService, productService), enabledExpectedResult);
            deepStrictEqualIgnoreStableVar(getShellIntegrationInjection({ executable: "bash", args: void 0 }, enabledProcessOptions, defaultEnvironment, logService, productService), enabledExpectedResult);
          });
          ...
          suite("should not modify args", () => {
            test("when shell integration is disabled", () => {
              strictEqual(getShellIntegrationInjection({ executable: "bash", args: ["-l"] }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
              strictEqual(getShellIntegrationInjection({ executable: "bash", args: void 0 }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
            });
            test("when custom array entry", () => {
              strictEqual(getShellIntegrationInjection({ executable: "bash", args: ["-l", "-i"] }, disabledProcessOptions, defaultEnvironment, logService, productService), void 0);
            });
          });
        });
      });
