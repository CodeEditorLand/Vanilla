      ...
      suite("zsh", () => {
        suite("should override args", () => {
          ...
          function assertIsEnabled(result, globalZdotdir = homedir()) {
            ...
            ok(
              result.filesToCopy[0].source.match(
                expectedSources[0]
              )
            );
            ok(
              result.filesToCopy[1].source.match(
                expectedSources[1]
              )
            );
            ok(
              result.filesToCopy[2].source.match(
                expectedSources[2]
              )
            );
            ok(
              result.filesToCopy[3].source.match(
                expectedSources[3]
              )
            );
          }
          test("when undefined, []", () => {
            const result1 = getShellIntegrationInjection(
              { executable: "zsh", args: [] },
              enabledProcessOptions,
              defaultEnvironment,
              logService,
            ...
            const result2 = getShellIntegrationInjection(
          ...
          suite("should incorporate login arg", () => {
            test("when array", () => {
              const result = getShellIntegrationInjection(
