...
class ParcelWatcher extends BaseWatcher {
  ...
  legacyMonitorRequest(watcher) {
    ...
    if (existsSync(parentPath)) {
      ...
      const nodeWatcher = new NodeJSFileWatcherLibrary({ path: parentPath, excludes: [], recursive: false, correlationId: watcher.request.correlationId }, void 0, (changes) => {
        if (watcher.token.isCancellationRequested) {
          return;
        }
      ...
      }, void 0, (msg) => this._onDidLogMessage.fire(msg), this.verboseLogging);
