...
suite("Files", () => {
  ...
  __name(testIsEqual, "testIsEqual");
  test("isEqual (ignoreCase)", function() {
    ...
    assert(isEqual(URI.file("/some\xF6\xE4\xFC/path").fsPath, URI.file("/some\xF6\xE4\xFC/path").fsPath, true));
    assert(isEqual(URI.file("c:\\some\xF6\xE4\xFC\\path").fsPath, URI.file("c:\\some\xF6\xE4\xFC\\path").fsPath, true));
    ...
    assert(isEqual(URI.file("/some/path").fsPath, URI.file("/some/PATH").fsPath, true));
    assert(isEqual(URI.file("/some\xF6\xE4\xFC/path").fsPath, URI.file("/some\xD6\xC4\xDC/PATH").fsPath, true));
    assert(isEqual(URI.file("c:\\some\\path").fsPath, URI.file("c:\\some\\PATH").fsPath, true));
    assert(isEqual(URI.file("c:\\some\xF6\xE4\xFC\\path").fsPath, URI.file("c:\\some\xD6\xC4\xDC\\PATH").fsPath, true));
    assert(isEqual(URI.file("c:\\some\\path").fsPath, URI.file("C:\\some\\PATH").fsPath, true));
  });
