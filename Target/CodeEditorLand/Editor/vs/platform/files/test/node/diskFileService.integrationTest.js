...
__name(toLineByLineReadable, "toLineByLineReadable");
class TestDiskFileSystemProvider extends DiskFileSystemProvider {
  static {
    __name(this, "TestDiskFileSystemProvider");
  }
  totalBytesRead = 0;
...
(!isESM ? suite.skip : flakySuite)("Disk File Service", function() {
  ...
  __name(testResolveDirectoryWithTarget, "testResolveDirectoryWithTarget");
  ...
  __name(testDeleteFile, "testDeleteFile");
  ...
  __name(testDeleteFolderRecursive, "testDeleteFolderRecursive");
  ...
  __name(testDeleteEmptyFolder, "testDeleteEmptyFolder");
  test("move", async () => {
    let event;
    disposables.add(service.onDidRunOperation((e) => event = e));
  ...
  __name(testMoveAcrossProviders, "testMoveAcrossProviders");
  ...
  __name(testMoveFolderAcrossProviders, "testMoveFolderAcrossProviders");
  ...
  __name(setCapabilities, "setCapabilities");
  ...
  __name(testCloneFile, "testCloneFile");
  ...
  __name(testReadFile, "testReadFile");
  ...
  __name(testReadFileStream, "testReadFileStream");
  ...
  __name(testFilesNotIntermingled, "testFilesNotIntermingled");
  ...
  __name(testReadFileFromPositionAscii, "testReadFileFromPositionAscii");
  ...
  __name(testReadFileFromPositionUmlaut, "testReadFileFromPositionUmlaut");
  ...
  __name(testReadThreeBytesFromFile, "testReadThreeBytesFromFile");
  ...
  __name(readLargeFileWithLength, "readLargeFileWithLength");
  ...
  __name(testNotModifiedSince, "testNotModifiedSince");
  ...
  __name(testFileTooLarge, "testFileTooLarge");
  ...
  __name(doTestFileTooLarge, "doTestFileTooLarge");
  ...
  __name(assertCreateFile, "assertCreateFile");
  ...
  __name(testWriteFileLarge, "testWriteFileLarge");
  ...
  __name(testWriteFileReadonlyThrows, "testWriteFileReadonlyThrows");
  ...
  __name(testWriteFileReadable, "testWriteFileReadable");
  ...
  __name(testWriteFileLargeReadable, "testWriteFileLargeReadable");
  ...
  __name(testWriteFileStream, "testWriteFileStream");
  ...
  __name(testWriteFileLargeStream, "testWriteFileLargeStream");
  ...
  __name(testLockedFiles, "testLockedFiles");
