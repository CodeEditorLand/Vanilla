...
suite.skip("File Watcher (parcel)", () => {
  ...
  __name(enableLogging, "enableLogging");
  enableLogging(false);
  setup(async () => {
  ...
  __name(awaitMessage, "awaitMessage");
  ...
  __name(basicCrudTest, "basicCrudTest");
  ...
  __name(testExcludes, "testExcludes");
  ...
  (!isMacintosh ? test.skip : test)("correlated watch requests support suspend/resume (folder, does not exist in beginning, reusing watcher)", async () => {
  ...
  async function testCorrelatedWatchFolderDoesNotExist(reuseExistingWatcher) {
    ...
    let changeFuture = awaitEvent(watcher, folderPath, FileChangeType.ADDED, void 0, 1);
    ...
    await onDidWatchFail;
    changeFuture = awaitEvent(watcher, folderPath, FileChangeType.ADDED, void 0, 1);
  ...
  __name(testCorrelatedWatchFolderDoesNotExist, "testCorrelatedWatchFolderDoesNotExist");
  ...
  (!isMacintosh ? test.skip : test)("correlated watch requests support suspend/resume (folder, exist in beginning, reusing watcher)", async () => {
  ...
  async function testCorrelatedWatchFolderExists(reuseExistingWatcher) {
    ...
    await Promises.rm(folderPath);
    await onDidWatchFail;
    const changeFuture = awaitEvent(watcher, folderPath, FileChangeType.ADDED, void 0, 1);
  ...
  __name(testCorrelatedWatchFolderExists, "testCorrelatedWatchFolderExists");
