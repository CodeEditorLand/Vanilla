...
suite("AbstractKeybindingService", () => {
  class TestKeybindingService extends AbstractKeybindingService {
    static {
      __name(this, "TestKeybindingService");
    }
    _resolver;
  ...
  setup(() => {
    ...
    createTestKeybindingService = /* @__PURE__ */ __name((items) => {
      const contextKeyService = {
        ...
        getContext: /* @__PURE__ */ __name((target) => {
          return currentContextValue;
        }, "getContext"),
        updateParent: /* @__PURE__ */ __name(() => {
        }, "updateParent")
      };
      ...
      const notificationService = {
        ...
        notify: /* @__PURE__ */ __name((notification) => {
  ...
  test("issue #16833: Keybinding service should not testDispatch on modifier keys", () => {
    ...
    __name(assertIsIgnored, "assertIsIgnored");
