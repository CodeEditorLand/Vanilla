...
flakySuite("BackupMainService", () => {
  function assertEqualFolderInfos(actual, expected) {
    const withUriAsString = /* @__PURE__ */ __name((f) => ({ folderUri: f.folderUri.toString(), remoteAuthority: f.remoteAuthority }), "withUriAsString");
    assert.deepStrictEqual(actual.map(withUriAsString), expected.map(withUriAsString));
  }
  __name(assertEqualFolderInfos, "assertEqualFolderInfos");
  ...
  __name(toWorkspaceBackupInfo, "toWorkspaceBackupInfo");
  function toFolderBackupInfo(uri, remoteAuthority) {
    return { folderUri: uri, remoteAuthority };
  }
  __name(toFolderBackupInfo, "toFolderBackupInfo");
  ...
  __name(toSerializedWorkspace, "toSerializedWorkspace");
  ...
  __name(createBackupFolder, "createBackupFolder");
  function readWorkspacesMetadata() {
    return stateMainService.getItem("backupWorkspaces");
  }
  __name(readWorkspacesMetadata, "readWorkspacesMetadata");
  ...
  __name(writeWorkspacesMetadata, "writeWorkspacesMetadata");
  ...
  setup(async () => {
    ...
    service = new class TestBackupMainService extends BackupMainService {
      static {
        __name(this, "TestBackupMainService");
      }
      constructor() {
  ...
  suite("getWorkspaceHash", () => {
    (platform.isLinux ? test.skip : test)("should ignore case on Windows and Mac", () => {
      const assertFolderHash = /* @__PURE__ */ __name((uri1, uri2) => {
