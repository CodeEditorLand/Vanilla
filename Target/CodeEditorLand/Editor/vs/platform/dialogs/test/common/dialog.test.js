...
suite("Dialog", () => {
  ...
  test("massageMessageBoxOptions", () => {
    ...
    const oneButtonNoCancel = massageMessageBoxOptions({ buttons: ["1"], cancelId: void 0, message: "message" }, testProductService);
    ...
    const twoButtonNoCancel = massageMessageBoxOptions({ buttons: ["1", "2"], cancelId: void 0, message: "message" }, testProductService);
    ...
    const threeButtonNoCancel = massageMessageBoxOptions({ buttons: ["1", "2", "3"], cancelId: void 0, message: "message" }, testProductService);
    ...
    const fourButtonNoCancel = massageMessageBoxOptions({ buttons: ["1", "2", "3", "4"], cancelId: void 0, message: "message" }, testProductService);
