...
suite("ExtensionsMerge", () => {
  ...
  __name(anExpectedSyncExtension, "anExpectedSyncExtension");
  ...
  __name(anExpectedBuiltinSyncExtension, "anExpectedBuiltinSyncExtension");
  ...
  __name(aLocalSyncExtension, "aLocalSyncExtension");
  ...
  __name(aRemoteSyncExtension, "aRemoteSyncExtension");
  ...
  __name(aSyncExtension, "aSyncExtension");
});
