...
import { Change, IResourcePreview as IBaseResourcePreview, IUserDataSyncResourcePreview as IBaseSyncResourcePreview, IRemoteUserData, ISyncData, IUserData, IUserDataResourceManifest, IUserDataSyncConfiguration, IUserDataSyncEnablementService, IUserDataSynchroniser, IUserDataSyncLocalStoreService, IUserDataSyncLogService, IUserDataSyncResource, IUserDataSyncResourceConflicts, IUserDataSyncResourceInitializer, IUserDataSyncStoreService, IUserDataSyncUtilService, MergeState, SyncResource, SyncStatus } from "./userDataSync.js";
