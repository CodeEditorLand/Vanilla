...
import { type IFileContent, IFileService } from "../../files/common/files.js";
...
import { Change, type IResourcePreview as IBaseResourcePreview, type IUserDataSyncResourcePreview as IBaseSyncResourcePreview, type IRemoteUserData, type ISyncData, type IUserData, type IUserDataResourceManifest, type IUserDataSyncConfiguration, IUserDataSyncEnablementService, IUserDataSyncLocalStoreService, IUserDataSyncLogService, type IUserDataSyncResource, type IUserDataSyncResourceConflicts, type IUserDataSyncResourceInitializer, IUserDataSyncStoreService, IUserDataSyncUtilService, type IUserDataSynchroniser, MergeState, type SyncResource, SyncStatus } from "./userDataSync.js";
