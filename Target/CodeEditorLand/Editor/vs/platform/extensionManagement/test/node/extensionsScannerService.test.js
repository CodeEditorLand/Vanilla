...
suite("NativeExtensionsScanerService Test", () => {
  ...
  test("scan system extensions include additional builtin extensions", async () => {
    instantiationService.stub(IProductService, {
      version: "1.66.0",
      builtInExtensions: [
        { name: "pub.name2", version: "", repo: "", metadata: void 0 },
        { name: "pub.name", version: "", repo: "", metadata: void 0 }
      ]
    });
  ...
  __name(anExtension, "anExtension");
  function anExtensionManifest(manifest) {
    return { engines: { vscode: "^1.66.0" }, version: "1.0.0", main: "main.js", activationEvents: ["*"], ...manifest };
  }
  __name(anExtensionManifest, "anExtensionManifest");
});
suite("ExtensionScannerInput", () => {
  ensureNoDisposablesAreLeakedInTestSuite();
  test("compare inputs - location", () => {
    const anInput = /* @__PURE__ */ __name((location, mtime) => new ExtensionScannerInput(location, mtime, void 0, void 0, false, void 0, ExtensionType.User, true, true, "1.1.1", void 0, void 0, true, void 0, {}), "anInput");
    assert.strictEqual(ExtensionScannerInput.equals(anInput(ROOT, void 0), anInput(ROOT, void 0)), true);
    assert.strictEqual(ExtensionScannerInput.equals(anInput(ROOT, 100), anInput(ROOT, 100)), true);
    assert.strictEqual(ExtensionScannerInput.equals(anInput(joinPath(ROOT, "foo"), void 0), anInput(ROOT, void 0)), false);
    assert.strictEqual(ExtensionScannerInput.equals(anInput(ROOT, 100), anInput(ROOT, 200)), false);
    assert.strictEqual(ExtensionScannerInput.equals(anInput(ROOT, void 0), anInput(ROOT, 200)), false);
  });
  test("compare inputs - application location", () => {
    const anInput = /* @__PURE__ */ __name((location, mtime) => new ExtensionScannerInput(ROOT, void 0, location, mtime, false, void 0, ExtensionType.User, true, true, "1.1.1", void 0, void 0, true, void 0, {}), "anInput");
    assert.strictEqual(ExtensionScannerInput.equals(anInput(ROOT, void 0), anInput(ROOT, void 0)), true);
    assert.strictEqual(ExtensionScannerInput.equals(anInput(ROOT, 100), anInput(ROOT, 100)), true);
    assert.strictEqual(ExtensionScannerInput.equals(anInput(joinPath(ROOT, "foo"), void 0), anInput(ROOT, void 0)), false);
    assert.strictEqual(ExtensionScannerInput.equals(anInput(ROOT, 100), anInput(ROOT, 200)), false);
  ...
  test("compare inputs - profile", () => {
    const anInput = /* @__PURE__ */ __name((profile, profileScanOptions) => new ExtensionScannerInput(ROOT, void 0, void 0, void 0, profile, profileScanOptions, ExtensionType.User, true, true, "1.1.1", void 0, void 0, true, void 0, {}), "anInput");
    ...
    assert.strictEqual(ExtensionScannerInput.equals(anInput(true, void 0), anInput(true, {})), false);
  ...
  test("compare inputs - extension type", () => {
    const anInput = /* @__PURE__ */ __name((type) => new ExtensionScannerInput(ROOT, void 0, void 0, void 0, false, void 0, type, true, true, "1.1.1", void 0, void 0, true, void 0, {}), "anInput");
