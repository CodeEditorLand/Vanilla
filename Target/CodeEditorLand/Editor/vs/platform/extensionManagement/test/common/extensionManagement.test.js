...
suite("Extension Identifier Pattern", () => {
  ...
  test("extension key", () => {
    ...
    assert.strictEqual(
      ...
      `pub.extension-name-1.0.1-${TargetPlatform.WIN32_X64}`
    );
  });
