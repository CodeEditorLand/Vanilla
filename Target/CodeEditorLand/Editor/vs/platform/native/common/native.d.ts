...
import type { IColorScheme, IOpenEmptyWindowOptions, IOpenWindowOptions, IOpenedAuxiliaryWindow, IOpenedMainWindow, IPoint, IRectangle, IWindowOpenable } from "../../window/common/window.js";
