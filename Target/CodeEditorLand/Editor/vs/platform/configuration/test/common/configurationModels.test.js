...
suite("ConfigurationModelParser", () => {
  ...
  test("parse configuration model with scopes filter", () => {
    ...
    assert.strictEqual(testObject.configurationModel.getValue("ConfigurationModelParserTest.windowSetting"), void 0);
  });
  ...
  test("parse configuration model with invalid setting key", () => {
    ...
    assert.strictEqual(testObject.configurationModel.getValue("a.b"), void 0);
    assert.strictEqual(testObject.configurationModel.getValue("a.b.c"), void 0);
  });
});
suite("ConfigurationModel", () => {
  ensureNoDisposablesAreLeakedInTestSuite();
  test("setValue for a key that has no sections and not defined", () => {
    const testObject = new ConfigurationModel({ "a": { "b": 1 } }, ["a.b"], [], void 0, new NullLogService());
  ...
  test("setValue for a key that has no sections and defined", () => {
    const testObject = new ConfigurationModel({ "a": { "b": 1 }, "f": 1 }, ["a.b", "f"], [], void 0, new NullLogService());
  ...
  test("setValue for a key that has sections and not defined", () => {
    ...
    expected["a"] = { "b": 1 };
    expected["f"] = 1;
    expected["b"] = /* @__PURE__ */ Object.create(null);
    expected["b"]["c"] = 1;
  ...
  test("setValue for a key that has sections and defined", () => {
    const testObject = new ConfigurationModel({ "a": { "b": 1 }, "b": { "c": 1 }, "f": 1 }, ["a.b", "b.c", "f"], [], void 0, new NullLogService());
  ...
  test("setValue for a key that has sections and sub section defined", () => {
    const testObject = new ConfigurationModel({ "a": { "b": 1, "c": 1 }, "f": 1 }, ["a.b", "a.c", "f"], [], void 0, new NullLogService());
  ...
  test("setValue for a key that has sections and last section is added", () => {
    const testObject = new ConfigurationModel({ "a": { "b": {} }, "f": 1 }, ["a.b", "f"], [], void 0, new NullLogService());
  ...
  test("removeValue: remove a non existing key", () => {
    const testObject = new ConfigurationModel({ "a": { "b": 2 } }, ["a.b"], [], void 0, new NullLogService());
  ...
  test("removeValue: remove a single segmented key", () => {
    const testObject = new ConfigurationModel({ "a": 1 }, ["a"], [], void 0, new NullLogService());
  ...
  test("simple merge", () => {
    const base = new ConfigurationModel({ "a": 1, "b": 2 }, ["a", "b"], [], void 0, new NullLogService());
    const add = new ConfigurationModel({ "a": 3, "c": 4 }, ["a", "c"], [], void 0, new NullLogService());
  ...
  test("recursive merge", () => {
    const base = new ConfigurationModel({ "a": { "b": 1 } }, ["a.b"], [], void 0, new NullLogService());
    const add = new ConfigurationModel({ "a": { "b": 2 } }, ["a.b"], [], void 0, new NullLogService());
    const result = base.merge(add);
  ...
  test("simple merge overrides", () => {
    const base = new ConfigurationModel({ "a": { "b": 1 } }, ["a.b"], [{ identifiers: ["c"], contents: { "a": 2 }, keys: ["a"] }], void 0, new NullLogService());
    const add = new ConfigurationModel({ "a": { "b": 2 } }, ["a.b"], [{ identifiers: ["c"], contents: { "b": 2 }, keys: ["b"] }], void 0, new NullLogService());
    const result = base.merge(add);
    assert.deepStrictEqual(result.contents, { "a": { "b": 2 } });
  ...
  test("recursive merge overrides", () => {
    const base = new ConfigurationModel({ "a": { "b": 1 }, "f": 1 }, ["a.b", "f"], [{ identifiers: ["c"], contents: { "a": { "d": 1 } }, keys: ["a"] }], void 0, new NullLogService());
    const add = new ConfigurationModel({ "a": { "b": 2 } }, ["a.b"], [{ identifiers: ["c"], contents: { "a": { "e": 2 } }, keys: ["a"] }], void 0, new NullLogService());
    const result = base.merge(add);
  ...
  test("Test contents while getting an existing property", () => {
    let testObject = new ConfigurationModel({ "a": 1 }, [], [], void 0, new NullLogService());
    assert.deepStrictEqual(testObject.getValue("a"), 1);
    testObject = new ConfigurationModel({ "a": { "b": 1 } }, [], [], void 0, new NullLogService());
    assert.deepStrictEqual(testObject.getValue("a"), { "b": 1 });
  });
  test("Test contents are undefined for non existing properties", () => {
    const testObject = new ConfigurationModel({ awesome: true }, [], [], void 0, new NullLogService());
    assert.deepStrictEqual(testObject.getValue("unknownproperty"), void 0);
  });
  test("Test override gives all content merged with overrides", () => {
    const testObject = new ConfigurationModel({ "a": 1, "c": 1 }, [], [{ identifiers: ["b"], contents: { "a": 2 }, keys: ["a"] }], void 0, new NullLogService());
  ...
  test("Test override when an override has multiple identifiers", () => {
    const testObject = new ConfigurationModel({ "a": 1, "c": 1 }, ["a", "c"], [{ identifiers: ["x", "y"], contents: { "a": 2 }, keys: ["a"] }], void 0, new NullLogService());
  ...
  test("Test override when an identifier is defined in multiple overrides", () => {
    const testObject = new ConfigurationModel({ "a": 1, "c": 1 }, ["a", "c"], [{ identifiers: ["x"], contents: { "a": 3, "b": 1 }, keys: ["a", "b"] }, { identifiers: ["x", "y"], contents: { "a": 2 }, keys: ["a"] }], void 0, new NullLogService());
  ...
  test("Test merge when configuration models have multiple identifiers", () => {
    const testObject = new ConfigurationModel({ "a": 1, "c": 1 }, ["a", "c"], [{ identifiers: ["y"], contents: { "c": 1 }, keys: ["c"] }, { identifiers: ["x", "y"], contents: { "a": 2 }, keys: ["a"] }], void 0, new NullLogService());
    const target = new ConfigurationModel({ "a": 2, "b": 1 }, ["a", "b"], [{ identifiers: ["x"], contents: { "a": 3, "b": 2 }, keys: ["a", "b"] }, { identifiers: ["x", "y"], contents: { "b": 3 }, keys: ["b"] }], void 0, new NullLogService());
  ...
  test("inspect when raw is same", () => {
    const testObject = new ConfigurationModel({ "a": 1, "c": 1 }, ["a", "c"], [{ identifiers: ["x", "y"], contents: { "a": 2, "b": 1 }, keys: ["a"] }], void 0, new NullLogService());
    assert.deepStrictEqual(testObject.inspect("a"), { value: 1, override: void 0, merged: 1, overrides: [{ identifiers: ["x", "y"], value: 2 }] });
    assert.deepStrictEqual(testObject.inspect("a", "x"), { value: 1, override: 2, merged: 2, overrides: [{ identifiers: ["x", "y"], value: 2 }] });
    assert.deepStrictEqual(testObject.inspect("b", "x"), { value: void 0, override: 1, merged: 1, overrides: [{ identifiers: ["x", "y"], value: 1 }] });
    assert.deepStrictEqual(testObject.inspect("d"), { value: void 0, override: void 0, merged: void 0, overrides: void 0 });
  });
  test("inspect when raw is not same", () => {
    ...
    assert.deepStrictEqual(testObject.inspect("d"), { value: 3, override: void 0, merged: 3, overrides: void 0 });
    assert.deepStrictEqual(testObject.inspect("e"), { value: void 0, override: void 0, merged: void 0, overrides: void 0 });
  });
  test("inspect in merged configuration when raw is same", () => {
    const target1 = new ConfigurationModel({ "a": 1 }, ["a"], [{ identifiers: ["x", "y"], contents: { "a": 2 }, keys: ["a"] }], void 0, new NullLogService());
    const target2 = new ConfigurationModel({ "b": 3 }, ["b"], [], void 0, new NullLogService());
    const testObject = target1.merge(target2);
    assert.deepStrictEqual(testObject.inspect("a"), { value: 1, override: void 0, merged: 1, overrides: [{ identifiers: ["x", "y"], value: 2 }] });
    assert.deepStrictEqual(testObject.inspect("a", "x"), { value: 1, override: 2, merged: 2, overrides: [{ identifiers: ["x", "y"], value: 2 }] });
    assert.deepStrictEqual(testObject.inspect("b"), { value: 3, override: void 0, merged: 3, overrides: void 0 });
    assert.deepStrictEqual(testObject.inspect("b", "y"), { value: 3, override: void 0, merged: 3, overrides: void 0 });
    assert.deepStrictEqual(testObject.inspect("c"), { value: void 0, override: void 0, merged: void 0, overrides: void 0 });
  });
  test("inspect in merged configuration when raw is not same for one model", () => {
    ...
    assert.deepStrictEqual(testObject.inspect("a"), { value: 1, override: void 0, merged: 1, overrides: [{ identifiers: ["x", "y"], value: 2 }] });
    assert.deepStrictEqual(testObject.inspect("a", "x"), { value: 1, override: 2, merged: 2, overrides: [{ identifiers: ["x", "y"], value: 2 }] });
    assert.deepStrictEqual(testObject.inspect("b"), { value: 3, override: void 0, merged: 3, overrides: [{ identifiers: ["x", "y"], value: 4 }] });
    assert.deepStrictEqual(testObject.inspect("b", "y"), { value: 3, override: 4, merged: 4, overrides: [{ identifiers: ["x", "y"], value: 4 }] });
    assert.deepStrictEqual(testObject.inspect("c"), { value: 3, override: void 0, merged: 3, overrides: void 0 });
  });
  ...
  test("inspect when no overrides", () => {
    const testObject = new ConfigurationModel({ "a": 1, "c": 1 }, ["a", "c"], [], void 0, new NullLogService());
    assert.strictEqual(testObject.inspect("a").overrides, void 0);
  });
});
suite("CustomConfigurationModel", () => {
  ...
  test("Test contents are undefined for non existing properties", () => {
    ...
    assert.deepStrictEqual(testObject.configurationModel.getValue("unknownproperty"), void 0);
  });
  ...
  test("Test update with empty data", () => {
    const testObject = new ConfigurationModelParser("test", new NullLogService());
    testObject.parse("");
    assert.deepStrictEqual(testObject.configurationModel.contents, /* @__PURE__ */ Object.create(null));
    assert.deepStrictEqual(testObject.configurationModel.keys, []);
    testObject.parse(null);
    assert.deepStrictEqual(testObject.configurationModel.contents, /* @__PURE__ */ Object.create(null));
    assert.deepStrictEqual(testObject.configurationModel.keys, []);
    testObject.parse(void 0);
    assert.deepStrictEqual(testObject.configurationModel.contents, /* @__PURE__ */ Object.create(null));
    assert.deepStrictEqual(testObject.configurationModel.keys, []);
  });
...
class TestConfiguration extends Configuration {
  ...
  constructor(defaultConfiguration, policyConfiguration, applicationConfiguration, localUserConfiguration) {
    super(
...
suite("Configuration", () => {
  ...
  test("Test inspect for overrideIdentifiers", () => {
    ...
    const { overrideIdentifiers } = testObject.inspect("a", {}, void 0);
  ...
  test("Test update value", () => {
    ...
    assert.strictEqual(testObject.getValue("a", {}, void 0), 2);
  });
  test("Test update value after inspect", () => {
    const parser = new ConfigurationModelParser("test", new NullLogService());
    parser.parse(JSON.stringify({ "a": 1 }));
    const testObject = new TestConfiguration(parser.configurationModel, ConfigurationModel.createEmptyModel(new NullLogService()), ConfigurationModel.createEmptyModel(new NullLogService()), ConfigurationModel.createEmptyModel(new NullLogService()));
    testObject.inspect("a", {}, void 0);
    testObject.updateValue("a", 2);
    assert.strictEqual(testObject.getValue("a", {}, void 0), 2);
  });
  ...
  __name(parseConfigurationModel, "parseConfigurationModel");
});
suite("ConfigurationChangeEvent", () => {
  ...
  test("changeEvent affecting keys with new configuration", () => {
    ...
    const testObject = new ConfigurationChangeEvent(change, void 0, configuration, void 0, new NullLogService());
  ...
  test("changeEvent affecting keys when configuration changed", () => {
    ...
    const testObject = new ConfigurationChangeEvent(change, { data }, configuration, void 0, new NullLogService());
...
__name(toConfigurationModel, "toConfigurationModel");
export {
  TestConfiguration
};
