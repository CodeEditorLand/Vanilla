...
suite("ConfigurationModelParser", () => {
  ...
  test("parse configuration model with single override identifier", () => {
    ...
    assert.deepStrictEqual(
      JSON.stringify(testObject.configurationModel.overrides),
      JSON.stringify([
        { identifiers: ["x"], keys: ["a"], contents: { a: 1 } }
      ])
    );
  });
  test("parse configuration model with multiple override identifiers", () => {
    ...
    assert.deepStrictEqual(
      JSON.stringify(testObject.configurationModel.overrides),
      JSON.stringify([
        { identifiers: ["x", "y"], keys: ["a"], contents: { a: 1 } }
      ])
    );
  });
  ...
  test("parse configuration model with exclude option", () => {
    ...
    assert.strictEqual(
      testObject.configurationModel.getValue("a"),
      void 0
    );
  ...
  test("parse configuration model with exclude option even included", () => {
    ...
    testObject.parse(JSON.stringify({ a: 1, b: 2 }), {
      exclude: ["a"],
      include: ["a"]
    });
    assert.strictEqual(
  ...
  test("parse configuration model with scopes filter", () => {
    ...
    testObject.parse(
      JSON.stringify({
        "ConfigurationModelParserTest.windowSetting": "1"
      }),
      { scopes: [ConfigurationScope.APPLICATION] }
    );
    assert.strictEqual(
      testObject.configurationModel.getValue(
        "ConfigurationModelParserTest.windowSetting"
      ),
      void 0
    );
  ...
  test("parse configuration model with invalid setting key", () => {
    ...
    assert.strictEqual(
      testObject.configurationModel.getValue("a.b"),
      void 0
    );
    assert.strictEqual(
      testObject.configurationModel.getValue("a.b.c"),
      void 0
    );
  });
});
suite("ConfigurationModel", () => {
  ...
  test("get overriding configuration model for an existing identifier", () => {
    ...
    assert.deepStrictEqual(testObject.override("c").contents, {
      a: { b: 1, d: 1 },
      f: 1
    });
  });
  test("get overriding configuration model for an identifier that does not exist", () => {
    ...
    assert.deepStrictEqual(testObject.override("xyz").contents, {
      a: { b: 1 },
      f: 1
    });
  });
  ...
  test("simple merge", () => {
    ...
    const add = new ConfigurationModel(
      { a: 3, c: 4 },
      ["a", "c"],
      [],
      void 0,
  ...
  test("simple merge overrides", () => {
    const base = new ConfigurationModel(
      { a: { b: 1 } },
      ["a.b"],
      [{ identifiers: ["c"], contents: { a: 2 }, keys: ["a"] }],
      void 0,
      new NullLogService()
    );
    const add = new ConfigurationModel(
      { a: { b: 2 } },
      ["a.b"],
      [{ identifiers: ["c"], contents: { b: 2 }, keys: ["b"] }],
      void 0,
      new NullLogService()
    );
    const result = base.merge(add);
  ...
  test("recursive merge overrides", () => {
    ...
    const add = new ConfigurationModel(
      { a: { b: 2 } },
      ["a.b"],
      [{ identifiers: ["c"], contents: { a: { e: 2 } }, keys: ["a"] }],
      void 0,
      new NullLogService()
    );
    const result = base.merge(add);
    ...
    assert.deepStrictEqual(result.override("c").contents, {
      a: { b: 2, d: 1, e: 2 },
      f: 1
    });
  ...
  test("Test contents while getting an existing property", () => {
    ...
    testObject = new ConfigurationModel(
      { a: { b: 1 } },
      [],
      [],
      void 0,
  ...
  test("Test contents are undefined for non existing properties", () => {
    ...
    assert.deepStrictEqual(
      testObject.getValue("unknownproperty"),
      void 0
    );
  });
  test("Test override gives all content merged with overrides", () => {
    const testObject = new ConfigurationModel(
      { a: 1, c: 1 },
      [],
      [{ identifiers: ["b"], contents: { a: 2 }, keys: ["a"] }],
      void 0,
      new NullLogService()
    );
    assert.deepStrictEqual(testObject.override("b").contents, {
      a: 2,
      c: 1
    });
  });
  test("Test override when an override has multiple identifiers", () => {
    ...
    assert.deepStrictEqual(testObject.getKeysForOverrideIdentifier("x"), [
      "a"
    ]);
    actual = testObject.override("y");
    assert.deepStrictEqual(actual.contents, { a: 2, c: 1 });
    assert.deepStrictEqual(actual.keys, ["a", "c"]);
    assert.deepStrictEqual(testObject.getKeysForOverrideIdentifier("y"), [
      "a"
    ]);
  });
  ...
  test("Test merge when configuration models have multiple identifiers", () => {
    ...
    const target = new ConfigurationModel(
      { a: 2, b: 1 },
      ["a", "b"],
      [
        {
  ...
  test("inspect in merged configuration when raw is same", () => {
    const target1 = new ConfigurationModel(
      { a: 1 },
      ["a"],
      [{ identifiers: ["x", "y"], contents: { a: 2 }, keys: ["a"] }],
      void 0,
    ...
    const target2 = new ConfigurationModel(
      { b: 3 },
      ["b"],
      [],
      void 0,
...
suite("CustomConfigurationModel", () => {
  ...
  test("Test contents while getting an existing property", () => {
    ...
    assert.deepStrictEqual(testObject.configurationModel.getValue("a"), {
      b: 1
    });
  });
  test("Test contents are undefined for non existing properties", () => {
    ...
    assert.deepStrictEqual(
      testObject.configurationModel.getValue("unknownproperty"),
      void 0
    );
  });
  ...
  test("Test configWithOverrides gives all content merged with overrides", () => {
    ...
    assert.deepStrictEqual(
      testObject.configurationModel.override("b").contents,
      { a: 2, c: 1, "[b]": { a: 2 } }
    );
  });
  ...
  test("Test update with empty data", () => {
    ...
    testObject.parse("");
    assert.deepStrictEqual(
      testObject.configurationModel.contents,
  ...
  test("Test empty property is not ignored", () => {
    ...
    assert.strictEqual(
      JSON.stringify(testObject.configurationModel.contents),
      JSON.stringify({ "": 1 })
    );
    assert.deepStrictEqual(testObject.configurationModel.keys, [""]);
  });
...
suite("Configuration", () => {
  ...
  test("Test inspect for overrideIdentifiers", () => {
    ...
    const testObject = new TestConfiguration(
  ...
  test("Test compare and update default configuration", () => {
    ...
    testObject.updateDefaultConfiguration(
      toConfigurationModel({
        "editor.lineNumbers": "on"
      })
    );
    const actual = testObject.compareAndUpdateDefaultConfiguration(
      toConfigurationModel({
  ...
  test("Test compare and update application configuration", () => {
    ...
    testObject.updateApplicationConfiguration(
      toConfigurationModel({
        "update.mode": "on"
      })
    );
    const actual = testObject.compareAndUpdateApplicationConfiguration(
      toConfigurationModel({
        "update.mode": "none",
        "[typescript]": {
          "editor.wordWrap": "off"
  ...
  test("Test compare and update user configuration", () => {
    ...
    testObject.updateLocalUserConfiguration(
      toConfigurationModel({
        "editor.lineNumbers": "off",
        "editor.fontSize": 12,
        "[typescript]": {
    ...
    const actual = testObject.compareAndUpdateLocalUserConfiguration(
      toConfigurationModel({
        "editor.lineNumbers": "on",
        "window.zoomLevel": 1,
        "[typescript]": {
    ...
    assert.deepStrictEqual(actual, {
      ...
      overrides: [
        ["typescript", ["editor.insertSpaces", "editor.wordWrap"]]
      ]
    });
  });
  test("Test compare and update workspace configuration", () => {
    ...
    testObject.updateWorkspaceConfiguration(
      toConfigurationModel({
        "editor.lineNumbers": "off",
        "editor.fontSize": 12,
        "[typescript]": {
    ...
    const actual = testObject.compareAndUpdateWorkspaceConfiguration(
      toConfigurationModel({
        "editor.lineNumbers": "on",
        "window.zoomLevel": 1,
        "[typescript]": {
  ...
  test("Test compare and update workspace folder configuration", () => {
    ...
    testObject.updateFolderConfiguration(
      URI.file("file1"),
      toConfigurationModel({
        "editor.lineNumbers": "off",
        "editor.fontSize": 12,
    ...
    const actual = testObject.compareAndUpdateFolderConfiguration(
      URI.file("file1"),
      toConfigurationModel({
        "editor.lineNumbers": "on",
        "window.zoomLevel": 1,
  ...
  test("Test compare and delete workspace folder configuration", () => {
    ...
    const actual = testObject.compareAndDeleteFolderConfiguration(
      URI.file("file1")
    );
    assert.deepStrictEqual(actual, {
...
suite("ConfigurationChangeEvent", () => {
  ...
  test("changeEvent affecting keys with new configuration", () => {
    ...
    const testObject = new ConfigurationChangeEvent(
      change,
      void 0,
      configuration,
      void 0,
    ...
    assert.ok(
      testObject.affectsConfiguration("workbench.editor.enablePreview")
    );
  ...
  test("changeEvent affecting keys when configuration changed", () => {
    ...
    configuration.updateLocalUserConfiguration(
      toConfigurationModel({
        "window.zoomLevel": 2,
    ...
    assert.deepStrictEqual(
      [...testObject.affectedKeys],
      ["window.zoomLevel", "workbench.editor.enablePreview"]
    );
    assert.ok(testObject.affectsConfiguration("window.zoomLevel"));
    assert.ok(testObject.affectsConfiguration("window"));
    assert.ok(
  ...
  test("changeEvent affecting overrides with new configuration", () => {
    ...
    assert.ok(
      testObject.affectsConfiguration("editor", {
    ...
    assert.ok(
      testObject.affectsConfiguration("editor.wordWrap", {
        overrideIdentifier: "markdown"
      })
    );
    assert.ok(
    ...
    assert.ok(
      !testObject.affectsConfiguration("editor.lineNumbers", {
        overrideIdentifier: "markdown"
      })
    );
    assert.ok(
    ...
    assert.ok(
      !testObject.affectsConfiguration("editor.fontSize", {
        overrideIdentifier: "markdown"
      })
    );
  ...
  test("changeEvent affecting overrides when configuration changed", () => {
    ...
    assert.ok(!testObject.affectsConfiguration("[markdown].editor"));
    assert.ok(
      !testObject.affectsConfiguration("[markdown].editor.fontSize")
    );
    assert.ok(
      !testObject.affectsConfiguration("[markdown].editor.wordWrap")
    );
    assert.ok(!testObject.affectsConfiguration("[markdown].workbench"));
    ...
    assert.ok(
      testObject.affectsConfiguration("editor", {
        overrideIdentifier: "css"
      })
    );
    assert.ok(
      testObject.affectsConfiguration("editor", {
        overrideIdentifier: "scss"
      })
    );
    assert.ok(
      testObject.affectsConfiguration("editor.fontSize", {
    ...
    assert.ok(testObject.affectsConfiguration("window.zoomLevel"));
    assert.ok(
      testObject.affectsConfiguration("window", {
        overrideIdentifier: "markdown"
      })
    );
    assert.ok(
      testObject.affectsConfiguration("window.zoomLevel", {
        overrideIdentifier: "markdown"
      })
    );
    assert.ok(testObject.affectsConfiguration("workbench"));
    ...
    assert.ok(
      testObject.affectsConfiguration("workbench", {
        overrideIdentifier: "markdown"
      })
    );
    assert.ok(
      testObject.affectsConfiguration("workbench.editor", {
        overrideIdentifier: "markdown"
      })
    );
  });
  test("changeEvent affecting workspace folders", () => {
    ...
    configuration.updateWorkspaceConfiguration(
      toConfigurationModel({ "window.title": "custom" })
    );
    configuration.updateFolderConfiguration(
      URI.file("folder1"),
      toConfigurationModel({
        "window.zoomLevel": 2,
    ...
    const workspace = new Workspace("a", [
      new WorkspaceFolder({
        index: 0,
        name: "a",
        uri: URI.file("folder1")
      }),
      new WorkspaceFolder({
        index: 1,
        name: "b",
        uri: URI.file("folder2")
      }),
      new WorkspaceFolder({
        index: 2,
        name: "c",
        uri: URI.file("folder3")
      })
    ]);
    const change = mergeChanges(
      configuration.compareAndUpdateWorkspaceConfiguration(
        toConfigurationModel({ "window.title": "native" })
      ),
      configuration.compareAndUpdateFolderConfiguration(
        URI.file("folder1"),
        toConfigurationModel({
          "window.zoomLevel": 1,
    ...
    assert.ok(
      testObject.affectsConfiguration("window.restoreFullscreen", {
        resource: URI.file(join("folder1", "file1"))
      })
    );
    assert.ok(
    ...
    assert.ok(
      testObject.affectsConfiguration("window.restoreWindows", {
    ...
    assert.ok(
      testObject.affectsConfiguration("window.title", {
        resource: URI.file("folder1")
      })
    );
    assert.ok(
    ...
    assert.ok(!testObject.affectsConfiguration("files"));
    assert.ok(
      !testObject.affectsConfiguration("files", {
        resource: URI.file("folder1")
      })
    );
    assert.ok(
  ...
  test("changeEvent - all", () => {
    ...
    const data = configuration.toData();
    const change = mergeChanges(
      configuration.compareAndUpdateDefaultConfiguration(
        toConfigurationModel({
          "editor.lineNumbers": "off",
          "[markdown]": {
            "editor.wordWrap": "off"
      ...
      configuration.compareAndUpdateLocalUserConfiguration(
        toConfigurationModel({
          "[json]": {
            "editor.lineNumbers": "relative"
          }
      ...
      configuration.compareAndDeleteFolderConfiguration(
        URI.file("file1")
      ),
      configuration.compareAndUpdateFolderConfiguration(
        URI.file("file2"),
  ...
  test("affectsConfiguration returns false for empty string", () => {
    ...
    const change = configuration.compareAndUpdateLocalUserConfiguration(
      toConfigurationModel({ "window.zoomLevel": 1 })
    );
    const testObject = new ConfigurationChangeEvent(
      change,
      void 0,
