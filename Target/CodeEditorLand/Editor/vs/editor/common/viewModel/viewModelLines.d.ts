...
import { PositionAffinity, type IModelDecoration, type ITextModel } from "../model.js";
import type { ILineBreaksComputer, ILineBreaksComputerFactory, InjectedText, ModelLineProjectionData } from "../modelLineProjectionData.js";
import { IndentGuide, type BracketGuideOptions, type IActiveIndentGuideInfo } from "../textModelGuides.js";
import * as viewEvents from "../viewEvents.js";
import { ViewLineData, type ICoordinatesConverter } from "../viewModel.js";
export interface IViewModelLines extends IDisposable {
    ...
    onModelLineChanged(versionId: number | null, lineNumber: number, lineBreakData: ModelLineProjectionData | null): [
        boolean,
...
export declare class ViewModelLinesFromModelAsIs implements IViewModelLines {
    ...
    onModelLineChanged(_versionId: number | null, lineNumber: number, lineBreakData: ModelLineProjectionData | null): [
        boolean,
        viewEvents.ViewLinesChangedEvent | null,
        viewEvents.ViewLinesInsertedEvent | null,
        viewEvents.ViewLinesDeletedEvent | null
