    ...
    if (hasEmptyRange && emptySelectionClipboard) {
      ...
      for (const modelRange of modelRanges) {
        ...
        if (modelRange.isEmpty()) {
          ...
          result2.push(this.model.getValueInRange(modelRange, forceCRLF ? EndOfLinePreference.CRLF : EndOfLinePreference.TextDefined));
        }
...
class OverviewRulerDecorations {
  static {
    __name(this, "OverviewRulerDecorations");
  }
...
__name(mergeLineRangeArray, "mergeLineRangeArray");
...
__name(rangeArraysEqual, "rangeArraysEqual");
