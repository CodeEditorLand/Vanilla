...
const editorMultiCursorPrimaryForeground = registerColor(
...
const editorMultiCursorPrimaryBackground = registerColor(
...
const editorMultiCursorSecondaryForeground = registerColor(
...
const editorMultiCursorSecondaryBackground = registerColor(
...
const deprecatedEditorIndentGuides = registerColor(
...
const editorIndentGuide1 = registerColor(
...
const editorIndentGuide2 = registerColor(
...
const editorIndentGuide3 = registerColor(
...
const editorIndentGuide4 = registerColor(
...
const editorIndentGuide5 = registerColor(
...
const editorIndentGuide6 = registerColor(
...
const editorActiveIndentGuide1 = registerColor(
...
const editorActiveIndentGuide2 = registerColor(
...
const editorActiveIndentGuide3 = registerColor(
...
const editorActiveIndentGuide4 = registerColor(
...
const editorActiveIndentGuide5 = registerColor(
...
const editorActiveIndentGuide6 = registerColor(
...
const editorDimmedLineNumber = registerColor(
