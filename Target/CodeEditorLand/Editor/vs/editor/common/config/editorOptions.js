...
class EditorClassName extends ComputedEditorOption {
  constructor() {
    super(144 /* editorClassName */);
  }
  compute(env, options, _) {
    const classNames = ["monaco-editor"];
    if (options.get(40 /* extraEditorClassName */)) {
      classNames.push(options.get(40 /* extraEditorClassName */));
    }
    if (env.extraEditorClassName) {
      classNames.push(env.extraEditorClassName);
    }
    if (options.get(75 /* mouseStyle */) === "default") {
      classNames.push("mouse-default");
    } else if (options.get(75 /* mouseStyle */) === "copy") {
      classNames.push("mouse-copy");
    }
    if (options.get(113 /* showUnused */)) {
      classNames.push("showUnused");
    }
    if (options.get(142 /* showDeprecated */)) {
...
class EditorGoToLocation extends BaseEditorOption {
  constructor() {
    ...
    super(59 /* gotoLocation */, "gotoLocation", defaults, {
...
class EditorLayoutInfoComputer extends ComputedEditorOption {
  ...
  static computeLayout(options, env) {
    ...
    const wordWrapOverride2 = options.get(139 /* wordWrapOverride2 */);
    const wordWrapOverride1 = wordWrapOverride2 === "inherit" ? options.get(138 /* wordWrapOverride1 */) : wordWrapOverride2;
    const wordWrap = wordWrapOverride1 === "inherit" ? options.get(134 /* wordWrap */) : wordWrapOverride1;
    const wordWrapColumn = options.get(137 /* wordWrapColumn */);
    const isDominatedByLongLines = env.isDominatedByLongLines;
    const showGlyphMargin = options.get(58 /* glyphMargin */);
    const showLineNumbers = options.get(69 /* lineNumbers */).renderType !== 0 /* Off */;
    const lineNumbersMinChars = options.get(
      70 /* lineNumbersMinChars */
    );
    const scrollBeyondLastLine = options.get(
      107 /* scrollBeyondLastLine */
    );
    const padding = options.get(85 /* padding */);
    const minimap = options.get(74 /* minimap */);
    const scrollbar = options.get(105 /* scrollbar */);
    const verticalScrollbarWidth = scrollbar.verticalScrollbarSize;
    const verticalScrollbarHasArrows = scrollbar.verticalHasArrows;
    const scrollbarArrowSize = scrollbar.arrowSize;
    const horizontalScrollbarHeight = scrollbar.horizontalScrollbarSize;
    const folding = options.get(44 /* folding */);
    const showFoldingDecoration = options.get(112 /* showFoldingControls */) !== "never";
    let lineDecorationsWidth = options.get(
      67 /* lineDecorationsWidth */
    );
...
class WrappingStrategy extends BaseEditorOption {
  constructor() {
    super(141 /* wrappingStrategy */, "wrappingStrategy", "simple", {
...
class EditorLightbulb extends BaseEditorOption {
  constructor() {
    ...
    super(66 /* lightbulb */, "lightbulb", defaults, {
...
class EditorStickyScroll extends BaseEditorOption {
  constructor() {
    ...
    super(117 /* stickyScroll */, "stickyScroll", defaults, {
...
class EditorInlayHints extends BaseEditorOption {
  constructor() {
    ...
    super(143 /* inlayHints */, "inlayHints", defaults, {
...
class EditorLineDecorationsWidth extends BaseEditorOption {
  constructor() {
    super(67 /* lineDecorationsWidth */, "lineDecorationsWidth", 10);
  }
  validate(input) {
...
class EditorMinimap extends BaseEditorOption {
  constructor() {
    ...
    super(74 /* minimap */, "minimap", defaults, {
...
class EditorParameterHints extends BaseEditorOption {
  constructor() {
    ...
    super(87 /* parameterHints */, "parameterHints", defaults, {
...
class PlaceholderOption extends BaseEditorOption {
  constructor() {
    super(89 /* placeholder */, "placeholder", void 0);
  }
  validate(input) {
    if (typeof input === "undefined") {
      return this.defaultValue;
...
class EditorQuickSuggestions extends BaseEditorOption {
  ...
  constructor() {
    ...
    super(91 /* quickSuggestions */, "quickSuggestions", defaults, {
      type: "object",
...
function filterValidationDecorations(options) {
  const renderValidationDecorations = options.get(
    100 /* renderValidationDecorations */
  );
  if (renderValidationDecorations === "editable") {
    return options.get(93 /* readOnly */);
  }
...
class EditorRulers extends BaseEditorOption {
  constructor() {
    ...
    super(104 /* rulers */, "rulers", defaults, {
      type: "array",
      items: {
        anyOf: [
          columnSchema,
...
class ReadonlyMessage extends BaseEditorOption {
  constructor() {
    ...
    super(94 /* readOnlyMessage */, "readOnlyMessage", defaults);
  }
  validate(_input) {
    if (!_input || typeof _input !== "object") {
      return this.defaultValue;
...
class EditorScrollbar extends BaseEditorOption {
  constructor() {
    ...
    super(105 /* scrollbar */, "scrollbar", defaults, {
...
class UnicodeHighlight extends BaseEditorOption {
  constructor() {
    ...
    super(127 /* unicodeHighlighting */, "unicodeHighlight", defaults, {
...
class InlineEditorSuggest extends BaseEditorOption {
  constructor() {
    ...
    super(63 /* inlineSuggest */, "inlineSuggest", defaults, {
...
class InlineEditorEdit extends BaseEditorOption {
  constructor() {
    ...
    super(64 /* inlineEdit */, "experimentalInlineEdit", defaults, {
...
class EditorSuggest extends BaseEditorOption {
  constructor() {
    ...
    super(120 /* suggest */, "suggest", defaults, {
...
class EditorWrappingInfoComputer extends ComputedEditorOption {
  constructor() {
    super(148 /* wrappingInfo */);
  }
  compute(env, options, _) {
    const layoutInfo = options.get(147 /* layoutInfo */);
    return {
      isDominatedByLongLines: env.isDominatedByLongLines,
...
class EditorPasteAs extends BaseEditorOption {
  constructor() {
    ...
    super(86 /* pasteAs */, "pasteAs", defaults, {
...
const EditorOptions = {
  ...
  colorDecoratorActivatedOn: register(
    new EditorStringEnumOption(
      150 /* colorDecoratorsActivatedOn */,
  ...
  fixedOverflowWidgets: register(
    new EditorBooleanOption(
      43 /* fixedOverflowWidgets */,
      "fixedOverflowWidgets",
      false
    )
  ),
  folding: register(
    new EditorBooleanOption(44 /* folding */, "folding", true, {
      description: nls.localize(
        "folding",
  ...
  unfoldOnClickAfterEndOfLine: register(
    new EditorBooleanOption(
      49 /* unfoldOnClickAfterEndOfLine */,
  ...
  glyphMargin: register(
    new EditorBooleanOption(58 /* glyphMargin */, "glyphMargin", true, {
      description: nls.localize(
        "glyphMargin",
  ...
  links: register(
    new EditorBooleanOption(72 /* links */, "links", true, {
      description: nls.localize(
        "links",
  ...
  mouseWheelScrollSensitivity: register(
    new EditorFloatOption(
      76 /* mouseWheelScrollSensitivity */,
  ...
  multiCursorMergeOverlapping: register(
    new EditorBooleanOption(
      78 /* multiCursorMergeOverlapping */,
  ...
  readOnly: register(
    new EditorBooleanOption(93 /* readOnly */, "readOnly", false)
  ),
  ...
  renderLineHighlightOnlyWhenFocus: register(
    new EditorBooleanOption(
      99 /* renderLineHighlightOnlyWhenFocus */,
  ...
  revealHorizontalRightPadding: register(
    new EditorIntOption(
      102 /* revealHorizontalRightPadding */,
  ...
  showUnused: register(
    new EditorBooleanOption(113 /* showUnused */, "showUnused", true, {
      description: nls.localize(
        "showUnused",
  ...
  inlineCompletionsAccessibilityVerbose: register(
    new EditorBooleanOption(
      151 /* inlineCompletionsAccessibilityVerbose */,
  ...
  suggestOnTriggerCharacters: register(
    new EditorBooleanOption(
      123 /* suggestOnTriggerCharacters */,
  ...
  useTabStops: register(
    new EditorBooleanOption(130 /* useTabStops */, "useTabStops", true, {
      description: nls.localize(
        "useTabStops",
  ...
  wordWrapBreakAfterCharacters: register(
    new EditorStringOption(
      135 /* wordWrapBreakAfterCharacters */,
  ...
  wordWrapBreakBeforeCharacters: register(
    new EditorStringOption(
      136 /* wordWrapBreakBeforeCharacters */,
