...
class EditorFontWeight extends BaseEditorOption {
  ...
  static SUGGESTION_VALUES = ["normal", "bold", "100", "200", "300", "400", "500", "600", "700", "800", "900"];
...
class EditorLayoutInfoComputer extends ComputedEditorOption {
  ...
  static computeLayout(options, env) {
    ...
    const lineNumbersMinChars = options.get(71 /* lineNumbersMinChars */);
    const scrollBeyondLastLine = options.get(108 /* scrollBeyondLastLine */);
    ...
    let lineDecorationsWidth = options.get(68 /* lineDecorationsWidth */);
...
function filterValidationDecorations(options) {
  const renderValidationDecorations = options.get(101 /* renderValidationDecorations */);
...
const EditorOptions = {
  ...
  codeLensFontSize: register(new EditorIntOption(19 /* codeLensFontSize */, "codeLensFontSize", 0, 0, 100, {
    type: "number",
    default: 0,
    minimum: 0,
    maximum: 100,
  ...
  colorDecoratorActivatedOn: register(new EditorStringEnumOption(151 /* colorDecoratorsActivatedOn */, "colorDecoratorsActivatedOn", "clickAndHover", ["clickAndHover", "hover", "click"], {
    enumDescriptions: [
