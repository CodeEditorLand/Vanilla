...
((AccessibilityHelpNLS2) => {
  AccessibilityHelpNLS2.accessibilityHelpTitle = nls.localize(
    "accessibilityHelpTitle",
    "Accessibility Help"
  );
  AccessibilityHelpNLS2.openingDocs = nls.localize(
    "openingDocs",
    "Opening the Accessibility documentation page."
  );
  AccessibilityHelpNLS2.readonlyDiffEditor = nls.localize(
    "readonlyDiffEditor",
    "You are in a read-only pane of a diff editor."
  );
  AccessibilityHelpNLS2.editableDiffEditor = nls.localize(
    "editableDiffEditor",
    "You are in a pane of a diff editor."
  );
  AccessibilityHelpNLS2.readonlyEditor = nls.localize(
    "readonlyEditor",
    "You are in a read-only code editor."
  );
  AccessibilityHelpNLS2.editableEditor = nls.localize(
    "editableEditor",
    "You are in a code editor."
  );
  AccessibilityHelpNLS2.changeConfigToOnMac = nls.localize(
    "changeConfigToOnMac",
    "Configure the application to be optimized for usage with a Screen Reader (Command+E)."
  );
  AccessibilityHelpNLS2.changeConfigToOnWinLinux = nls.localize(
    "changeConfigToOnWinLinux",
    "Configure the application to be optimized for usage with a Screen Reader (Control+E)."
  );
  AccessibilityHelpNLS2.auto_on = nls.localize(
    "auto_on",
    "The application is configured to be optimized for usage with a Screen Reader."
  );
  AccessibilityHelpNLS2.auto_off = nls.localize(
    "auto_off",
    "The application is configured to never be optimized for usage with a Screen Reader."
  );
  AccessibilityHelpNLS2.screenReaderModeEnabled = nls.localize(
    "screenReaderModeEnabled",
    "Screen Reader Optimized Mode enabled."
  );
  AccessibilityHelpNLS2.screenReaderModeDisabled = nls.localize(
    "screenReaderModeDisabled",
    "Screen Reader Optimized Mode disabled."
  );
  AccessibilityHelpNLS2.tabFocusModeOnMsg = nls.localize(
    "tabFocusModeOnMsg",
  ...
  AccessibilityHelpNLS2.intellisense = nls.localize(
    "intellisense",
  ...
  AccessibilityHelpNLS2.addToWatch = nls.localize(
  ...
  AccessibilityHelpNLS2.debugExecuteSelection = nls.localize(
...
((InspectTokensNLS2) => {
  InspectTokensNLS2.inspectTokensAction = nls.localize(
    "inspectTokens",
...
var GoToLineNLS;
((GoToLineNLS2) => {
  GoToLineNLS2.gotoLineActionLabel = nls.localize(
    "gotoLineActionLabel",
    "Go to Line/Column..."
  );
...
var QuickHelpNLS;
((QuickHelpNLS2) => {
  QuickHelpNLS2.helpQuickAccessActionLabel = nls.localize(
    "helpQuickAccess",
...
var QuickCommandNLS;
((QuickCommandNLS2) => {
  QuickCommandNLS2.quickCommandActionLabel = nls.localize(
    "quickCommandActionLabel",
    "Command Palette"
  );
  QuickCommandNLS2.quickCommandHelp = nls.localize(
...
var QuickOutlineNLS;
((QuickOutlineNLS2) => {
  QuickOutlineNLS2.quickOutlineActionLabel = nls.localize(
    "quickOutlineActionLabel",
    "Go to Symbol..."
  );
  QuickOutlineNLS2.quickOutlineByCategoryActionLabel = nls.localize(
    "quickOutlineByCategoryActionLabel",
    "Go to Symbol by Category..."
  );
})(QuickOutlineNLS || (QuickOutlineNLS = {}));
var StandaloneCodeEditorNLS;
((StandaloneCodeEditorNLS2) => {
  StandaloneCodeEditorNLS2.editorViewAccessibleLabel = nls.localize(
    "editorViewAccessibleLabel",
    "Editor content"
  );
})(StandaloneCodeEditorNLS || (StandaloneCodeEditorNLS = {}));
var ToggleHighContrastNLS;
((ToggleHighContrastNLS2) => {
  ToggleHighContrastNLS2.toggleHighContrast = nls.localize(
    "toggleHighContrast",
    "Toggle High Contrast Theme"
  );
})(ToggleHighContrastNLS || (ToggleHighContrastNLS = {}));
var StandaloneServicesNLS;
((StandaloneServicesNLS2) => {
  StandaloneServicesNLS2.bulkEditServiceSummary = nls.localize(
