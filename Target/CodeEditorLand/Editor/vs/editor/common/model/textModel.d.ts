...
export declare class TextModel extends Disposable implements model.ITextModel, IDecorationsTreesHost {
    ...
    get onDidChangeLanguage(): any;
    get onDidChangeLanguageConfiguration(): any;
    get onDidChangeTokens(): any;
    ...
    constructor(source: string | model.ITextBufferFactory, languageIdOrSelection: string | ILanguageSelection, creationOptions: model.ITextModelCreationOptions, associatedResource: URI | null, _undoRedoService: IUndoRedoService, _languageService: ILanguageService, _languageConfigurationService: ILanguageConfigurationService, instantiationService: IInstantiationService);
    dispose(): void;
