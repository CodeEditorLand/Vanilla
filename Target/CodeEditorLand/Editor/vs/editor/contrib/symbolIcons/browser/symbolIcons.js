...
const SYMBOL_ICON_BOOLEAN_FOREGROUND = registerColor(
...
const SYMBOL_ICON_CLASS_FOREGROUND = registerColor(
...
const SYMBOL_ICON_COLOR_FOREGROUND = registerColor(
...
const SYMBOL_ICON_CONSTANT_FOREGROUND = registerColor(
...
const SYMBOL_ICON_CONSTRUCTOR_FOREGROUND = registerColor(
...
const SYMBOL_ICON_ENUMERATOR_FOREGROUND = registerColor(
...
const SYMBOL_ICON_ENUMERATOR_MEMBER_FOREGROUND = registerColor(
...
const SYMBOL_ICON_EVENT_FOREGROUND = registerColor(
...
const SYMBOL_ICON_FIELD_FOREGROUND = registerColor(
...
const SYMBOL_ICON_FILE_FOREGROUND = registerColor(
...
const SYMBOL_ICON_FOLDER_FOREGROUND = registerColor(
...
const SYMBOL_ICON_FUNCTION_FOREGROUND = registerColor(
...
const SYMBOL_ICON_INTERFACE_FOREGROUND = registerColor(
...
const SYMBOL_ICON_KEY_FOREGROUND = registerColor(
...
const SYMBOL_ICON_KEYWORD_FOREGROUND = registerColor(
...
const SYMBOL_ICON_METHOD_FOREGROUND = registerColor(
...
const SYMBOL_ICON_MODULE_FOREGROUND = registerColor(
...
const SYMBOL_ICON_NAMESPACE_FOREGROUND = registerColor(
...
const SYMBOL_ICON_NULL_FOREGROUND = registerColor(
...
const SYMBOL_ICON_NUMBER_FOREGROUND = registerColor(
...
const SYMBOL_ICON_OBJECT_FOREGROUND = registerColor(
...
const SYMBOL_ICON_OPERATOR_FOREGROUND = registerColor(
...
const SYMBOL_ICON_PACKAGE_FOREGROUND = registerColor(
...
const SYMBOL_ICON_PROPERTY_FOREGROUND = registerColor(
...
const SYMBOL_ICON_REFERENCE_FOREGROUND = registerColor(
...
const SYMBOL_ICON_SNIPPET_FOREGROUND = registerColor(
...
const SYMBOL_ICON_STRING_FOREGROUND = registerColor(
...
const SYMBOL_ICON_STRUCT_FOREGROUND = registerColor(
...
const SYMBOL_ICON_TEXT_FOREGROUND = registerColor(
...
const SYMBOL_ICON_TYPEPARAMETER_FOREGROUND = registerColor(
...
const SYMBOL_ICON_UNIT_FOREGROUND = registerColor(
...
const SYMBOL_ICON_VARIABLE_FOREGROUND = registerColor(
...
export {
  SYMBOL_ICON_ARRAY_FOREGROUND,
  SYMBOL_ICON_BOOLEAN_FOREGROUND,
  SYMBOL_ICON_CLASS_FOREGROUND,
  SYMBOL_ICON_COLOR_FOREGROUND,
  ...
  SYMBOL_ICON_FIELD_FOREGROUND,
  SYMBOL_ICON_FILE_FOREGROUND,
  SYMBOL_ICON_FOLDER_FOREGROUND,
  SYMBOL_ICON_FUNCTION_FOREGROUND,
  SYMBOL_ICON_INTERFACE_FOREGROUND,
  SYMBOL_ICON_KEYWORD_FOREGROUND,
  SYMBOL_ICON_KEY_FOREGROUND,
  SYMBOL_ICON_METHOD_FOREGROUND,
  SYMBOL_ICON_MODULE_FOREGROUND,
  SYMBOL_ICON_NAMESPACE_FOREGROUND,
  SYMBOL_ICON_NULL_FOREGROUND,
  SYMBOL_ICON_NUMBER_FOREGROUND,
  SYMBOL_ICON_OBJECT_FOREGROUND,
  SYMBOL_ICON_OPERATOR_FOREGROUND,
  SYMBOL_ICON_PACKAGE_FOREGROUND,
  SYMBOL_ICON_PROPERTY_FOREGROUND,
  SYMBOL_ICON_REFERENCE_FOREGROUND,
  SYMBOL_ICON_SNIPPET_FOREGROUND,
  SYMBOL_ICON_STRING_FOREGROUND,
  SYMBOL_ICON_STRUCT_FOREGROUND,
  SYMBOL_ICON_TEXT_FOREGROUND,
  SYMBOL_ICON_TYPEPARAMETER_FOREGROUND,
  SYMBOL_ICON_UNIT_FOREGROUND,
