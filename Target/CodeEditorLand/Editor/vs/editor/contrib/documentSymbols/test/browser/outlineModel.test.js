...
suite("OutlineModel", () => {
  ...
  test("OutlineModel#create, cached", async () => {
  ...
  test("OutlineModel#create, cached/cancel", async () => {
    const insta = createModelServices(disposables);
    const modelService = insta.get(IModelService);
    const envService = new class extends mock() {
      isBuilt = true;
  ...
  test("OutlineElement - updateMarker", () => {
  ...
  test("OutlineElement - updateMarker, 2", () => {
  ...
  test("OutlineElement - updateMarker/multiple groups", () => {
    ...
    model.children.get("g1").children.set(
      "c1",
      new OutlineElement(
        "c1",
    ...
    model.children.get("g2").children.set(
      "c2",
      new OutlineElement(
        "c2",
    ...
    model.children.get("g2").children.get("c2").children.set(
      "c2.1",
      new OutlineElement(
        "c2.1",
