...
let InlineEditSideBySideWidget = class extends Disposable {
  ...
  static _createUniqueUri() {
    return URI.from({ scheme: "inline-edit-widget", path: (/* @__PURE__ */ new Date()).toString() + String(InlineEditSideBySideWidget._modelId++) });
  }
  ...
  _originalModel = derivedDisposable(() => this._modelService.createModel("", null, InlineEditSideBySideWidget._createUniqueUri())).keepObserved(this._store);
  _modifiedModel = derivedDisposable(() => this._modelService.createModel("", null, InlineEditSideBySideWidget._createUniqueUri())).keepObserved(this._store);
...
let InlineEditSideBySideContentWidget = class extends Disposable {
  ...
  _scrollChanged = observableSignalFromEvent("editor.onDidScrollChange", this._editor.onDidScrollChange);
