...
suite("Snippet Variables Resolver", function() {
  ...
  __name(assertVariableResolve, "assertVariableResolve");
  ...
  __name(assertVariableResolve2, "assertVariableResolve2");
  ...
  __name(assertVariableResolve3, "assertVariableResolve3");
  ...
  test("Add RELATIVE_FILEPATH snippet variable #114208", function() {
    let resolver2;
    const workspaceLabelService = /* @__PURE__ */ __name((rootPath) => {
      const labelService2 = new class extends mock() {
