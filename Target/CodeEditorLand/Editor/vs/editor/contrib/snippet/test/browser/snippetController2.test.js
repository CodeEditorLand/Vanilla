...
suite("SnippetController2", () => {
  ...
  test("insert, insert -> tab, tab, done", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    ...
    assert.strictEqual(
      SnippetController2.InSnippetMode.getValue(contextKeys),
      false
    );
    assert.strictEqual(
      SnippetController2.HasNextTabstop.getValue(contextKeys),
      false
    );
    assert.strictEqual(
      SnippetController2.HasPrevTabstop.getValue(contextKeys),
      false
    );
  });
  test("insert, insert -> cursor moves out (left/right)", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    ctrl.insert("foo${1:bar}foo$0");
    assertContextKeys(contextKeys, true, false, true);
    assertSelections(
  ...
  test("insert, insert -> cursor moves out (up/down)", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    ctrl.insert("foo${1:bar}foo$0");
    assertContextKeys(contextKeys, true, false, true);
    assertSelections(
    ...
    editor.setSelections([
      ...
      new Selection(3, 8, 3, 11)
    ]);
    assertContextKeys(contextKeys, false, false, false);
  });
  test("insert, insert -> cursors collapse", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    ctrl.insert("foo${1:bar}foo$0");
    assert.strictEqual(
      SnippetController2.InSnippetMode.getValue(contextKeys),
  ...
  test("insert, insert plain text -> no snippet mode", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    ctrl.insert("foobar");
    assertContextKeys(contextKeys, false, false, false);
    assertSelections(
  ...
  test("insert, delete snippet text", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
  ...
  test("insert, nested trivial snippet", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
  ...
  test("Nested snippets without final placeholder jumps to next outer placeholder, #27898", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    ctrl.insert("for(const ${1:element} of ${2:array}) {$0}");
    assertContextKeys(contextKeys, true, false, true);
    assertSelections(
      editor,
      new Selection(1, 11, 1, 18),
      new Selection(2, 15, 2, 22)
    );
    ctrl.next();
    assertContextKeys(contextKeys, true, true, true);
    assertSelections(
      editor,
      new Selection(1, 22, 1, 27),
      new Selection(2, 26, 2, 31)
    );
    ...
    assertSelections(
      ...
      new Selection(2, 34, 2, 34)
    );
    ctrl.next();
    assertContextKeys(contextKeys, false, false, false);
  });
  test("Inconsistent tab stop behaviour with recursive snippets and tab / shift tab, #27543", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    ...
    assertSelections(
      ...
      new Selection(2, 14, 2, 16)
    );
    ctrl.insert("2_calize(${1:nl}, '${2:value}')$0");
    assertSelections(
      editor,
      new Selection(1, 19, 1, 21),
      new Selection(2, 23, 2, 25)
    );
    ctrl.next();
    assertSelections(
      editor,
      new Selection(1, 24, 1, 29),
      new Selection(2, 28, 2, 33)
    );
    ctrl.next();
    assertSelections(
      editor,
      new Selection(1, 31, 1, 31),
      new Selection(2, 35, 2, 35)
    );
    ctrl.next();
    assertSelections(
      editor,
      new Selection(1, 34, 1, 39),
      new Selection(2, 38, 2, 43)
    );
    ctrl.prev();
    assertSelections(
      editor,
  ...
  test("Snippet tabstop selecting content of previously entered variable only works when separated by space, #23728", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    ...
    assertSelections(
      editor,
      new Selection(1, 8, 1, 14),
      new Selection(1, 21, 1, 27)
    );
    ctrl.insert("foo");
    assertSelections(
      editor,
  ...
  test("HTML Snippets Combine, #32211", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    model.updateOptions({
      insertSpaces: false,
  ...
  test("Problems with nested snippet insertion #39594", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    editor.setSelection(new Selection(1, 1, 1, 1));
  ...
  test("Problems with nested snippet insertion #39594 (part2)", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("a-\naaa-");
    editor.setSelections([
      new Selection(2, 5, 2, 5),
  ...
  test("\u201CNested\u201D snippets terminating abruptly in VSCode 1.19.2. #42012", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    editor.setSelection(new Selection(1, 1, 1, 1));
    ...
    assertSelections(
      editor,
      new Selection(1, 5, 1, 9),
      new Selection(1, 12, 1, 16)
    );
    assertContextKeys(contextKeys, true, false, true);
    ctrl.next();
    assertContextKeys(contextKeys, true, true, true);
  });
  test("Placeholders order #58267", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    editor.setSelection(new Selection(1, 1, 1, 1));
    ctrl.insert("\\pth{$1}$0");
    ...
    assertContextKeys(contextKeys, true, false, true);
    ctrl.insert(
      "\\itv{${1:left}}{${2:right}}{${3:left_value}}{${4:right_value}}$0"
    );
  ...
  test("Must tab through deleted tab stops in snippets #31619", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    editor.setSelection(new Selection(1, 1, 1, 1));
  ...
  test("Cancelling snippet mode should discard added cursors #68512 (soft cancel)", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    editor.setSelection(new Selection(1, 1, 1, 1));
    ctrl.insert(
    ...
    assertSelections(
      editor,
      new Selection(1, 9, 1, 22),
      new Selection(2, 22, 2, 35)
    );
    assertContextKeys(contextKeys, true, true, true);
    editor.setSelections([
  ...
  test("Cancelling snippet mode should discard added cursors #68512 (hard cancel)", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    editor.setSelection(new Selection(1, 1, 1, 1));
    ctrl.insert(
  ...
  test("User defined snippet tab stops ignored #72862", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    editor.setSelection(new Selection(1, 1, 1, 1));
  ...
  test("Optional tabstop in snippets #72358", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    editor.setSelection(new Selection(1, 1, 1, 1));
  ...
  test("issue #90135: confusing trim whitespace edits", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
  ...
  test("issue #145727: insertSnippet can put snippet selections in wrong positions (1 of 2)", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
    ctrl.insert(
    ...
    assertSelections(
      editor,
      new Selection(2, 19, 2, 26),
      new Selection(2, 41, 2, 48)
    );
  });
  test("issue #145727: insertSnippet can put snippet selections in wrong positions (2 of 2)", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
    ctrl.insert(
    ...
    assertSelections(
      editor,
      new Selection(2, 23, 2, 30),
      new Selection(2, 45, 2, 52)
    );
  });
  test("leading TAB by snippets won't replace by spaces #101870", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
  ...
  test("leading TAB by snippets won't replace by spaces #101870 (part 2)", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    model.updateOptions({ insertSpaces: true, tabSize: 4 });
    ctrl.insert("	Hello World\n	New Line\n${1:	more}");
  ...
  test.skip("Snippet transformation does not work after inserting variable using intellisense, #112362", () => {
    {
      ctrl = instaService.createInstance(SnippetController2, editor);
      model.setValue("");
      model.updateOptions({ insertSpaces: true, tabSize: 4 });
...
foo: 'number',`);
  ...
  suite("createEditsAndSnippetsFromEdits", () => {
    ...
    test("apply, tab, done with special final tabstop", () => {
      model.setValue('foo("bar")');
      ctrl = instaService.createInstance(SnippetController2, editor);
      ctrl.apply([
        { range: new Range(1, 5, 1, 10), template: "$1" },
        {
          range: new Range(1, 1, 1, 1),
          template: 'const ${1:new_const}$0 = "bar";\n'
        }
      ]);
      assert.strictEqual(
        model.getValue(),
    ...
    test('nested into insert abort "outer" snippet', () => {
      ctrl = instaService.createInstance(SnippetController2, editor);
      model.setValue("one\ntwo");
      editor.setSelections([
        new Selection(1, 1, 1, 1),
    ...
    test('nested into "insert" abort "outer" snippet (2)', () => {
      ctrl = instaService.createInstance(SnippetController2, editor);
      model.setValue("one\ntwo");
      editor.setSelections([
        new Selection(1, 1, 1, 1),
  ...
  test("Bug: cursor position $0 with user snippets #163808", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
    ctrl.insert(
      '<Element1 Attr1="foo" $1>\n  <Element2 Attr1="$2"/>\n$0"\n</Element1>'
    );
    assert.deepStrictEqual(editor.getSelections(), [
    ...
    assert.strictEqual(
      model.getValue(),
      '<Element1 Attr1="foo" Qualifier="">\n  <Element2 Attr1=""/>\n"\n</Element1>'
    );
    assert.deepStrictEqual(editor.getSelections(), [
      new Selection(1, 34, 1, 34)
    ]);
  });
  test("EOL-Sequence (CRLF) shifts tab stop in isFileTemplate snippets #167386", () => {
    ctrl = instaService.createInstance(SnippetController2, editor);
    model.setValue("");
  ...
  test('"Surround With" code action snippets use incorrect indentation levels and styles #169319', () => {
    model.setValue(
      "function foo(f, x, condition) {\n    f();\n    return x;\n}"
    );
