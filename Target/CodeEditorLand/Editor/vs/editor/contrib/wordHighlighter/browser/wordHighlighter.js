...
let WordHighlighter = class {
      ...
      editor.onDidChangeConfiguration((e) => {
        ...
        if (this.occurrencesHighlight !== newValue) {
          ...
          switch (newValue) {
            ...
            case "singleFile":
              this._stopAll(
                WordHighlighter.query?.modelInfo?.model
              );
              break;
            case "multiFile":
  ...
  _stopSingular() {
    ...
    if (this.editor.hasTextFocus()) {
      if (this.editor.getModel()?.uri.scheme !== Schemas.vscodeNotebookCell && WordHighlighter.query?.modelInfo?.model.uri.scheme !== Schemas.vscodeNotebookCell) {
  ...
  _run(multiFileConfigChange) {
    ...
    if (workerRequestIsValid) {
      ...
      this.editor.getModel().uri,
      WordHighlighter.query.modelInfo?.model.uri
    )) {
      ...
      this._stopAll(multiFileConfigChange ? this.model : void 0);
