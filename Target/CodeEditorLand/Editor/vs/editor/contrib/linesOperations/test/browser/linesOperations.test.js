...
__name(assertSelection, "assertSelection");
...
suite("Editor Contrib - Line Operations", () => {
  ...
  test("InsertLineBeforeAction", () => {
    ...
    __name(testInsertLineBefore, "testInsertLineBefore");
  ...
  test("InsertLineAfterAction", () => {
    ...
    __name(testInsertLineAfter, "testInsertLineAfter");
  ...
  __name(testDeleteLinesCommand, "testDeleteLinesCommand");
