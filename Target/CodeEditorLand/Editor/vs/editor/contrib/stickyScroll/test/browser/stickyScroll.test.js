...
suite("Sticky Scroll Tests", () => {
  ...
  __name(documentSymbolProviderForTestModel, "documentSymbolProviderForTestModel");
  ...
  __name(documentSymbolProviderForSecondTestModel, "documentSymbolProviderForSecondTestModel");
