...
suite("Folding with regions", () => {
  ...
  test("Nested Regions 2", () => {
    assertRanges(
      ...
      [r(1, 8, -1), r(2, 8, 0, true), r(4, 6, 1, true)],
      false,
      markers
    );
  });
