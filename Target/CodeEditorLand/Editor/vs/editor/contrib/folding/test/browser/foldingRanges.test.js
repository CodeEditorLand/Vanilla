...
suite("FoldingRanges", () => {
  ...
  const foldRange = /* @__PURE__ */ __name((from, to, collapsed = void 0, source = FoldSource.provider, type = void 0) => ({
  ...
  const assertEqualRanges = /* @__PURE__ */ __name((range1, range2, msg) => {
  ...
  test("test max folding regions", () => {
    ...
    const collector = new RangesCollector({ limit: MAX_FOLDING_REGIONS, update: /* @__PURE__ */ __name(() => {
    }, "update") });
