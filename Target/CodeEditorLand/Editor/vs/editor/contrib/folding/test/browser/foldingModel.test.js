...
class TestDecorationProvider {
  ...
  static collapsedDecoration = ModelDecorationOptions.register({
    description: "test",
    stickiness: TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
    linesDecorationsClassName: "folding"
  });
  static expandedDecoration = ModelDecorationOptions.register({
    description: "test",
    stickiness: TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
    linesDecorationsClassName: "folding"
  });
  static hiddenDecoration = ModelDecorationOptions.register({
    description: "test",
    stickiness: TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
    linesDecorationsClassName: "folding"
  });
...
suite("Folding Model", () => {
  ...
  function assertFoldedRanges(foldingModel, expectedRegions, message) {
    ...
    for (let i = 0; i < actual.length; i++) {
      if (actual.isCollapsed(i)) {
        actualRanges.push(
          r(actual.getStartLineNumber(i), actual.getEndLineNumber(i))
        );
      }
    }
  ...
  function assertDecorations(foldingModel, expectedDecoration, message) {
    ...
    assert.deepStrictEqual(
      decorationProvider.getDecorations(),
      expectedDecoration,
      message
    );
  }
  ...
  test("collapse", () => {
    ...
    try {
      ...
      foldingModel.toggleCollapseState([
        foldingModel.getRegionAtLine(7)
      ]);
      foldingModel.update(ranges);
      assertRanges(foldingModel, [
        r(1, 3, true),
        r(4, 7, true),
        r(5, 6, true)
      ]);
  ...
  test("update", () => {
    ...
    try {
      ...
      textModel.applyEdits([
        EditOperation.insert(new Position(4, 1), "//hello\n")
      ]);
  ...
  test("delete", () => {
    ...
    try {
      ...
      textModel.applyEdits([
        EditOperation.delete(new Range(6, 11, 9, 0))
      ]);
      foldingModel.update(
        computeRanges(textModel, true, void 0),
  ...
  test("getRegionsInside", () => {
    ...
    try {
      ...
      assertRegions(
        foldingModel.getRegionsInside(null),
        [r1, r2, r3],
        "1"
      );
  ...
  test("getRegionsInsideWithLevel", () => {
    ...
    try {
      ...
      assertRanges(foldingModel, [r1, r2, r3, r4, r5]);
      assertRegions(
        foldingModel.getRegionsInside(null, (r6, level) => level === 1),
        [r1, r2],
        "1"
      );
      assertRegions(
        foldingModel.getRegionsInside(null, (r6, level) => level === 2),
        [r3],
        "2"
      );
      assertRegions(
        foldingModel.getRegionsInside(null, (r6, level) => level === 3),
        [r4, r5],
        "3"
      );
      assertRegions(
        foldingModel.getRegionsInside(
          region2,
          (r6, level) => level === 1
        ),
        [r3],
  ...
  test("getRegionAtLine2", () => {
    ...
    try {
      ...
      assertRegions(
        foldingModel.getAllRegionsAtLine(2),
        [r1, r2].reverse(),
        "2"
      );
      assertRegions(
        foldingModel.getAllRegionsAtLine(3),
        [r1, r2, r3].reverse(),
        "3"
      );
      assertRegions(
        foldingModel.getAllRegionsAtLine(4),
        [r1, r2, r3, r4].reverse(),
        "4"
      );
      assertRegions(
        foldingModel.getAllRegionsAtLine(5),
        [r1, r2, r3, r4].reverse(),
        "5"
      );
      assertRegions(
        foldingModel.getAllRegionsAtLine(6),
        [r1, r2, r3].reverse(),
        "6"
      );
      assertRegions(
        foldingModel.getAllRegionsAtLine(7),
        [r1, r2, r3].reverse(),
        "7"
      );
      assertRegions(
        foldingModel.getAllRegionsAtLine(8),
        [r1, r2].reverse(),
        "8"
      );
  ...
  test("folding decoration", () => {
    ...
    try {
      ...
      assertRanges(foldingModel, [r1, r2, r3]);
      assertDecorations(foldingModel, [
        d(1, "expanded"),
        d(2, "expanded"),
        d(3, "expanded")
      ]);
