...
class TestDecorationProvider {
  ...
  static {
    __name(this, "TestDecorationProvider");
  }
...
suite("Folding Model", () => {
  ...
  __name(assertRegion, "assertRegion");
  ...
  __name(assertFoldedRanges, "assertFoldedRanges");
  ...
  __name(assertRanges, "assertRanges");
  ...
  __name(assertDecorations, "assertDecorations");
  ...
  __name(assertRegions, "assertRegions");
