...
let DiffEditorEditors = class extends Disposable {
  ...
  modifiedScrollTop = observableFromEvent(
    this,
  ...
  isModifiedFocused = observableCodeEditor(
    this.modified
  ).isFocused;
  isFocused = derived(
    this,
