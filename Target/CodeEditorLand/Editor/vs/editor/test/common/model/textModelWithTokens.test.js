...
suite("TextModelWithTokens", () => {
  ...
  function testBrackets(contents, brackets) {
    ...
    __name(toRelaxedFoundBracket, "toRelaxedFoundBracket");
    const charIsBracket = {};
  ...
  __name(testBrackets, "testBrackets");
  test("brackets1", () => {
    testBrackets([
      "if (a == 3) { return (7 * (a + 5)); }"
    ], [
...
__name(assertIsNotBracket, "assertIsNotBracket");
...
__name(assertIsBracket, "assertIsBracket");
...
suite("TextModelWithTokens regression tests", () => {
  ...
  test("microsoft/monaco-editor#122: Unhandled Exception: TypeError: Unable to get property 'replace' of undefined or null reference", () => {
    function assertViewLineTokens(model2, lineNumber, forceTokenization, expected) {
      ...
      const decode = /* @__PURE__ */ __name((token) => {
        return {
    ...
    __name(createViewLineToken, "createViewLineToken");
  });
...
suite("TextModel.getLineIndentGuide", () => {
  ...
  __name(assertIndentGuides, "assertIndentGuides");
