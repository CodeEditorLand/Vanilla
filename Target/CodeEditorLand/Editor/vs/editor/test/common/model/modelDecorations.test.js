...
__name(modelHasDecorations, "modelHasDecorations");
...
__name(lineHasDecorations, "lineHasDecorations");
function lineHasNoDecorations(model, lineNumber) {
  lineHasDecorations(model, lineNumber, []);
}
__name(lineHasNoDecorations, "lineHasNoDecorations");
...
__name(lineHasDecoration, "lineHasDecoration");
...
suite("deltaDecorations", () => {
  ...
  __name(toModelDeltaDecoration, "toModelDeltaDecoration");
  function strcmp(a, b) {
    if (a === b) {
      return 0;
    }
  ...
  __name(readModelDecorations, "readModelDecorations");
  ...
  __name(testDeltaDecorations, "testDeltaDecorations");
