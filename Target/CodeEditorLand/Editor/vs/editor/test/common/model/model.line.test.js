...
__name(assertLineTokens, "assertLineTokens");
suite("ModelLine - getIndentLevel", () => {
  ...
  __name(assertIndentLevel, "assertIndentLevel");
  test("getIndentLevel", () => {
    assertIndentLevel("", -1);
    assertIndentLevel(" ", -1);
    assertIndentLevel("   	", -1);
...
class ManualTokenizationSupport {
  static {
    __name(this, "ManualTokenizationSupport");
  }
...
suite("ModelLinesTokens", () => {
  ...
  __name(testLineEditTokens, "testLineEditTokens");
  ...
  __name(testLineSplitTokens, "testLineSplitTokens");
  ...
  __name(testLineAppendTokens, "testLineAppendTokens");
  test("append empty 1", () => {
