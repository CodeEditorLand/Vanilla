...
suite("ModelLinesTokens", () => {
  ...
  function testApplyEdits(initial, edits, expected) {
    ...
    for (let lineIndex = 0; lineIndex < expected.length; lineIndex++) {
      ...
      const actualTokens = model.tokenization.getLineTokens(
        lineIndex + 1
      );
  ...
  test("updates tokens on insertion 1", () => {
    testLineEditTokens(
      "abcd efgh",
      [new TestToken(0, 1), new TestToken(4, 2), new TestToken(5, 3)],
      [
        {
          startColumn: 1,
          endColumn: 1,
      ...
      "aabcd efgh",
      [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
    );
  });
  test("updates tokens on insertion 2", () => {
    testLineEditTokens(
      ...
      "axabcd efgh",
      [new TestToken(0, 1), new TestToken(6, 2), new TestToken(7, 3)]
    );
  });
  test("updates tokens on insertion 3", () => {
    testLineEditTokens(
      ...
      "axstuabcd efgh",
      [new TestToken(0, 1), new TestToken(9, 2), new TestToken(10, 3)]
    );
  });
  test("updates tokens on insertion 4", () => {
    testLineEditTokens(
      ...
      "axstuabcd	 efgh",
      [new TestToken(0, 1), new TestToken(10, 2), new TestToken(11, 3)]
    );
  });
  test("updates tokens on insertion 5", () => {
    testLineEditTokens(
      ...
      "axstuabcd	 ddefgh",
      [new TestToken(0, 1), new TestToken(10, 2), new TestToken(13, 3)]
    );
  });
  ...
  test("updates tokens on insertion 7", () => {
    testLineEditTokens(
      ...
      [new TestToken(0, 1), new TestToken(11, 2), new TestToken(14, 3)]
    );
  });
  ...
  test("delete second token 2", () => {
    testLineEditTokens(
      "abcdefghij",
      [new TestToken(0, 1), new TestToken(3, 2), new TestToken(6, 3)],
      [
        {
          startColumn: 4,
          endColumn: 7,
      ...
      "abcghij",
      [new TestToken(0, 1), new TestToken(3, 3)]
    );
  });
  test("insert right before second token", () => {
    testLineEditTokens(
      ...
      "abchellodefghij",
      [new TestToken(0, 1), new TestToken(8, 2), new TestToken(11, 3)]
    );
  });
  test("delete first char", () => {
    testLineEditTokens(
      ...
      "bcd efgh",
      [new TestToken(0, 1), new TestToken(3, 2), new TestToken(4, 3)]
    );
  });
  test("delete 2nd and 3rd chars", () => {
    testLineEditTokens(
      ...
      "ad efgh",
      [new TestToken(0, 1), new TestToken(2, 2), new TestToken(3, 3)]
    );
  });
  test("delete first token", () => {
    testLineEditTokens(
      ...
      " efgh",
      [new TestToken(0, 2), new TestToken(1, 3)]
    );
  });
  test("delete second token", () => {
    testLineEditTokens(
      ...
      "abcdefgh",
      [new TestToken(0, 1), new TestToken(4, 3)]
    );
  });
  ...
  test("split inthe middle 2", () => {
    testLineSplitTokens(
      ...
      "abcd ",
      "efgh",
      [new TestToken(0, 1), new TestToken(4, 2)]
    );
  });
  ...
  test("append 1", () => {
    testLineAppendTokens(
      ...
      [new TestToken(0, 1), new TestToken(4, 2), new TestToken(5, 3)],
      "abcd efgh",
      [new TestToken(0, 4), new TestToken(4, 5), new TestToken(5, 6)],
      "abcd efghabcd efgh",
      [
        new TestToken(0, 1),
        new TestToken(4, 2),
