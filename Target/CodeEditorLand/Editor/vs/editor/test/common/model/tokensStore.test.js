...
suite("TokensStore", () => {
  ...
  __name(parseTokensState, "parseTokensState");
  ...
  __name(extractState, "extractState");
  ...
  __name(testTokensAdjustment, "testTokensAdjustment");
...
` },
  ...
  test("bug", () => {
    ...
    __name(createTokens, "createTokens");
    const codec = new LanguageIdCodec();
    const store = new SparseTokensStore(codec);
    store.setPartial(
  ...
  test("issue #95949: Identifiers are colored in bold when targetting keywords", () => {
    ...
    __name(createTMMetadata, "createTMMetadata");
...
//# sourceMappingURL=tokensStore.test.js.map
