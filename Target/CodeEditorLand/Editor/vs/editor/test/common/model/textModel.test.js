...
suite("Editor Model - TextModel", () => {
  ...
  test("getValueLengthInRange", () => {
    ...
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 1, 1, 1)),
      "".length
    );
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 1, 1, 2)),
      "M".length
    );
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 2, 1, 3)),
      "y".length
    );
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 1, 1, 14)),
      "My First Line".length
    );
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 1, 2, 1)),
      "My First Line\r\n".length
    );
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 2, 2, 1)),
      "y First Line\r\n".length
    );
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 2, 2, 2)),
      "y First Line\r\nM".length
    );
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 2, 2, 1e3)),
      "y First Line\r\nMy Second Line".length
    );
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 2, 3, 1)),
      "y First Line\r\nMy Second Line\r\n".length
    );
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 2, 3, 1e3)),
      "y First Line\r\nMy Second Line\r\nMy Third Line".length
    );
    assert.strictEqual(
      m.getValueLengthInRange(new Range(1, 1, 1e3, 1e3)),
      "My First Line\r\nMy Second Line\r\nMy Third Line".length
    );
    m.dispose();
  ...
  test("guess indentation 1", () => {
    ...
    assertGuess(false, void 0, ["	x", "	    x"], "mixed whitespace 2");
  });
  ...
  test("validatePosition", () => {
    ...
    assert.deepStrictEqual(
      m.validatePosition(new Position(0, 0)),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(0, 1)),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 1)),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 2)),
      new Position(1, 2)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 30)),
      new Position(1, 9)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(2, 0)),
      new Position(2, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(2, 1)),
      new Position(2, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(2, 2)),
      new Position(2, 2)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(2, 30)),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(3, 0)),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(3, 1)),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(3, 30)),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(30, 30)),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(-123.123, -0.5)),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(
    ...
    assert.deepStrictEqual(
      m.validatePosition(new Position(123.23, 47.5)),
      new Position(2, 9)
    );
    m.dispose();
  });
  test("validatePosition around high-low surrogate pairs 1", () => {
    ...
    assert.deepStrictEqual(
      m.validatePosition(new Position(0, 7)),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 1)),
    ...
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 3)),
      new Position(1, 2)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 4)),
      new Position(1, 4)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 5)),
      new Position(1, 5)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 30)),
  ...
  test("validatePosition around high-low surrogate pairs 2", () => {
    ...
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 6)),
      new Position(1, 6)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 7)),
      new Position(1, 7)
    );
    m.dispose();
  });
  test("validatePosition handle NaN.", () => {
    const m = createTextModel("line one\nline two");
    assert.deepStrictEqual(
      m.validatePosition(new Position(Number.NaN, 1)),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, Number.NaN)),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(Number.NaN, Number.NaN)),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(2, Number.NaN)),
      new Position(2, 1)
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(Number.NaN, 3)),
      new Position(1, 3)
    );
    m.dispose();
  });
  test("issue #71480: validatePosition handle floats", () => {
    const m = createTextModel("line one\nline two");
    assert.deepStrictEqual(
      m.validatePosition(new Position(0.2, 1)),
      new Position(1, 1),
      "a"
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1.2, 1)),
      new Position(1, 1),
      "b"
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1.5, 2)),
      new Position(1, 2),
      "c"
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1.8, 3)),
      new Position(1, 3),
      "d"
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 0.3)),
      new Position(1, 1),
      "e"
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(2, 0.8)),
      new Position(2, 1),
      "f"
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(1, 1.2)),
      new Position(1, 1),
      "g"
    );
    assert.deepStrictEqual(
      m.validatePosition(new Position(2, 1.5)),
      new Position(2, 1),
      "h"
    );
    m.dispose();
  ...
  test("issue #71480: validateRange handle floats", () => {
    const m = createTextModel("line one\nline two");
    assert.deepStrictEqual(
      m.validateRange(new Range(0.2, 1.5, 0.8, 2.5)),
      new Range(1, 1, 1, 1)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1.2, 1.7, 1.8, 2.2)),
      new Range(1, 1, 1, 2)
    );
    m.dispose();
  });
  test("validateRange around high-low surrogate pairs 1", () => {
    const m = createTextModel("a\u{1F4DA}b");
    assert.deepStrictEqual(
      m.validateRange(new Range(0, 0, 0, 1)),
      new Range(1, 1, 1, 1)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(0, 0, 0, 7)),
      new Range(1, 1, 1, 1)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 1, 1, 1)),
      new Range(1, 1, 1, 1)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 1, 1, 2)),
      new Range(1, 1, 1, 2)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 1, 1, 3)),
      new Range(1, 1, 1, 4)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 1, 1, 4)),
      new Range(1, 1, 1, 4)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 1, 1, 5)),
      new Range(1, 1, 1, 5)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 2, 1, 2)),
      new Range(1, 2, 1, 2)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 2, 1, 3)),
      new Range(1, 2, 1, 4)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 2, 1, 4)),
      new Range(1, 2, 1, 4)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 2, 1, 5)),
      new Range(1, 2, 1, 5)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 3, 1, 3)),
      new Range(1, 2, 1, 2)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 3, 1, 4)),
      new Range(1, 2, 1, 4)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 3, 1, 5)),
      new Range(1, 2, 1, 5)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 4, 1, 4)),
      new Range(1, 4, 1, 4)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 4, 1, 5)),
      new Range(1, 4, 1, 5)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 5, 1, 5)),
      new Range(1, 5, 1, 5)
    );
    m.dispose();
  });
  test("validateRange around high-low surrogate pairs 2", () => {
    ...
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 1, 1, 6)),
      new Range(1, 1, 1, 6)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 1, 1, 7)),
      new Range(1, 1, 1, 7)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 2, 1, 2)),
    ...
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 2, 1, 6)),
      new Range(1, 2, 1, 6)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 2, 1, 7)),
      new Range(1, 2, 1, 7)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 3, 1, 3)),
    ...
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 3, 1, 6)),
      new Range(1, 2, 1, 6)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 3, 1, 7)),
      new Range(1, 2, 1, 7)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 4, 1, 4)),
    ...
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 4, 1, 6)),
      new Range(1, 4, 1, 6)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 4, 1, 7)),
      new Range(1, 4, 1, 7)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 5, 1, 5)),
    ...
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 5, 1, 6)),
      new Range(1, 4, 1, 6)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 5, 1, 7)),
      new Range(1, 4, 1, 7)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 6, 1, 6)),
      new Range(1, 6, 1, 6)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 6, 1, 7)),
      new Range(1, 6, 1, 7)
    );
    assert.deepStrictEqual(
      m.validateRange(new Range(1, 7, 1, 7)),
      new Range(1, 7, 1, 7)
    );
    m.dispose();
  });
  test("modifyPosition", () => {
    const m = createTextModel("line one\nline two");
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 1), 0),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(0, 0), 0),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(30, 1), 0),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 1), 17),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 1), 1),
      new Position(1, 2)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 1), 3),
      new Position(1, 4)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 2), 10),
      new Position(2, 3)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 5), 13),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 2), 16),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(2, 9), -17),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 2), -1),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 4), -3),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(2, 3), -10),
      new Position(1, 2)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(2, 9), -13),
      new Position(1, 5)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(2, 9), -16),
      new Position(1, 2)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 2), 17),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 2), 100),
      new Position(2, 9)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 2), -2),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(1, 2), -100),
    ...
    assert.deepStrictEqual(
      m.modifyPosition(new Position(2, 2), -100),
      new Position(1, 1)
    );
    assert.deepStrictEqual(
      m.modifyPosition(new Position(2, 9), -18),
      new Position(1, 1)
    );
    m.dispose();
  });
  test("normalizeIndentation 1", () => {
    const model = createTextModel("", void 0, {
      insertSpaces: false
    });
  ...
  test("#50471. getValueInRange with invalid range", () => {
    ...
    assert.strictEqual(
      m.getValueInRange(new Range(1, Number.NaN, 1, 3)),
      "My"
    );
    assert.strictEqual(
      m.getValueInRange(
        new Range(Number.NaN, Number.NaN, Number.NaN, Number.NaN)
      ),
      ""
    );
    m.dispose();
...
suite("TextModel.createSnapshot", () => {
  ...
  test("issue #119632: invalid range", () => {
    const model = createTextModel("hello world!");
    const actual = model._validateRangeRelaxedNoAllocations(
