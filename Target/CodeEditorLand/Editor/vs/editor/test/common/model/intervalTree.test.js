...
suite("IntervalTree 1", () => {
  ...
  __name(testIntervalTree, "testIntervalTree");
  ...
  __name(getRandomRange, "getRandomRange");
  class AutoTest {
    static {
      __name(this, "AutoTest");
    }
    _ops = [];
  ...
  suite("searching", () => {
    ...
    __name(createCormenTree, "createCormenTree");
    ...
    __name(assertIntervalSearch, "assertIntervalSearch");
    test("cormen 1->2", () => {
...
suite("IntervalTree 2", () => {
  ...
  __name(assertNodeAcceptEdit, "assertNodeAcceptEdit");
  test("nodeAcceptEdit", () => {
    {
...
__name(assertTreeInvariants, "assertTreeInvariants");
function depth(n) {
  if (n === SENTINEL) {
    return 1;
  }
...
__name(assertValidNode, "assertValidNode");
...
__name(assertValidTree, "assertValidTree");
