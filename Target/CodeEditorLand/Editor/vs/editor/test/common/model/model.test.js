...
suite("Editor Model - Model", () => {
  ...
  test("model insert text without newline 1", () => {
    thisModel.applyEdits([
      EditOperation.insert(new Position(1, 1), "foo ")
    ]);
    assert.strictEqual(thisModel.getLineCount(), 5);
  ...
  test("model insert text without newline 2", () => {
    thisModel.applyEdits([
      EditOperation.insert(new Position(1, 3), " foo")
    ]);
    assert.strictEqual(thisModel.getLineCount(), 5);
  ...
  test("model insert text with many newlines", () => {
    thisModel.applyEdits([
      EditOperation.insert(new Position(1, 3), "\n\n\n\n")
    ]);
  ...
  test("getValueInRange", () => {
    assert.strictEqual(
      thisModel.getValueInRange(new Range(1, 1, 1, 1)),
      ""
    );
    assert.strictEqual(
      thisModel.getValueInRange(new Range(1, 1, 1, 2)),
      "M"
    );
    assert.strictEqual(
      thisModel.getValueInRange(new Range(1, 2, 1, 3)),
      "y"
    );
    assert.strictEqual(
      thisModel.getValueInRange(new Range(1, 1, 1, 14)),
      "My First Line"
    );
    assert.strictEqual(
      thisModel.getValueInRange(new Range(1, 1, 2, 1)),
      "My First Line\n"
    );
    assert.strictEqual(
      thisModel.getValueInRange(new Range(1, 1, 2, 2)),
      "My First Line\n	"
    );
    assert.strictEqual(
      thisModel.getValueInRange(new Range(1, 1, 2, 3)),
      "My First Line\n		"
    );
    assert.strictEqual(
      thisModel.getValueInRange(new Range(1, 1, 2, 17)),
      "My First Line\n		My Second Line"
    );
    assert.strictEqual(
      thisModel.getValueInRange(new Range(1, 1, 3, 1)),
      "My First Line\n		My Second Line\n"
    );
    assert.strictEqual(
      thisModel.getValueInRange(new Range(1, 1, 4, 1)),
      "My First Line\n		My Second Line\n    Third Line\n"
    );
  });
  test("getValueLengthInRange", () => {
    assert.strictEqual(
      thisModel.getValueLengthInRange(new Range(1, 1, 1, 1)),
      "".length
    );
    assert.strictEqual(
      thisModel.getValueLengthInRange(new Range(1, 1, 1, 2)),
      "M".length
    );
    assert.strictEqual(
      thisModel.getValueLengthInRange(new Range(1, 2, 1, 3)),
      "y".length
    );
    assert.strictEqual(
      thisModel.getValueLengthInRange(new Range(1, 1, 1, 14)),
      "My First Line".length
    );
    assert.strictEqual(
      thisModel.getValueLengthInRange(new Range(1, 1, 2, 1)),
      "My First Line\n".length
    );
    assert.strictEqual(
      thisModel.getValueLengthInRange(new Range(1, 1, 2, 2)),
      "My First Line\n	".length
    );
    assert.strictEqual(
      thisModel.getValueLengthInRange(new Range(1, 1, 2, 3)),
      "My First Line\n		".length
    );
    assert.strictEqual(
      thisModel.getValueLengthInRange(new Range(1, 1, 2, 17)),
      "My First Line\n		My Second Line".length
    );
    assert.strictEqual(
      thisModel.getValueLengthInRange(new Range(1, 1, 3, 1)),
      "My First Line\n		My Second Line\n".length
    );
    assert.strictEqual(
      thisModel.getValueLengthInRange(new Range(1, 1, 4, 1)),
      "My First Line\n		My Second Line\n    Third Line\n".length
    );
  });
...
suite("Editor Model - Words", () => {
  ...
  test("Get word at position", () => {
    ...
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 1)),
      { word: "This", startColumn: 1, endColumn: 5 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 2)),
      { word: "This", startColumn: 1, endColumn: 5 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 4)),
      { word: "This", startColumn: 1, endColumn: 5 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 5)),
      { word: "This", startColumn: 1, endColumn: 5 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 6)),
      { word: "text", startColumn: 6, endColumn: 10 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 19)),
      { word: "some", startColumn: 15, endColumn: 19 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 20)),
      null
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 21)),
      { word: "words", startColumn: 21, endColumn: 26 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 26)),
      { word: "words", startColumn: 21, endColumn: 26 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 27)),
      null
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 28)),
      null
    );
  });
  ...
  test("issue #61296: VS code freezes when editing CSS file with emoji", () => {
    ...
    disposables2.add(
      languageConfigurationService.register(MODE_ID, {
        wordPattern: /(#?-?\d*\.\d\w*%?)|(::?[\w-]*(?=[^,{;]*[,{]))|(([@#.!])?[\w-?]+%?|[@#!.])/g
      })
    );
    const thisModel = disposables2.add(
      instantiateTextModel(instantiationService, ".\u{1F437}-a-b", MODE_ID)
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 1)),
      { word: ".", startColumn: 1, endColumn: 2 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 2)),
      { word: ".", startColumn: 1, endColumn: 2 }
    ...
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 3)),
      null
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 4)),
      { word: "-a-b", startColumn: 4, endColumn: 8 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 5)),
      { word: "-a-b", startColumn: 4, endColumn: 8 }
    ...
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 7)),
      { word: "-a-b", startColumn: 4, endColumn: 8 }
    );
    assert.deepStrictEqual(
      thisModel.getWordAtPosition(new Position(1, 8)),
      { word: "-a-b", startColumn: 4, endColumn: 8 }
    );
    disposables2.dispose();
  });
