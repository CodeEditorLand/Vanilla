...
suite("TextModelSearch", () => {
  ...
  __name(assertFindMatch, "assertFindMatch");
  ...
  __name(_assertFindMatches, "_assertFindMatches");
  ...
  __name(assertFindMatches, "assertFindMatches");
  const regularText = [
  ...
  __name(assertParseSearchResult, "assertParseSearchResult");
