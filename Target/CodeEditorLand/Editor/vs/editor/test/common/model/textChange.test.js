...
suite("TextChangeCompressor", () => {
  ...
  __name(getResultingContent, "getResultingContent");
  ...
  __name(getTextChanges, "getTextChanges");
  ...
  __name(assertCompression, "assertCompression");
  test("simple 1", () => {
    assertCompression(
      "",
  ...
  __name(getRandomEOL, "getRandomEOL");
  ...
  __name(getRandomBuffer, "getRandomBuffer");
  ...
  __name(getRandomEdits, "getRandomEdits");
  class GeneratedTest {
    static {
      __name(this, "GeneratedTest");
    }
    _content;
    _edits1;
    _edits2;
