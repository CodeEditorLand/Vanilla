...
__name(parseAnnotatedText, "parseAnnotatedText");
...
__name(toAnnotatedText, "toAnnotatedText");
...
__name(getLineBreakData, "getLineBreakData");
...
__name(assertLineBreaks, "assertLineBreaks");
suite("Editor ViewModel - MonospaceLineBreaksComputer", () => {
  ...
  __name(assertLineBreakDataEqual, "assertLineBreakDataEqual");
  ...
  __name(assertIncrementalLineBreaks, "assertIncrementalLineBreaks");
  ...
  test("issue #75494: surrogate pairs", () => {
    const factory = new MonospaceLineBreaksComputerFactory("	", " ");
    assertLineBreaks(factory, 4, 49, "\u{1F407}\u{1F46C}\u{1F316}\u{1F31E}\u{1F3C7}\u{1F37C}\u{1F407}\u{1F46C}\u{1F316}\u{1F31E}\u{1F3C7}\u{1F37C}\u{1F407}\u{1F46C}\u{1F316}\u{1F31E}\u{1F3C7}\u{1F37C}\u{1F407}\u{1F46C}\u{1F316}\u{1F31E}\u{1F3C7}\u{1F37C}|\u{1F407}\u{1F46C}\u{1F316}\u{1F31E}\u{1F3C7}\u{1F37C}\u{1F407}\u{1F46C}\u{1F316}\u{1F31E}\u{1F3C7}\u{1F37C}\u{1F407}\u{1F46C}\u{1F316}\u{1F31E}\u{1F3C7}\u{1F37C}\u{1F407}\u{1F46C}\u{1F316}\u{1F31E}\u{1F3C7}\u{1F37C}|\u{1F407}\u{1F46C}", WrappingIndent.Same);
  });
  ...
  test("issue #75494: surrogate pairs overrun 2", () => {
    const factory = new MonospaceLineBreaksComputerFactory(EditorOptions.wordWrapBreakBeforeCharacters.defaultValue, EditorOptions.wordWrapBreakAfterCharacters.defaultValue);
    assertLineBreaks(factory, 4, 17, 'factory, |"xtxtfunc|(x"\u{1F31E}\u{1F3C7}\u{1F37C}\u{1F31E}\u{1F3C7}\u{1F37C}\u{1F407}|&\u{1F46C}\u{1F316}\u{1F31E}\u{1F46C}\u{1F316}\u{1F31E}\u{1F3C7}\u{1F37C}|\u{1F407}\u{1F46C}x"', WrappingIndent.Same);
  });
  ...
  test("issue #112382: Word wrap doesn't work well with control characters", () => {
    const factory = new MonospaceLineBreaksComputerFactory(EditorOptions.wordWrapBreakBeforeCharacters.defaultValue, EditorOptions.wordWrapBreakAfterCharacters.defaultValue);
    assertLineBreaks(factory, 4, 6, "|", WrappingIndent.Same);
  });
