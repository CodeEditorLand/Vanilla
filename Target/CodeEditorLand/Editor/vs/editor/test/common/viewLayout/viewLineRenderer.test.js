...
__name(inflateRenderLineOutput, "inflateRenderLineOutput");
suite("viewLineRenderer.renderLine", () => {
  ...
  __name(assertCharacterReplacement, "assertCharacterReplacement");
  ...
  __name(assertParts, "assertParts");
  test("empty line", () => {
  ...
  test("issue #6885: Splits large tokens", () => {
    ...
    __name(assertSplitsTokens, "assertSplitsTokens");
    {
      assertSplitsTokens(
        "49 chars",
...
__name(assertCharacterMapping3, "assertCharacterMapping3");
suite("viewLineRenderer.renderLine 2", () => {
  ...
  __name(testCreateLineParts, "testCreateLineParts");
  ...
  test("createLineParts simple", () => {
    assert.deepStrictEqual(
      ...
      {
        html: [
          '<span class="mtk1">Hello\xA0world!</span>'
        ],
        mapping: [
          [0, 0, 0],
          [0, 1, 1],
  ...
  __name(createTestGetColumnOfLinePartOffset, "createTestGetColumnOfLinePartOffset");
