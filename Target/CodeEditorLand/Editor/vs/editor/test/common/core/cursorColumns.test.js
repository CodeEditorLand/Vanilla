...
suite("CursorColumns", () => {
  ...
  test("visibleColumnFromColumn", () => {
    ...
    __name(testVisibleColumnFromColumn, "testVisibleColumnFromColumn");
  ...
  test("columnFromVisibleColumn", () => {
    ...
    __name(testColumnFromVisibleColumn, "testColumnFromVisibleColumn");
...
//# sourceMappingURL=cursorColumns.test.js.map
