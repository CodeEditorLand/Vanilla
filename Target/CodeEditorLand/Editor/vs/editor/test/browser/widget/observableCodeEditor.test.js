...
suite("CodeEditorWidget", () => {
  ...
  __name(withTestFixture, "withTestFixture");
      ...
      const derived = derivedHandleChanges(
        {
          ...
          handleChange: /* @__PURE__ */ __name((context) => {
  ...
  __name(withEditorSetupTestFixture, "withEditorSetupTestFixture");
...
__name(observableName, "observableName");
//# sourceMappingURL=observableCodeEditor.test.js.map
