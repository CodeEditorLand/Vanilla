...
suite("ViewModel", () => {
  ...
  function assertGetPlainTextToCopy(text, ranges, emptySelectionClipboard, expected) {
    testViewModel(text, {}, (viewModel, model) => {
      const actual = viewModel.getPlainTextToCopy(
        ranges,
  ...
  test("getPlainTextToCopy 0/2", () => {
    assertGetPlainTextToCopy(
      USUAL_TEXT,
      [new Range(2, 2, 2, 2), new Range(3, 2, 3, 2)],
      false,
      ""
    );
  });
  ...
  test("getPlainTextToCopy 1/2", () => {
    assertGetPlainTextToCopy(
      USUAL_TEXT,
      [new Range(2, 2, 2, 6), new Range(3, 2, 3, 2)],
      false,
      "ine2"
    );
  });
  ...
  test("getPlainTextToCopy 2/2", () => {
    assertGetPlainTextToCopy(
      USUAL_TEXT,
      [new Range(2, 2, 2, 6), new Range(3, 2, 3, 6)],
      false,
      ["ine2", "ine3"]
    );
  });
  test("getPlainTextToCopy 2/2 reversed", () => {
    assertGetPlainTextToCopy(
      USUAL_TEXT,
      [new Range(3, 2, 3, 6), new Range(2, 2, 2, 6)],
      false,
      ["ine2", "ine3"]
    );
  });
