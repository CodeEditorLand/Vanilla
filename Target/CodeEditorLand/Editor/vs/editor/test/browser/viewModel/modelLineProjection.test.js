...
suite("Editor ViewModel - SplitLinesCollection", () => {
  ...
  __name(withSplitLinesCollection, "withSplitLinesCollection");
...
suite("SplitLinesCollection", () => {
  ...
  __name(assertViewLineTokens, "assertViewLineTokens");
  ...
  __name(assertMinimapLineRenderingData, "assertMinimapLineRenderingData");
  ...
  __name(assertMinimapLinesRenderingData, "assertMinimapLinesRenderingData");
  ...
  __name(assertAllMinimapLinesRenderingData, "assertAllMinimapLinesRenderingData");
...
__name(createSplitLine, "createSplitLine");
...
__name(createLineBreakData, "createLineBreakData");
function createModel(text) {
  return {
    ...
    getLineLength: /* @__PURE__ */ __name((lineNumber) => {
      return text.length;
    }, "getLineLength"),
    getLineMinColumn: /* @__PURE__ */ __name((lineNumber) => {
      return 1;
    }, "getLineMinColumn"),
...
//# sourceMappingURL=modelLineProjection.test.js.map
