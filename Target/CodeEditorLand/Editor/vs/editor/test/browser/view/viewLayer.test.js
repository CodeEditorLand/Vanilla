...
__name(assertState, "assertState");
suite("RenderedLinesCollection onLinesDeleted", () => {
  ...
  function testOnModelLinesDeleted(deleteFromLineNumber, deleteToLineNumber, expectedDeleted, expectedState) {
    const col = new RenderedLinesCollection({ createLine: /* @__PURE__ */ __name(() => new TestLine("new"), "createLine") });
    col._set(6, [
      new TestLine("old6"),
      new TestLine("old7"),
      new TestLine("old8"),
  ...
  __name(testOnModelLinesDeleted, "testOnModelLinesDeleted");
  test("A1", () => {
...
suite("RenderedLinesCollection onLineChanged", () => {
  ...
  __name(testOnModelLineChanged, "testOnModelLineChanged");
  test("3", () => {
...
suite("RenderedLinesCollection onLinesInserted", () => {
  ...
  __name(testOnModelLinesInserted, "testOnModelLinesInserted");
  test("A1", () => {
...
suite("RenderedLinesCollection onTokensChanged", () => {
  ...
  __name(testOnModelTokensChanged, "testOnModelTokensChanged");
  test("A", () => {
...
//# sourceMappingURL=viewLayer.test.js.map
