...
} from "../../../common/commands/trimTrailingWhitespaceCommand.js";
...
function assertTrimTrailingWhitespaceCommand(text, expected) {
  return withEditorModel(text, (model) => {
    const op = new TrimTrailingWhitespaceCommand(
...
suite("Editor Commands - Trim Trailing Whitespace Command", () => {
  ...
  test("remove trailing whitespace", () => {
    ...
    assertTrimTrailingWhitespaceCommand(
      ["text   "],
      [createSingleEditOp(null, 1, 5, 1, 8)]
    );
    assertTrimTrailingWhitespaceCommand(
      ["text	   "],
      [createSingleEditOp(null, 1, 5, 1, 9)]
    );
    assertTrimTrailingWhitespaceCommand(
      ["	   "],
      [createSingleEditOp(null, 1, 1, 1, 5)]
    );
    assertTrimTrailingWhitespaceCommand(
      ["text	"],
      [createSingleEditOp(null, 1, 5, 1, 6)]
    );
    assertTrimTrailingWhitespaceCommand(
      [
        "some text	",
    ...
    assertTrimTrailingWhitespace(
      ...
      [createInsertDeleteSingleEditOp(null, 1, 5, 1, 8)]
    );
    assertTrimTrailingWhitespace(
      ["text   "],
    ...
    assertTrimTrailingWhitespace(
      ["text   "],
      [new Position(1, 1), new Position(1, 5), new Position(1, 6)],
      [createInsertDeleteSingleEditOp(null, 1, 6, 1, 8)]
    );
    assertTrimTrailingWhitespace(
      [
        "some text	",
  ...
  test("skips strings and regex if configured", () => {
