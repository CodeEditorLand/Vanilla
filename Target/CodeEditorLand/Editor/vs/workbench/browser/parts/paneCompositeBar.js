...
let PaneCompositeBar = class extends Disposable {
  ...
  viewContainerDisposables = this._register(new DisposableMap());
  location;
  compositeBar;
  dndHandler;
  ...
  getContextMenuActionsForComposite(compositeId) {
    ...
    if (defaultLocation !== this.viewDescriptorService.getViewContainerLocation(viewContainer)) {
      actions.push(toAction({ id: "resetLocationAction", label: localize("resetLocation", "Reset Location"), run: /* @__PURE__ */ __name(() => this.viewDescriptorService.moveViewContainerToLocation(viewContainer, defaultLocation, void 0, "resetLocationAction"), "run") }));
    } else {
      ...
      if (viewContainerModel.allViewDescriptors.length === 1) {
        ...
        if (defaultContainer !== viewContainer) {
          actions.push(toAction({ id: "resetLocationAction", label: localize("resetLocation", "Reset Location"), run: /* @__PURE__ */ __name(() => this.viewDescriptorService.moveViewsToContainer([viewToReset], defaultContainer, void 0, "resetLocationAction"), "run") }));
        }
      }
    }
    return actions;
