...
const IBreadcrumbsService = createDecorator(
...
class BreadcrumbsConfig {
  ...
  static IsEnabled = BreadcrumbsConfig._stub(
    "breadcrumbs.enabled"
  );
  static UseQuickPick = BreadcrumbsConfig._stub(
    "breadcrumbs.useQuickPick"
  );
  static FilePath = BreadcrumbsConfig._stub(
    "breadcrumbs.filePath"
  );
  static SymbolPath = BreadcrumbsConfig._stub(
