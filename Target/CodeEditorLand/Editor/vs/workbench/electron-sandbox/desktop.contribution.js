...
} from "./actions/installActions.js";
import {
  CloseWindowAction,
...
(/* @__PURE__ */ __name(function registerActions() {
...
(/* @__PURE__ */ __name(function registerMenu() {
  ...
  registry.registerConfiguration({
    ...
    properties: {
      ...
      "window.experimentalControlOverlay": {
        ...
        markdownDescription: localize(
          "window.experimentalControlOverlay",
          "Show the native window controls when {0} is set to `custom` (Linux only).",
          "`#window.titleBarStyle#`"
        ),
        default: true
      },
      "window.customTitleBarVisibility": {
        ...
        markdownDescription: localize(
          "window.customTitleBarVisibility",
          "Adjust when the custom title bar should be shown. The custom title bar can be hidden when in full screen mode with `windowed`. The custom title bar can only be hidden in none full screen mode with `never` when {0} is set to `native`.",
          "`#window.titleBarStyle#`"
        )
      },
      "window.dialogStyle": {
...
(/* @__PURE__ */ __name(function registerJSONSchemas() {
