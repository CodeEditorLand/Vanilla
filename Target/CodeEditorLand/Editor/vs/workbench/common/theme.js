...
const TAB_ACTIVE_BACKGROUND = registerColor(
...
const TAB_INACTIVE_BACKGROUND = registerColor(
...
const TAB_UNFOCUSED_INACTIVE_BACKGROUND = registerColor(
...
const TAB_ACTIVE_FOREGROUND = registerColor(
...
const TAB_INACTIVE_FOREGROUND = registerColor(
...
const TAB_UNFOCUSED_ACTIVE_FOREGROUND = registerColor(
...
const TAB_UNFOCUSED_INACTIVE_FOREGROUND = registerColor(
...
const TAB_HOVER_BACKGROUND = registerColor(
  "tab.hoverBackground",
  null,
  localize(
    "tabHoverBackground",
...
const TAB_UNFOCUSED_HOVER_BACKGROUND = registerColor(
...
const TAB_HOVER_FOREGROUND = registerColor(
  "tab.hoverForeground",
  null,
  localize(
    "tabHoverForeground",
...
const TAB_UNFOCUSED_HOVER_FOREGROUND = registerColor(
...
const TAB_BORDER = registerColor(
  "tab.border",
  {
    dark: "#252526",
    light: "#F3F3F3",
...
const TAB_LAST_PINNED_BORDER = registerColor(
...
const TAB_ACTIVE_BORDER = registerColor(
  "tab.activeBorder",
  null,
  localize(
    "tabActiveBorder",
...
const TAB_UNFOCUSED_ACTIVE_BORDER = registerColor(
...
const TAB_ACTIVE_BORDER_TOP = registerColor(
  "tab.activeBorderTop",
  {
    dark: null,
    light: null,
...
const TAB_UNFOCUSED_ACTIVE_BORDER_TOP = registerColor(
...
const TAB_SELECTED_BORDER_TOP = registerColor(
...
const TAB_SELECTED_BACKGROUND = registerColor(
...
const TAB_SELECTED_FOREGROUND = registerColor(
...
const TAB_HOVER_BORDER = registerColor(
  "tab.hoverBorder",
  null,
  localize(
    "tabHoverBorder",
...
const TAB_UNFOCUSED_HOVER_BORDER = registerColor(
...
const TAB_DRAG_AND_DROP_BORDER = registerColor(
...
const TAB_ACTIVE_MODIFIED_BORDER = registerColor(
...
const TAB_INACTIVE_MODIFIED_BORDER = registerColor(
...
const TAB_UNFOCUSED_ACTIVE_MODIFIED_BORDER = registerColor(
...
const TAB_UNFOCUSED_INACTIVE_MODIFIED_BORDER = registerColor(
...
const EDITOR_PANE_BACKGROUND = registerColor(
...
const EDITOR_GROUP_EMPTY_BACKGROUND = registerColor(
...
const EDITOR_GROUP_FOCUSED_EMPTY_BORDER = registerColor(
...
const EDITOR_GROUP_HEADER_TABS_BACKGROUND = registerColor(
...
const EDITOR_GROUP_HEADER_TABS_BORDER = registerColor(
...
const EDITOR_GROUP_HEADER_NO_TABS_BACKGROUND = registerColor(
...
const EDITOR_GROUP_HEADER_BORDER = registerColor(
...
const EDITOR_GROUP_BORDER = registerColor(
  "editorGroup.border",
  {
    dark: "#444444",
    light: "#E7E7E7",
...
const EDITOR_DRAG_AND_DROP_BACKGROUND = registerColor(
...
const EDITOR_DROP_INTO_PROMPT_BACKGROUND = registerColor(
...
const EDITOR_DROP_INTO_PROMPT_BORDER = registerColor(
...
const SIDE_BY_SIDE_EDITOR_HORIZONTAL_BORDER = registerColor(
...
const SIDE_BY_SIDE_EDITOR_VERTICAL_BORDER = registerColor(
...
const PANEL_BACKGROUND = registerColor(
  "panel.background",
  editorBackground,
  localize(
    "panelBackground",
...
const PANEL_BORDER = registerColor(
  "panel.border",
  {
...
const PANEL_ACTIVE_TITLE_FOREGROUND = registerColor(
...
const PANEL_INACTIVE_TITLE_FOREGROUND = registerColor(
...
const PANEL_ACTIVE_TITLE_BORDER = registerColor(
...
const PANEL_DRAG_AND_DROP_BORDER = registerColor(
  "panel.dropBorder",
...
const PANEL_SECTION_HEADER_BACKGROUND = registerColor(
...
const PANEL_SECTION_HEADER_FOREGROUND = registerColor(
...
const PANEL_SECTION_HEADER_BORDER = registerColor(
...
const PANEL_SECTION_BORDER = registerColor(
  "panelSection.border",
  PANEL_BORDER,
  localize(
    "panelSectionBorder",
...
const PANEL_STICKY_SCROLL_BACKGROUND = registerColor(
...
const PANEL_STICKY_SCROLL_BORDER = registerColor(
...
const PANEL_STICKY_SCROLL_SHADOW = registerColor(
...
const BANNER_BACKGROUND = registerColor(
  "banner.background",
  {
...
const BANNER_FOREGROUND = registerColor(
  "banner.foreground",
  listActiveSelectionForeground,
  localize(
    "banner.foreground",
...
const BANNER_ICON_FOREGROUND = registerColor(
...
const STATUS_BAR_FOREGROUND = registerColor(
...
const STATUS_BAR_NO_FOLDER_FOREGROUND = registerColor(
...
const STATUS_BAR_BACKGROUND = registerColor(
...
const STATUS_BAR_NO_FOLDER_BACKGROUND = registerColor(
...
const STATUS_BAR_BORDER = registerColor(
  "statusBar.border",
  {
    dark: null,
    light: null,
...
const STATUS_BAR_FOCUS_BORDER = registerColor(
...
const STATUS_BAR_NO_FOLDER_BORDER = registerColor(
...
const STATUS_BAR_ITEM_FOCUS_BORDER = registerColor(
...
const STATUS_BAR_ITEM_HOVER_BACKGROUND = registerColor(
...
const STATUS_BAR_ITEM_HOVER_FOREGROUND = registerColor(
...
const STATUS_BAR_ITEM_COMPACT_HOVER_BACKGROUND = registerColor(
...
const STATUS_BAR_PROMINENT_ITEM_FOREGROUND = registerColor(
...
const STATUS_BAR_PROMINENT_ITEM_BACKGROUND = registerColor(
...
const STATUS_BAR_PROMINENT_ITEM_HOVER_FOREGROUND = registerColor(
...
const STATUS_BAR_PROMINENT_ITEM_HOVER_BACKGROUND = registerColor(
...
const STATUS_BAR_ERROR_ITEM_BACKGROUND = registerColor(
...
const STATUS_BAR_ERROR_ITEM_FOREGROUND = registerColor(
...
const STATUS_BAR_ERROR_ITEM_HOVER_FOREGROUND = registerColor(
...
const STATUS_BAR_ERROR_ITEM_HOVER_BACKGROUND = registerColor(
...
const STATUS_BAR_WARNING_ITEM_BACKGROUND = registerColor(
...
const STATUS_BAR_WARNING_ITEM_FOREGROUND = registerColor(
...
const STATUS_BAR_WARNING_ITEM_HOVER_FOREGROUND = registerColor(
...
const STATUS_BAR_WARNING_ITEM_HOVER_BACKGROUND = registerColor(
...
const ACTIVITY_BAR_BACKGROUND = registerColor(
...
const ACTIVITY_BAR_FOREGROUND = registerColor(
...
const ACTIVITY_BAR_INACTIVE_FOREGROUND = registerColor(
...
const ACTIVITY_BAR_BORDER = registerColor(
  "activityBar.border",
  {
    dark: null,
    light: null,
...
const ACTIVITY_BAR_ACTIVE_BORDER = registerColor(
...
const ACTIVITY_BAR_ACTIVE_FOCUS_BORDER = registerColor(
...
const ACTIVITY_BAR_ACTIVE_BACKGROUND = registerColor(
...
const ACTIVITY_BAR_DRAG_AND_DROP_BORDER = registerColor(
...
const ACTIVITY_BAR_BADGE_BACKGROUND = registerColor(
...
const ACTIVITY_BAR_TOP_FOREGROUND = registerColor(
...
const ACTIVITY_BAR_TOP_ACTIVE_BORDER = registerColor(
...
const ACTIVITY_BAR_TOP_ACTIVE_BACKGROUND = registerColor(
...
const ACTIVITY_BAR_TOP_INACTIVE_FOREGROUND = registerColor(
...
const ACTIVITY_BAR_TOP_DRAG_AND_DROP_BORDER = registerColor(
...
const ACTIVITY_BAR_TOP_BACKGROUND = registerColor(
...
const PROFILE_BADGE_BACKGROUND = registerColor(
...
const PROFILE_BADGE_FOREGROUND = registerColor(
...
const STATUS_BAR_REMOTE_ITEM_HOVER_FOREGROUND = registerColor(
...
const STATUS_BAR_REMOTE_ITEM_HOVER_BACKGROUND = registerColor(
...
const STATUS_BAR_OFFLINE_ITEM_BACKGROUND = registerColor(
...
const STATUS_BAR_OFFLINE_ITEM_FOREGROUND = registerColor(
...
const STATUS_BAR_OFFLINE_ITEM_HOVER_FOREGROUND = registerColor(
...
const STATUS_BAR_OFFLINE_ITEM_HOVER_BACKGROUND = registerColor(
...
const EXTENSION_BADGE_REMOTE_BACKGROUND = registerColor(
...
const EXTENSION_BADGE_REMOTE_FOREGROUND = registerColor(
...
const SIDE_BAR_BACKGROUND = registerColor(
  "sideBar.background",
  {
    dark: "#252526",
    light: "#F3F3F3",
...
const SIDE_BAR_FOREGROUND = registerColor(
  "sideBar.foreground",
  null,
  localize(
    "sideBarForeground",
...
const SIDE_BAR_BORDER = registerColor(
  "sideBar.border",
  {
    dark: null,
    light: null,
...
const SIDE_BAR_TITLE_BACKGROUND = registerColor(
...
const SIDE_BAR_TITLE_FOREGROUND = registerColor(
...
const SIDE_BAR_DRAG_AND_DROP_BACKGROUND = registerColor(
...
const SIDE_BAR_SECTION_HEADER_BACKGROUND = registerColor(
...
const SIDE_BAR_SECTION_HEADER_FOREGROUND = registerColor(
...
const SIDE_BAR_SECTION_HEADER_BORDER = registerColor(
...
const ACTIVITY_BAR_TOP_BORDER = registerColor(
...
const SIDE_BAR_STICKY_SCROLL_BACKGROUND = registerColor(
...
const SIDE_BAR_STICKY_SCROLL_BORDER = registerColor(
...
const SIDE_BAR_STICKY_SCROLL_SHADOW = registerColor(
...
const TITLE_BAR_ACTIVE_FOREGROUND = registerColor(
...
const TITLE_BAR_INACTIVE_FOREGROUND = registerColor(
...
const TITLE_BAR_ACTIVE_BACKGROUND = registerColor(
...
const TITLE_BAR_INACTIVE_BACKGROUND = registerColor(
...
const TITLE_BAR_BORDER = registerColor(
  "titleBar.border",
  {
    dark: null,
    light: null,
...
const MENUBAR_SELECTION_FOREGROUND = registerColor(
...
const MENUBAR_SELECTION_BACKGROUND = registerColor(
...
const MENUBAR_SELECTION_BORDER = registerColor(
...
const COMMAND_CENTER_FOREGROUND = registerColor(
...
const COMMAND_CENTER_ACTIVEFOREGROUND = registerColor(
...
const COMMAND_CENTER_INACTIVEFOREGROUND = registerColor(
...
const COMMAND_CENTER_BACKGROUND = registerColor(
...
const COMMAND_CENTER_ACTIVEBACKGROUND = registerColor(
...
const COMMAND_CENTER_BORDER = registerColor(
...
const COMMAND_CENTER_ACTIVEBORDER = registerColor(
...
const COMMAND_CENTER_INACTIVEBORDER = registerColor(
...
const NOTIFICATIONS_CENTER_BORDER = registerColor(
...
const NOTIFICATIONS_TOAST_BORDER = registerColor(
...
const NOTIFICATIONS_FOREGROUND = registerColor(
...
const NOTIFICATIONS_BACKGROUND = registerColor(
...
const NOTIFICATIONS_LINKS = registerColor(
...
const NOTIFICATIONS_CENTER_HEADER_FOREGROUND = registerColor(
...
const NOTIFICATIONS_CENTER_HEADER_BACKGROUND = registerColor(
...
const NOTIFICATIONS_BORDER = registerColor(
...
const NOTIFICATIONS_ERROR_ICON_FOREGROUND = registerColor(
...
const NOTIFICATIONS_WARNING_ICON_FOREGROUND = registerColor(
...
const NOTIFICATIONS_INFO_ICON_FOREGROUND = registerColor(
...
const WINDOW_ACTIVE_BORDER = registerColor(
  "window.activeBorder",
  {
    dark: null,
    light: null,
...
const WINDOW_INACTIVE_BORDER = registerColor(
