...
const STATUS_BAR_REMOTE_ITEM_BACKGROUND = registerColor("statusBarItem.remoteBackground", ACTIVITY_BAR_BADGE_BACKGROUND, localize("statusBarItemHostBackground", "Background color for the remote indicator on the status bar."));
...
const EXTENSION_BADGE_REMOTE_BACKGROUND = registerColor("extensionBadge.remoteBackground", ACTIVITY_BAR_BADGE_BACKGROUND, localize("extensionBadge.remoteBackground", "Background color for the remote badge in the extensions view."));
const EXTENSION_BADGE_REMOTE_FOREGROUND = registerColor("extensionBadge.remoteForeground", ACTIVITY_BAR_BADGE_FOREGROUND, localize("extensionBadge.remoteForeground", "Foreground color for the remote badge in the extensions view."));
