...
suite("ExtHostTreeView", function() {
    ...
    return testObject.$getChildren("testNodeTreeProvider").then((elements) => {
      ...
      return Promise.all([
        testObject.$getChildren("testNodeTreeProvider", "0/0:a").then((children) => {
          ...
          return Promise.all([
            testObject.$getChildren("testNodeTreeProvider", "0/0:a/0:aa").then((children2) => assert.strictEqual(children2?.length, 0)),
            testObject.$getChildren("testNodeTreeProvider", "0/0:a/0:ab").then((children2) => assert.strictEqual(children2?.length, 0))
          ]);
        }),
        testObject.$getChildren("testNodeTreeProvider", "0/0:b").then((children) => {
          ...
          return Promise.all([
            testObject.$getChildren("testNodeTreeProvider", "0/0:b/0:ba").then((children2) => assert.strictEqual(children2?.length, 0)),
            testObject.$getChildren("testNodeTreeProvider", "0/0:b/0:bb").then((children2) => assert.strictEqual(children2?.length, 0))
          ]);
        })
      ]);
    });
    ...
    return testObject.$getChildren("testNodeWithIdTreeProvider").then((elements) => {
      ...
      return Promise.all([
        testObject.$getChildren("testNodeWithIdTreeProvider", "1/a").then((children) => {
          ...
          return Promise.all([
            testObject.$getChildren("testNodeWithIdTreeProvider", "1/aa").then((children2) => assert.strictEqual(children2?.length, 0)),
            testObject.$getChildren("testNodeWithIdTreeProvider", "1/ab").then((children2) => assert.strictEqual(children2?.length, 0))
          ]);
        }),
        testObject.$getChildren("testNodeWithIdTreeProvider", "1/b").then((children) => {
          ...
          return Promise.all([
            testObject.$getChildren("testNodeWithIdTreeProvider", "1/ba").then((children2) => assert.strictEqual(children2?.length, 0)),
            testObject.$getChildren("testNodeWithIdTreeProvider", "1/bb").then((children2) => assert.strictEqual(children2?.length, 0))
          ]);
        })
      ]);
    });
  ...
  test("error is thrown if id is not unique", (done) => {
    ...
    store.add(target.onRefresh.event(() => {
      testObject.$getChildren("testNodeWithIdTreeProvider").then((elements) => {
        const actuals = elements?.map((e) => e.handle);
        assert.deepStrictEqual(actuals, ["1/a", "1/b"]);
        return testObject.$getChildren("testNodeWithIdTreeProvider", "1/a").then(() => testObject.$getChildren("testNodeWithIdTreeProvider", "1/b")).then(() => assert.fail("Should fail with duplicate id")).catch(() => caughtExpectedError = true).finally(() => caughtExpectedError ? done() : assert.fail("Expected duplicate id error not thrown."));
      });
    }));
  ...
  __name(runWithEventMerging, "runWithEventMerging");
  ...
  function loadCompleteTree(treeId, element) {
    return testObject.$getChildren(treeId, element).then((elements) => elements?.map((e) => loadCompleteTree(treeId, e.handle))).then(() => null);
  }
  __name(loadCompleteTree, "loadCompleteTree");
  ...
  __name(aCompleteNodeTreeDataProvider, "aCompleteNodeTreeDataProvider");
  ...
  __name(aNodeWithIdTreeDataProvider, "aNodeWithIdTreeDataProvider");
  ...
  __name(aNodeWithHighlightedLabelTreeDataProvider, "aNodeWithHighlightedLabelTreeDataProvider");
  ...
  __name(getTreeElement, "getTreeElement");
  ...
  __name(getTreeItem, "getTreeItem");
