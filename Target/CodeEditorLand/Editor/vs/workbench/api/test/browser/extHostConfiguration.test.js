...
suite("ExtHostConfiguration", function() {
  ...
  __name(createExtHostConfiguration, "createExtHostConfiguration");
  function createConfigurationData(contents) {
    return {
      ...
      user: new ConfigurationModel(contents, [], [], void 0, new NullLogService()),
      workspace: ConfigurationModel.createEmptyModel(new NullLogService()),
      folders: [],
      configurationScopes: []
    };
  }
  __name(createConfigurationData, "createConfigurationData");
  ...
  __name(aWorkspaceFolder, "aWorkspaceFolder");
