...
suite("ExtHostTelemetry", function() {
  ...
  const createExtHostTelemetry = /* @__PURE__ */ __name(() => {
  ...
  }, "createExtHostTelemetry");
  const createLogger = /* @__PURE__ */ __name((functionSpy, extHostTelemetry, options) => {
    const extensionTelemetry = extHostTelemetry ?? createExtHostTelemetry();
    const appender = {
      sendEventData: /* @__PURE__ */ __name((eventName, data) => {
        functionSpy.dataArr.push({ eventName, data });
      }, "sendEventData"),
      sendErrorData: /* @__PURE__ */ __name((exception, data) => {
