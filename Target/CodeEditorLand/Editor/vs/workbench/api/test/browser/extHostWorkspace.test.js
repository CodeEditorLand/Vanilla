...
__name(createExtHostWorkspace, "createExtHostWorkspace");
suite("ExtHostWorkspace", function() {
  ...
  __name(assertAsRelativePath, "assertAsRelativePath");
  test("asRelativePath", () => {
  ...
  __name(aWorkspaceFolderData, "aWorkspaceFolderData");
  function asUpdateWorkspaceFolderData(uri, name) {
    return { uri, name };
  }
  __name(asUpdateWorkspaceFolderData, "asUpdateWorkspaceFolderData");
  suite("findFiles -", function() {
    ...
    __name(testFindFilesInclude, "testFindFilesInclude");
  ...
  suite("findFiles2 -", function() {
    ...
    __name(testFindFiles2Include, "testFindFiles2Include");
    test("RelativePattern include (string)", () => {
  ...
  suite("findFiles2New -", function() {
    ...
    __name(testFindFiles2NewInclude, "testFindFiles2NewInclude");
    test("RelativePattern include (string)", () => {
  ...
  suite("findTextInFilesNew -", function() {
    ...
    test("with cancelled token", async () => {
      ...
      const ws = createExtHostWorkspace(rpcProtocol, { id: "foo", folders: [aWorkspaceFolderData(URI.file(root), 0)], name: "Test" }, new NullLogService());
      const token = CancellationToken.Cancelled;
      await ws.findTextInFilesNew({ pattern: "foo" }, void 0, new ExtensionIdentifier("test"), token).complete;
      assert(!mainThreadCalled, "!mainThreadCalled");
    });
    test("RelativePattern exclude", async () => {
      const root = "/project/foo";
