...
suite("ExtHostDocumentData updates line mapping", () => {
  ...
  __name(positionToStr, "positionToStr");
  ...
  __name(assertDocumentLineMapping, "assertDocumentLineMapping");
  ...
  __name(createChangeEvent, "createChangeEvent");
  function testLineMappingDirectionAfterEvents(lines, eol, direction, e) {
    const myDocument = new ExtHostDocumentData(void 0, URI.file(""), lines.slice(0), eol, 1, "text", false);
    assertDocumentLineMapping(myDocument, direction);
    myDocument.onEvents(e);
    assertDocumentLineMapping(myDocument, direction);
  }
  __name(testLineMappingDirectionAfterEvents, "testLineMappingDirectionAfterEvents");
  ...
  __name(testLineMappingAfterEvents, "testLineMappingAfterEvents");
  ensureNoDisposablesAreLeakedInTestSuite();
  test("line mapping", () => {
