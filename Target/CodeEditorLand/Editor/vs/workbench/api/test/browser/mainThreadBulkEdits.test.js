...
suite("MainThreadBulkEdits", function() {
  ...
  test('"Rename failed to apply edits" in monorepo with pnpm #158845', function() {
    ...
    const edits = [
      { resource: URI.from({ scheme: "case", path: "/hello/WORLD/foo.txt" }), textEdit: { range: { startLineNumber: 1, startColumn: 1, endLineNumber: 1, endColumn: 1 }, text: "sss" }, versionId: void 0 },
      { resource: URI.from({ scheme: "case", path: "/heLLO/world/fOO.txt" }), textEdit: { range: { startLineNumber: 1, startColumn: 1, endLineNumber: 1, endColumn: 1 }, text: "sss" }, versionId: void 0 },
      { resource: URI.from({ scheme: "case", path: "/other/path.txt" }), textEdit: { range: { startLineNumber: 1, startColumn: 1, endLineNumber: 1, endColumn: 1 }, text: "sss" }, versionId: void 0 },
      { resource: URI.from({ scheme: "foo", path: "/other/path.txt" }), textEdit: { range: { startLineNumber: 1, startColumn: 1, endLineNumber: 1, endColumn: 1 }, text: "sss" }, versionId: void 0 }
    ];
    ...
    assert.strictEqual(out.edits[1].resource.path, "/hello/WORLD/foo.txt");
