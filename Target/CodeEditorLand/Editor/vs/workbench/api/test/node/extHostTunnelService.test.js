import s from"assert";import{findPorts as i,getRootProcesses as n,getSockets as c,loadConnectionTable as p,loadListeningPorts as a,parseIpAddress as d,tryFindRootPorts as b}from"../../node/extHostTunnelService.js";const r=`  sl  local_address rem_address   st tx_queue rx_queue tr tm->when retrnsmt   uid  timeout inode
...
`,l=`  sl  local_address                         remote_address                        st tx_queue rx_queue tr tm->when retrnsmt   uid  timeout inode
...
`,t=`ls: cannot access '/proc/8289/fd/255': No such file or directory
...
0 S node      1058  1056  0  80   0 -   770 pipe_w   888   9 14:43 ?        00:00:00 grep root`;suite("ExtHostTunnelService",()=>{test("getSockets",function(){const e=c(t);s.strictEqual(Object.keys(e).length,75),s.notStrictEqual(Object.keys(e).find(o=>e[o].pid===4412),void 0)}),test("loadConnectionTable",function(){const e=p(r);s.strictEqual(e.length,6),s.deepStrictEqual(e[0],{10:"1",11:"0000000010173312",12:"100",13:"0",14:"0",15:"10",16:"0",inode:"2335214",local_address:"00000000:0BBA",rem_address:"00000000:0000",retrnsmt:"00000000",sl:"0:",st:"0A",timeout:"0",tr:"00:00000000",tx_queue:"00000000:00000000",uid:"1000"})}),test("loadListeningPorts",function(){const e=a(r,l);s.strictEqual(e.length,7),s.notStrictEqual(e.find(o=>o.port===3002),void 0)}),test("tryFindRootPorts",function(){const e=n(x);s.strictEqual(e.length,6);const o=b([{socket:1e3,ip:"127.0.0.1",port:5e3}],x,new Map);s.strictEqual(o.size,1),s.strictEqual(o.get(5e3)?.pid,514)}),test("findPorts",async function(){const e=await i(a(r,l),c(t),f);s.strictEqual(e.length,1),s.strictEqual(e[0].host,"0.0.0.0"),s.strictEqual(e[0].port,3002),s.strictEqual(e[0].detail,"http-server")}),test("parseIpAddress",function(){s.strictEqual(d("00000000000000000000000001000000"),"0:0:0:0:0:0:0:1"),s.strictEqual(d("0000000000000000FFFF0000040510AC"),"0:0:0:0:0:ffff:ac10:504")})});
