...
import type { RenderLineNumbersType, TextEditorCursorStyle } from "../../../editor/common/config/editorOptions.js";
...
import type { ISelection, Selection } from "../../../editor/common/core/selection.js";
...
import type { CharacterPair, CommentRule, EnterAction } from "../../../editor/common/languages/languageConfiguration.js";
...
import type { ConfigurationTarget, IConfigurationChange, IConfigurationData, IConfigurationOverrides } from "../../../platform/configuration/common/configuration.js";
...
import type { ILoggerOptions, ILoggerResource, LogLevel } from "../../../platform/log/common/log.js";
import type { IMarkerData } from "../../../platform/markers/common/markers.js";
import type { IProgressOptions, IProgressStep } from "../../../platform/progress/common/progress.js";
import type * as quickInput from "../../../platform/quickinput/common/quickInput.js";
import type { IRemoteConnectionData, TunnelDescription } from "../../../platform/remote/common/remoteAuthorityResolver.js";
import type { AuthInfo, Credentials } from "../../../platform/request/common/request.js";
import type { ClassifiedEvent, IGDPRProperty, OmitMetadata, StrictPropertyCheck } from "../../../platform/telemetry/common/gdprTypings.js";
import type { TelemetryLevel } from "../../../platform/telemetry/common/telemetry.js";
import type { ISerializableEnvironmentDescriptionMap, ISerializableEnvironmentVariableCollection } from "../../../platform/terminal/common/environmentVariable.js";
import type { ICreateContributedTerminalProfileOptions, IProcessProperty, IProcessReadyWindowsPty, IShellLaunchConfigDto, ITerminalEnvironment, ITerminalLaunchError, ITerminalProfile, TerminalExitReason, TerminalLocation } from "../../../platform/terminal/common/terminal.js";
import type { ProvidedPortAttributes, TunnelCreationOptions, TunnelOptions, TunnelPrivacyId, TunnelProviderFeatures } from "../../../platform/tunnel/common/tunnel.js";
...
import type { IRevealOptions, ITreeItem, IViewBadge } from "../../common/views.js";
import type { CallHierarchyItem } from "../../contrib/callHierarchy/common/callHierarchy.js";
import type { ChatAgentLocation, IChatAgentMetadata, IChatAgentRequest, IChatAgentResult } from "../../contrib/chat/common/chatAgents.js";
import type { IChatProgressResponseContent } from "../../contrib/chat/common/chatModel.js";
import type { IChatFollowup, IChatProgress, IChatResponseErrorDetails, IChatTask, IChatTaskDto, IChatUserActionEvent, IChatVoteAction } from "../../contrib/chat/common/chatService.js";
import type { IChatRequestVariableValue, IChatVariableData, IChatVariableResolverProgress } from "../../contrib/chat/common/chatVariables.js";
import type { IChatMessage, IChatResponseFragment, ILanguageModelChatMetadata, ILanguageModelChatSelector, ILanguageModelsChangeEvent } from "../../contrib/chat/common/languageModels.js";
import type { IToolData, IToolInvocation, IToolResult } from "../../contrib/chat/common/languageModelToolsService.js";
import type { DebugConfigurationProviderTriggerKind, IAdapterDescriptor, IConfig, IDebugSessionReplMode, IDebugTestRunReference, IDebugVisualization, IDebugVisualizationContext, IDebugVisualizationTreeItem, MainThreadDebugVisualization } from "../../contrib/debug/common/debug.js";
...
import type { ICellExecutionComplete, ICellExecutionStateUpdate } from "../../contrib/notebook/common/notebookExecutionStateService.js";
...
import type { IWorkspaceSymbol, NotebookPriorityInfo } from "../../contrib/search/common/search.js";
import type { IRawClosedNotebookFileMatch } from "../../contrib/search/common/searchNotebookHelpers.js";
import type { IKeywordRecognitionEvent, ISpeechProviderMetadata, ISpeechToTextEvent, ITextToSpeechEvent } from "../../contrib/speech/common/speechService.js";
import type { CoverageDetails, ExtensionRunTestsRequest, ICallProfileRunHandler, IFileCoverage, ISerializedTestResults, IStartControllerTests, ITestItem, ITestMessage, ITestRunProfile, ITestRunTask, ResolvedTestRunRequest, TestControllerCapability, TestMessageFollowupRequest, TestMessageFollowupResponse, TestResultState, TestsDiffOp } from "../../contrib/testing/common/testTypes.js";
import type { Timeline, TimelineChangeEvent, TimelineOptions, TimelineProviderDescriptor } from "../../contrib/timeline/common/timeline.js";
import type { TypeHierarchyItem } from "../../contrib/typeHierarchy/common/typeHierarchy.js";
import type { RelatedInformationResult, RelatedInformationType } from "../../services/aiRelatedInformation/common/aiRelatedInformation.js";
import type { AuthenticationSession, AuthenticationSessionAccount, AuthenticationSessionsChangeEvent, IAuthenticationCreateSessionOptions, IAuthenticationProviderSessionOptions } from "../../services/authentication/common/authentication.js";
import type { EditorGroupColumn } from "../../services/editor/common/editorGroupColumn.js";
import type { IExtensionDescriptionDelta, IStaticWorkspaceData } from "../../services/extensions/common/extensionHostProtocol.js";
import type { IResolveAuthorityResult } from "../../services/extensions/common/extensionHostProxy.js";
import type { ActivationKind, ExtensionActivationReason, MissingExtensionDependency } from "../../services/extensions/common/extensions.js";
import { type Dto, type IRPCProtocol, type SerializableObjectWithBuffers } from "../../services/extensions/common/proxyIdentifier.js";
...
import type { IFileQueryBuilderOptions, ITextQueryBuilderOptions } from "../../services/search/common/queryBuilder.js";
...
export interface MainThreadAuthenticationShape extends IDisposable {
    ...
    $getSession(providerId: string, scopes: readonly string[], extensionId: string, extensionName: string, options: {
...
export declare enum TabInputKind {
    UnknownInput = 0,
    TextInput = 1,
    TextDiffInput = 2,
    TextMergeInput = 3,
...
export declare enum TabModelOperationKind {
    TAB_OPEN = 0,
    TAB_CLOSE = 1,
    TAB_UPDATE = 2,
    TAB_MOVE = 3
...
export declare enum WebviewEditorCapabilities {
    Editable = 0,
    SupportsHotExit = 1
}
...
export interface MainThreadWebviewViewsShape extends IDisposable {
    $registerWebviewViewProvider(extension: WebviewExtensionDescription, viewType: string, options: {
...
export interface ExtHostWebviewPanelsShape {
    ...
    $deserializeWebviewPanel(newWebviewHandle: WebviewHandle, viewType: string, initData: {
        title: string;
        state: any;
...
export interface ExtHostCustomEditorsShape {
    $resolveCustomEditor(resource: UriComponents, newWebviewHandle: WebviewHandle, viewType: string, initData: {
        title: string;
...
export declare enum CellOutputKind {
    Text = 1,
    Error = 2,
    Rich = 3
}
...
export interface ExtHostLanguageModelsShape {
    ...
    $startChatRequest(handle: number, requestId: number, from: ExtensionIdentifier, messages: IChatMessage[], options: {
        [name: string]: any;
...
export type IChatContentProgressDto = Dto<Exclude<IChatProgressResponseContent, IChatTask>> | IChatTaskDto;
...
export interface ExtHostChatAgentsShape2 {
    ...
    $detectChatParticipant(handle: number, request: Dto<IChatAgentRequest>, context: {
        history: IChatAgentHistoryEntryDto[];
    }, options: {
...
export type IChatVariableResolverProgressDto = Dto<IChatVariableResolverProgress>;
...
export type IChatProgressDto = Dto<Exclude<IChatProgress, IChatTask>> | IChatTaskDto;
...
export declare enum CandidatePortSource {
    None = 0,
    Process = 1,
    Output = 2,
    Hybrid = 3
...
export declare enum ISuggestDataDtoField {
    label = "a",
    kind = "b",
    detail = "c",
    documentation = "d",
...
export declare enum ISuggestResultDtoField {
    defaultRanges = "a",
    completions = "b",
    isIncomplete = "c",
    duration = "d"
...
export type IInlayHintsDto = CachedSession<{
    hints: IInlayHintDto[];
}>;
...
export type ICellEditOperationDto = notebookCommon.ICellPartialMetadataEdit | notebookCommon.IDocumentMetadataEdit | {
...
type CachedSessionItem<T> = T & {
    cacheId?: ChainedCacheId;
};
type CachedSession<T> = T & {
    cacheId?: CacheId;
};
export type ILinksListDto = CachedSession<{
    links: ILinkDto[];
}>;
export type ILinkDto = CachedSessionItem<Dto<languages.ILink>>;
export type ICodeLensListDto = CachedSession<{
    lenses: ICodeLensDto[];
}>;
...
export interface ExtHostLanguageFeaturesShape {
    ...
    $provideHover(handle: number, resource: UriComponents, position: IPosition, context: languages.HoverContext<{
        id: number;
    }> | undefined, token: CancellationToken): Promise<HoverWithId | undefined>;
    ...
    $resolvePasteEdit(handle: number, id: ChainedCacheId, token: CancellationToken): Promise<{
        additionalEdit?: IWorkspaceEditDto;
    }>;
...
export interface ExtHostCommentsShape {
    ...
    $setActiveComment(controllerHandle: number, commentInfo: {
...
export interface ExtHostNotebookShape extends ExtHostNotebookDocumentsAndEditorsShape {
    ...
    $searchInNotebooks(handle: number, textQuery: search.ITextQuery, viewTypeFileTargets: NotebookPriorityInfo[], otherViewTypeFileTargets: NotebookPriorityInfo[], token: CancellationToken): Promise<{
...
} | notebookCommon.NotebookCellsChangeLanguageEvent | notebookCommon.NotebookCellsChangeMimeEvent | notebookCommon.NotebookCellsChangeMetadataEvent | notebookCommon.NotebookCellsChangeInternalMetadataEvent | notebookCommon.NotebookCellContentChangeEvent;
...
export declare enum ExtHostTestingResource {
    Workspace = 0,
    TextDocument = 1
}
export interface ExtHostTestingShape {
    $runControllerTests(req: IStartControllerTests[], token: CancellationToken): Promise<{
        error?: string;
    }[]>;
    $startContinuousRun(req: ICallProfileRunHandler[], token: CancellationToken): Promise<{
        error?: string;
    }[]>;
...
export declare const MainContext: {
    ...
    MainThreadLanguageModels: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadLanguageModelsShape>;
    MainThreadEmbeddings: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadEmbeddingsShape>;
    MainThreadChatAgents2: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadChatAgentsShape2>;
    MainThreadChatVariables: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadChatVariablesShape>;
    ...
    MainThreadConfiguration: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadConfigurationShape>;
    MainThreadConsole: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadConsoleShape>;
    MainThreadDebugService: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadDebugServiceShape>;
    MainThreadDecorations: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadDecorationsShape>;
    MainThreadDiagnostics: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadDiagnosticsShape>;
    MainThreadDialogs: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadDiaglogsShape>;
    MainThreadDocuments: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadDocumentsShape>;
    MainThreadDocumentContentProviders: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadDocumentContentProvidersShape>;
    MainThreadTextEditors: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadTextEditorsShape>;
    MainThreadEditorInsets: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadEditorInsetsShape>;
    MainThreadEditorTabs: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadEditorTabsShape>;
    MainThreadErrors: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadErrorsShape>;
    MainThreadTreeViews: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadTreeViewsShape>;
    MainThreadDownloadService: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadDownloadServiceShape>;
    MainThreadLanguageFeatures: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadLanguageFeaturesShape>;
    MainThreadLanguages: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadLanguagesShape>;
    MainThreadLogger: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadLoggerShape>;
    MainThreadMessageService: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadMessageServiceShape>;
    ...
    MainThreadWebviewPanels: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadWebviewPanelsShape>;
    MainThreadWebviewViews: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadWebviewViewsShape>;
    MainThreadCustomEditors: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadCustomEditorsShape>;
    MainThreadUrls: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadUrlsShape>;
    MainThreadUriOpeners: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadUriOpenersShape>;
    MainThreadProfileContentHandlers: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadProfileContentHandlersShape>;
    MainThreadWorkspace: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadWorkspaceShape>;
    MainThreadFileSystem: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadFileSystemShape>;
    MainThreadFileSystemEventService: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadFileSystemEventServiceShape>;
    MainThreadExtensionService: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadExtensionServiceShape>;
    MainThreadSCM: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadSCMShape>;
    MainThreadSearch: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadSearchShape>;
    ...
    MainThreadNotebookEditors: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadNotebookEditorsShape>;
    MainThreadNotebookKernels: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadNotebookKernelsShape>;
    MainThreadNotebookRenderers: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadNotebookRenderersShape>;
    MainThreadInteractive: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadInteractiveShape>;
    MainThreadTheming: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadThemingShape>;
    MainThreadTunnelService: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadTunnelServiceShape>;
    MainThreadManagedSockets: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<MainThreadManagedSocketsShape>;
...
export declare const ExtHostContext: {
    ExtHostCommands: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostCommandsShape>;
    ExtHostConfiguration: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostConfigurationShape>;
    ExtHostDiagnostics: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostDiagnosticsShape>;
    ExtHostDebugService: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostDebugServiceShape>;
    ExtHostDecorations: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostDecorationsShape>;
    ExtHostDocumentsAndEditors: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostDocumentsAndEditorsShape>;
    ExtHostDocuments: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostDocumentsShape>;
    ExtHostDocumentContentProviders: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostDocumentContentProvidersShape>;
    ExtHostDocumentSaveParticipant: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostDocumentSaveParticipantShape>;
    ExtHostEditors: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostEditorsShape>;
    ExtHostTreeViews: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostTreeViewsShape>;
    ExtHostFileSystem: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostFileSystemShape>;
    ExtHostFileSystemInfo: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostFileSystemInfoShape>;
    ExtHostFileSystemEventService: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostFileSystemEventServiceShape>;
    ExtHostLanguages: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostLanguagesShape>;
    ExtHostLanguageFeatures: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostLanguageFeaturesShape>;
    ExtHostQuickOpen: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostQuickOpenShape>;
    ExtHostQuickDiff: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostQuickDiffShape>;
    ExtHostStatusBar: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostStatusBarShape>;
    ExtHostShare: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostShareShape>;
    ExtHostExtensionService: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostExtensionServiceShape>;
    ExtHostLogLevelServiceShape: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostLogLevelServiceShape>;
    ExtHostTerminalService: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostTerminalServiceShape>;
    ExtHostTerminalShellIntegration: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostTerminalShellIntegrationShape>;
    ExtHostSCM: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostSCMShape>;
    ExtHostSearch: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostSearchShape>;
    ...
    ExtHostWebviewViews: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostWebviewViewsShape>;
    ExtHostEditorInsets: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostEditorInsetsShape>;
    ExtHostEditorTabs: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<IExtHostEditorTabsShape>;
    ExtHostProgress: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostProgressShape>;
    ExtHostComments: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostCommentsShape>;
    ExtHostSecretState: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostSecretStateShape>;
    ...
    ExtHostNotebook: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostNotebookShape>;
    ExtHostNotebookDocuments: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostNotebookDocumentsShape>;
    ExtHostNotebookEditors: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostNotebookEditorsShape>;
    ExtHostNotebookKernels: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostNotebookKernelsShape>;
    ExtHostNotebookRenderers: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostNotebookRenderersShape>;
    ExtHostNotebookDocumentSaveParticipant: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostNotebookDocumentSaveParticipantShape>;
    ExtHostInteractive: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostInteractiveShape>;
    ExtHostChatAgents2: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostChatAgentsShape2>;
    ExtHostChatVariables: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostChatVariablesShape>;
    ...
    ExtHostAuthentication: import("../../services/extensions/common/proxyIdentifier.js").ProxyIdentifier<ExtHostAuthenticationShape>;
