...
import { Dto, IRPCProtocol, SerializableObjectWithBuffers } from "vs/workbench/services/extensions/common/proxyIdentifier";
...
export declare const MainContext: {
    MainThreadAuthentication: any;
    MainThreadBulkEdits: any;
    MainThreadLanguageModels: any;
    MainThreadEmbeddings: any;
    MainThreadChatAgents2: any;
    MainThreadChatVariables: any;
    MainThreadLanguageModelTools: any;
    MainThreadClipboard: any;
    MainThreadCommands: any;
    MainThreadComments: any;
    MainThreadConfiguration: any;
    MainThreadConsole: any;
    MainThreadDebugService: any;
    MainThreadDecorations: any;
    MainThreadDiagnostics: any;
    MainThreadDialogs: any;
    MainThreadDocuments: any;
    MainThreadDocumentContentProviders: any;
    MainThreadTextEditors: any;
    MainThreadEditorInsets: any;
    MainThreadEditorTabs: any;
    MainThreadErrors: any;
    MainThreadTreeViews: any;
    MainThreadDownloadService: any;
    MainThreadLanguageFeatures: any;
    MainThreadLanguages: any;
    MainThreadLogger: any;
    MainThreadMessageService: any;
    MainThreadOutputService: any;
    MainThreadProgress: any;
    MainThreadQuickDiff: any;
    MainThreadQuickOpen: any;
    MainThreadStatusBar: any;
    MainThreadSecretState: any;
    MainThreadStorage: any;
    MainThreadSpeech: any;
    MainThreadTelemetry: any;
    MainThreadTerminalService: any;
    MainThreadTerminalShellIntegration: any;
    MainThreadWebviews: any;
    MainThreadWebviewPanels: any;
    MainThreadWebviewViews: any;
    MainThreadCustomEditors: any;
    MainThreadUrls: any;
    MainThreadUriOpeners: any;
    MainThreadProfileContentHandlers: any;
    MainThreadWorkspace: any;
    MainThreadFileSystem: any;
    MainThreadFileSystemEventService: any;
    MainThreadExtensionService: any;
    MainThreadSCM: any;
    MainThreadSearch: any;
    MainThreadShare: any;
    MainThreadTask: any;
    MainThreadWindow: any;
    MainThreadLabelService: any;
    MainThreadNotebook: any;
    MainThreadNotebookDocuments: any;
    MainThreadNotebookEditors: any;
    MainThreadNotebookKernels: any;
    MainThreadNotebookRenderers: any;
    MainThreadInteractive: any;
    MainThreadTheming: any;
    MainThreadTunnelService: any;
    MainThreadManagedSockets: any;
    MainThreadTimeline: any;
    MainThreadTesting: any;
    MainThreadLocalization: any;
    MainThreadAiRelatedInformation: any;
    MainThreadAiEmbeddingVector: any;
};
export declare const ExtHostContext: {
    ExtHostCommands: any;
    ExtHostConfiguration: any;
    ExtHostDiagnostics: any;
    ExtHostDebugService: any;
    ExtHostDecorations: any;
    ExtHostDocumentsAndEditors: any;
    ExtHostDocuments: any;
    ExtHostDocumentContentProviders: any;
    ExtHostDocumentSaveParticipant: any;
    ExtHostEditors: any;
    ExtHostTreeViews: any;
    ExtHostFileSystem: any;
    ExtHostFileSystemInfo: any;
    ExtHostFileSystemEventService: any;
    ExtHostLanguages: any;
    ExtHostLanguageFeatures: any;
    ExtHostQuickOpen: any;
    ExtHostQuickDiff: any;
    ExtHostStatusBar: any;
    ExtHostShare: any;
    ExtHostExtensionService: any;
    ExtHostLogLevelServiceShape: any;
    ExtHostTerminalService: any;
    ExtHostTerminalShellIntegration: any;
    ExtHostSCM: any;
    ExtHostSearch: any;
    ExtHostTask: any;
    ExtHostWorkspace: any;
    ExtHostWindow: any;
    ExtHostWebviews: any;
    ExtHostWebviewPanels: any;
    ExtHostCustomEditors: any;
    ExtHostWebviewViews: any;
    ExtHostEditorInsets: any;
    ExtHostEditorTabs: any;
    ExtHostProgress: any;
    ExtHostComments: any;
    ExtHostSecretState: any;
    ExtHostStorage: any;
    ExtHostUrls: any;
    ExtHostUriOpeners: any;
    ExtHostProfileContentHandlers: any;
    ExtHostOutputService: any;
    ExtHostLabelService: any;
    ExtHostNotebook: any;
    ExtHostNotebookDocuments: any;
    ExtHostNotebookEditors: any;
    ExtHostNotebookKernels: any;
    ExtHostNotebookRenderers: any;
    ExtHostNotebookDocumentSaveParticipant: any;
    ExtHostInteractive: any;
    ExtHostChatAgents2: any;
    ExtHostChatVariables: any;
    ExtHostLanguageModelTools: any;
    ExtHostChatProvider: any;
    ExtHostSpeech: any;
    ExtHostEmbeddings: any;
    ExtHostAiRelatedInformation: any;
    ExtHostAiEmbeddingVector: any;
    ExtHostTheming: any;
    ExtHostTunnelService: any;
    ExtHostManagedSockets: any;
    ExtHostAuthentication: any;
    ExtHostTimeline: any;
    ExtHostTesting: any;
    ExtHostTelemetry: any;
    ExtHostLocalization: any;
};
export {};
