...
import { TestsDiffOp, type CoverageDetails, type ISerializedTestResults, type IStartControllerTests, type IStartControllerTestsResult, type TestMessageFollowupRequest, type TestMessageFollowupResponse } from "../../contrib/testing/common/testTypes.js";
import { type ExtHostTestingShape, type ILocationDto, type MainThreadTestingShape } from "./extHost.protocol.js";
