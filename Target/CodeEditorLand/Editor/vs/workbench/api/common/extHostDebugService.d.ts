...
import { type IAdapterDescriptor, type IConfig, type IDebugVisualization, type IDebugVisualizationContext, type IDebugVisualizationTreeItem, type MainThreadDebugVisualization } from "../../contrib/debug/common/debug.js";
...
import { type DebugSessionUUID, type ExtHostDebugServiceShape, type IBreakpointsDeltaDto, type IDebugSessionDto, type IStackFrameFocusDto, type IThreadFocusDto, type MainThreadDebugServiceShape } from "./extHost.protocol.js";
...
import { DebugAdapterExecutable } from "./extHostTypes.js";
