...
let ViewsService = class extends Disposable {
  ...
  _onDidChangeFocusedView = this._register(new Emitter());
  ...
  registerResetViewLocationAction(viewDescriptor) {
    return registerAction2(class ResetViewLocationAction extends Action2 {
      ...
      run(accessor) {
        ...
        viewDescriptorService.moveViewsToContainer([viewDescriptor], viewDescriptorService.getDefaultContainerById(viewDescriptor.id), void 0, this.desc.id);
  ...
  registerPaneComposite(viewContainer, viewContainerLocation) {
    ...
    Registry.as(getPaneCompositeExtension(viewContainerLocation)).registerPaneComposite(PaneCompositeDescriptor.create(
      PaneContainer,
      viewContainer.id,
...
__name(getPaneCompositeExtension, "getPaneCompositeExtension");
...
__name(getPartByLocation, "getPartByLocation");
registerSingleton(
  IViewsService,
  ViewsService,
