...
suite("ViewDescriptorService", () => {
  ...
  __name(aViewDescriptorService, "aViewDescriptorService");
  ...
  test("move view events", async function() {
    ...
    let actualSequence = "";
    const containerMoveString = /* @__PURE__ */ __name((view, from, to) => {
      return `Moved ${view.id} from ${from.id} to ${to.id}
`;
    }, "containerMoveString");
    const locationMoveString = /* @__PURE__ */ __name((view, from, to) => {
