...
suite("Replace Pattern test", () => {
  ...
  test("parse replace string", () => {
    const testParse = (input, expected, expectedHasParameters) => {
      let actual = new ReplacePattern(input, {
        pattern: "somepattern",
        isRegExp: true
      });
  ...
  test("get replace string if given text is a complete match", () => {
    let testObject = new ReplacePattern("hello", {
      pattern: "bla",
      isRegExp: true
    });
    let actual = testObject.getReplaceString("bla");
    assert.strictEqual(actual, "hello");
    testObject = new ReplacePattern("hello", {
      pattern: "bla",
      isRegExp: false
    });
    ...
    actual = testObject.getReplaceString("bla");
    assert.strictEqual(actual, "hello");
    testObject = new ReplacePattern("hello$0", {
      pattern: "(bla)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("bla");
    ...
    actual = testObject.getReplaceString("let fs = require('fs');");
    assert.strictEqual(actual, null);
    testObject = new ReplacePattern("cat$1", {
      pattern: "for(.*)",
      isRegExp: true
    });
  ...
  test("get replace string if match is sub-string of the text", () => {
    ...
    assert.strictEqual(actual, "hello");
    testObject = new ReplacePattern("that", {
      pattern: "this(?=.*bla)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "that");
    testObject = new ReplacePattern("$1at", {
      pattern: "(th)is(?=.*bla)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "that");
    testObject = new ReplacePattern("$1e", {
      pattern: "(th)is(?=.*bla)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "the");
    testObject = new ReplacePattern("$1ere", {
      pattern: "(th)is(?=.*bla)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "there");
    testObject = new ReplacePattern("$1", {
      pattern: "(th)is(?=.*bla)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "th");
    testObject = new ReplacePattern("ma$1", {
      pattern: "(th)is(?=.*bla)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "math");
    testObject = new ReplacePattern("ma$1s", {
      pattern: "(th)is(?=.*bla)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    ...
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "maths");
    testObject = new ReplacePattern("$0", {
      pattern: "(th)is(?=.*bla)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "this");
    testObject = new ReplacePattern("$0$1", {
      pattern: "(th)is(?=.*bla)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "thisth");
    testObject = new ReplacePattern("foo", {
      pattern: "bla(?=\\stext$)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "foo");
    testObject = new ReplacePattern("f$1", {
      pattern: "b(la)(?=\\stext$)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "fla");
    testObject = new ReplacePattern("f$0", {
      pattern: "b(la)(?=\\stext$)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
    assert.strictEqual(actual, "fbla");
    testObject = new ReplacePattern("$0ah", {
      pattern: "b(la)(?=\\stext$)",
      isRegExp: true
    });
    actual = testObject.getReplaceString("this is a bla text");
