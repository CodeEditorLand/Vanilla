...
__name(assertNoTraverses, "assertNoTraverses");
...
__name(assertTraverses, "assertTraverses");
...
__name(assertIgnoreMatch, "assertIgnoreMatch");
...
__name(assertNoIgnoreMatch, "assertNoIgnoreMatch");
suite("Parsing .gitignore files", () => {
  ...
  test("various advanced constructs found in popular repos", () => {
    const runTest = /* @__PURE__ */ __name(({ pattern, included, excluded }) => {
      for (const include of included) {
...
//# sourceMappingURL=ignoreFile.test.js.map
