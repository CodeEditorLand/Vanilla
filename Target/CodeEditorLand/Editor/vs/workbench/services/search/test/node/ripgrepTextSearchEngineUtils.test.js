...
suite("RipgrepTextSearchEngine", () => {
  ...
  test("fixRegexNewline - re", () => {
    ...
    __name(testFixRegexNewline, "testFixRegexNewline");
    [
      ["foo", "foo", true],
      ["foo\\n", "foo\r\n", true],
      ["foo\\n\\n", "foo\n\n", true],
  ...
  test("fixNewline - matching", () => {
    ...
    __name(testFixNewline, "testFixNewline");
    [
      ["foo", "foo"],
      ["foo\n", "foo\r\n"],
      ["foo\n", "foo\n"],
  ...
  suite("RipgrepParser", () => {
    ...
    __name(makeRgMatch, "makeRgMatch");
    test("single result", () => {
      testParser(
        [
  ...
  suite("getRgArgs", () => {
    test("simple includes", () => {
      ...
      __name(testGetRgArgs, "testGetRgArgs");
      [
  ...
  test("brace expansion for ripgrep", () => {
    ...
    __name(testBraceExpansion, "testBraceExpansion");
    [
