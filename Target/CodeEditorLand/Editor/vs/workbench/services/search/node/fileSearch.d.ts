...
import { IFileQuery, IFolderQuery, IProgressMessage, IRawFileMatch, ISearchEngine, ISearchEngineStats, ISearchEngineSuccess } from "vs/workbench/services/search/common/search";
