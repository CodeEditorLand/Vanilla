...
} from "../../common/proxyIdentifier.js";
...
suite("RPCProtocol", () => {
  ...
  test("simple call without result", (done) => {
    delegate = (a1, a2) => {
    };
    bProxy.$m(4, 1).then((res) => {
  ...
  test("passing buffer as argument", (done) => {
    delegate = (a1, a2) => {
  ...
  test("cancelling a call via CancellationToken before", (done) => {
    delegate = (a1, a2) => a1 + a2;
  ...
  test("passing CancellationToken.None", (done) => {
    delegate = (a1, token) => {
      assert.ok(!!token);
      return a1 + 1;
    };
  ...
  test("cancelling a call via CancellationToken quickly", (done) => {
    delegate = (a1, token) => {
  ...
  test("issue #60450: Converting circular structure to JSON", (done) => {
    delegate = (a1, a2) => {
      const circular = {};
  ...
  test("issue #72798: null errors are hard to digest", (done) => {
    delegate = (a1, a2) => {
      throw { what: "what" };
    };
    bProxy.$m(4, 1).then(
  ...
  test("undefined arguments arrive as null", () => {
    delegate = (a1, a2) => {
  ...
  test("SerializableObjectWithBuffers is correctly transfered", (done) => {
    delegate = (a1, a2) => {
    ...
    b.buffer[3] = 4;
    bProxy.$m(
      new SerializableObjectWithBuffers({ string: "hello", buff: b }),
      void 0
    ).then((res) => {
