...
const IExtensionBisectService = createDecorator(
...
let ExtensionBisectService = class {
  ...
  _isEnabledInEnv(extension) {
    return Array.isArray(this._envService.enableExtensions) && this._envService.enableExtensions.some(
...
let ExtensionBisectUi = class {
  ...
  static ctxIsBisectActive = new RawContextKey(
