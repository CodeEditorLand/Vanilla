  ...
  if (!service) {
    ...
    if (!workspaceContextService) {
      workspaceContextService = instantiationService.stub(IWorkspaceContextService, {
        getWorkbenchState: /* @__PURE__ */ __name(() => WorkbenchState.FOLDER, "getWorkbenchState"),
        getWorkspace: /* @__PURE__ */ __name(() => TestWorkspace, "getWorkspace")
      });
    }
...
class TestExtensionEnablementService extends ExtensionEnablementService {
  static {
    __name(this, "TestExtensionEnablementService");
  }
  constructor(instantiationService) {
    const disposables = new DisposableStore();
    const storageService = createStorageService(instantiationService, disposables);
    const extensionManagementServerService = instantiationService.get(IExtensionManagementServerService) || instantiationService.stub(IExtensionManagementServerService, anExtensionManagementServerService({
      id: "local",
      label: "local",
    ...
    super(
      ...
      instantiationService.get(IUserDataSyncEnablementService) || instantiationService.stub(IUserDataSyncEnablementService, { isEnabled() {
        return false;
      } }),
...
suite("ExtensionEnablementService Test", () => {
  ...
  test("test disable an extension globally should return truthy promise", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally).then((value) => assert.ok(value));
  });
  ...
  test("test disable an extension globally again should return a falsy promise", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally)).then((value) => assert.ok(!value[0]));
  });
  test("test state of globally disabled extension", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.DisabledGlobally));
  });
  test("test state of globally enabled extension", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledGlobally)).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.EnabledGlobally));
  });
  ...
  test("test disable an extension for workspace returns a truthy promise", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then((value) => assert.ok(value));
  });
  test("test disable an extension for workspace again should return a falsy promise", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace)).then((value) => assert.ok(!value[0]));
  });
  test("test state of workspace disabled extension", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.DisabledWorkspace));
  });
  test("test state of workspace and globally disabled extension", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace)).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.DisabledWorkspace));
  });
  test("test state of workspace enabled extension", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledWorkspace)).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.EnabledWorkspace));
  });
  test("test state of globally disabled and workspace enabled extension", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace)).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledWorkspace)).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.EnabledWorkspace));
  });
  test("test state of an extension when disabled for workspace from workspace enabled", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledWorkspace)).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace)).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.DisabledWorkspace));
  });
  test("test state of an extension when disabled globally from workspace enabled", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledWorkspace)).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally)).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.DisabledGlobally));
  });
  test("test state of an extension when disabled globally from workspace disabled", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally)).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.DisabledGlobally));
  });
  test("test state of an extension when enabled globally from workspace enabled", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledWorkspace)).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledGlobally)).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.EnabledGlobally));
  });
  test("test state of an extension when enabled globally from workspace disabled", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledGlobally)).then(() => assert.strictEqual(testObject.getEnablementState(aLocalExtension("pub.a")), EnablementState.EnabledGlobally));
  });
  ...
  test("test disable an extension for workspace and then globally return a truthy promise", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally)).then((value) => assert.ok(value));
  });
  test("test disable an extension for workspace and then globally trigger the change event", () => {
    const target = sinon.spy();
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => disposableStore.add(testObject.onEnablementChanged(target))).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally)).then(() => {
      assert.ok(target.calledOnce);
      assert.deepStrictEqual(target.args[0][0][0].identifier, { id: "pub.a" });
    });
  });
  ...
  test("test disable an extension globally and then for workspace return a truthy promise", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace)).then((value) => assert.ok(value));
  });
  test("test disable an extension globally and then for workspace triggers the change event", () => {
    const target = sinon.spy();
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally).then(() => disposableStore.add(testObject.onEnablementChanged(target))).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace)).then(() => {
      assert.ok(target.calledOnce);
      assert.deepStrictEqual(target.args[0][0][0].identifier, { id: "pub.a" });
    });
  });
  test("test disable an extension for workspace when there is no workspace throws error", () => {
    ...
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => assert.fail("should throw an error"), (error) => assert.ok(error));
  });
  ...
  test("test enable an extension globally triggers change event", () => {
    const target = sinon.spy();
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally).then(() => disposableStore.add(testObject.onEnablementChanged(target))).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledGlobally)).then(() => {
      assert.ok(target.calledOnce);
      assert.deepStrictEqual(target.args[0][0][0].identifier, { id: "pub.a" });
    });
  });
  test("test enable an extension globally when already enabled return falsy promise", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledGlobally).then((value) => assert.ok(!value[0]));
  });
  ...
  test("test enable an extension for workspace return truthy promise", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledWorkspace)).then((value) => assert.ok(value));
  });
  test("test enable an extension for workspace triggers change event", () => {
    const target = sinon.spy();
    return testObject.setEnablement([aLocalExtension("pub.b")], EnablementState.DisabledWorkspace).then(() => disposableStore.add(testObject.onEnablementChanged(target))).then(() => testObject.setEnablement([aLocalExtension("pub.b")], EnablementState.EnabledWorkspace)).then(() => {
      assert.ok(target.calledOnce);
  ...
  test("test enable an extension for workspace when already enabled return truthy promise", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.EnabledWorkspace).then((value) => assert.ok(value));
  });
  ...
  test("test isEnabled return false extension is disabled globally", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledGlobally).then(() => assert.ok(!testObject.isEnabled(aLocalExtension("pub.a"))));
  });
  test("test isEnabled return false extension is disabled in workspace", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => assert.ok(!testObject.isEnabled(aLocalExtension("pub.a"))));
  });
  test("test isEnabled return true extension is not disabled", () => {
    return testObject.setEnablement([aLocalExtension("pub.a")], EnablementState.DisabledWorkspace).then(() => testObject.setEnablement([aLocalExtension("pub.c")], EnablementState.DisabledGlobally)).then(() => assert.ok(testObject.isEnabled(aLocalExtension("pub.b"))));
  });
  ...
  test("test canChangeEnablement return false for auth extension and user data sync account depends on it and auto sync is on", () => {
    instantiationService.stub(IUserDataSyncEnablementService, { isEnabled() {
      return true;
    } });
    instantiationService.stub(IUserDataSyncAccountService, {
      account: { authenticationProviderId: "a" }
  ...
  test("test canChangeEnablement return true for system extensions when extensions are disabled in environment", () => {
    instantiationService.stub(IWorkbenchEnvironmentService, { disableExtensions: true });
    testObject = disposableStore.add(new TestExtensionEnablementService(instantiationService));
    const extension = aLocalExtension("pub.a", void 0, ExtensionType.System);
  ...
  test("test extension does not support untrusted workspaces is disabled in untrusted workspace", () => {
    ...
    instantiationService.stub(IWorkspaceTrustManagementService, { isWorkspaceTrusted() {
      return false;
    } });
    testObject = disposableStore.add(new TestExtensionEnablementService(instantiationService));
...
__name(anExtensionManagementServer, "anExtensionManagementServer");
...
function anExtensionManagementServerService(localExtensionManagementServer, remoteExtensionManagementServer, webExtensionManagementServer) {
  return {
    ...
    getExtensionInstallLocation(extension) {
      ...
      return server === remoteExtensionManagementServer ? ExtensionInstallLocation.Remote : server === webExtensionManagementServer ? ExtensionInstallLocation.Web : ExtensionInstallLocation.Local;
    }
  };
}
__name(anExtensionManagementServerService, "anExtensionManagementServerService");
...
__name(aLocalExtension2, "aLocalExtension2");
export {
  TestExtensionEnablementService,
  anExtensionManagementServerService
};
