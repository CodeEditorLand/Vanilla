...
function createProvider(overrides = {}) {
  return {
    ...
    id: "test",
    label: "Test",
    getSessions: /* @__PURE__ */ __name(async () => [], "getSessions"),
    createSession: /* @__PURE__ */ __name(async () => createSession(), "createSession"),
    removeSession: /* @__PURE__ */ __name(async () => {
    }, "removeSession"),
    ...overrides
  };
}
...
suite("AuthenticationService", () => {
  ...
  suite("authenticationSessions", () => {
    test("getSessions", async () => {
      let isCalled = false;
      const provider = createProvider({
        getSessions: /* @__PURE__ */ __name(async () => {
          isCalled = true;
    ...
    test("createSession", async () => {
      ...
      const provider = createProvider({
        ...
        createSession: /* @__PURE__ */ __name(async () => {
    ...
    test("removeSession", async () => {
      ...
      const provider = createProvider({
        onDidChangeSessions: emitter.event,
        removeSession: /* @__PURE__ */ __name(async () => emitter.fire({ added: [], removed: [session], changed: [] }), "removeSession")
      });
      const changed = Event.toPromise(authenticationService.onDidChangeSessions);
      authenticationService.registerAuthenticationProvider(provider.id, provider);
