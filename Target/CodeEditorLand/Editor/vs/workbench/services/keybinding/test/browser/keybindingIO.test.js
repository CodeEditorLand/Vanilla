...
suite("keybindingIO", () => {
  ...
  test("serialize/deserialize", () => {
    function testOneSerialization(keybinding, expected, msg, OS) {
      const usLayoutResolvedKeybinding = createUSLayoutResolvedKeybinding(
        keybinding,
        OS
      );
  ...
  test("deserialize scan codes", () => {
    assert.deepStrictEqual(
      ...
      new Keybinding([
        new ScanCodeChord(true, true, false, false, ScanCode.Comma),
