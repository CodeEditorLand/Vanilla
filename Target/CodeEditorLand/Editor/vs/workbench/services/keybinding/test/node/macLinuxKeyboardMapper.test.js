...
suite("keyboardMapper - MAC de_ch", () => {
  ...
  __name(assertKeybindingTranslation, "assertKeybindingTranslation");
  ...
  __name(_assertResolveKeybinding, "_assertResolveKeybinding");
  test("kb => hw", () => {
...
suite("keyboardMapper", () => {
  ...
  test("issue #24064: NumLock/NumPad keys stopped working in 1.11 on Linux", () => {
    ...
    __name(assertNumpadKeyboardEvent, "assertNumpadKeyboardEvent");
  ...
  test("issue #24107: Delete, Insert, Home, End, PgUp, PgDn, and arrow keys no longer work editor in 1.11", () => {
    ...
    __name(assertKeyboardEvent, "assertKeyboardEvent");
...
__name(_assertKeybindingTranslation, "_assertKeybindingTranslation");
