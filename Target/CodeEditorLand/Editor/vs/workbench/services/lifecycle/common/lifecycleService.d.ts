...
import { LifecyclePhase, ShutdownReason, StartupKind, type BeforeShutdownErrorEvent, type ILifecycleService, type InternalBeforeShutdownEvent, type WillShutdownEvent } from "./lifecycle.js";
