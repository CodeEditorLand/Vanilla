...
class TestNativeWorkbenchEnvironmentService extends NativeWorkbenchEnvironmentService {
  static {
    __name(this, "TestNativeWorkbenchEnvironmentService");
  }
...
class NodeTestWorkingCopyBackupService extends NativeWorkingCopyBackupService {
  static {
    __name(this, "NodeTestWorkingCopyBackupService");
  }
...
${content}`;
    ...
    __name(toExpectedPreamble, "toExpectedPreamble");
    test("joining", async () => {
    ...
    __name(testLargeTextFile, "testLargeTextFile");
  ...
  suite("resolve", () => {
    ...
    __name(testResolveBackup, "testResolveBackup");
    ...
    __name(doTestResolveBackup, "doTestResolveBackup");
    ...
    __name(testShouldRestoreOriginalContentsWithBrokenBackup, "testShouldRestoreOriginalContentsWithBrokenBackup");
    ...
    __name(testShouldUpdateMetaFromFileWhenResolving, "testShouldUpdateMetaFromFileWhenResolving");
