...
suite("WorkingCopyEditorService", () => {
  ...
  test("registry - basics", () => {
    ...
    const editorHandler = {
      ...
      isOpen: /* @__PURE__ */ __name(() => false, "isOpen"),
  ...
  test("findEditor", async () => {
    ...
    const editorHandler = {
      handles: /* @__PURE__ */ __name((workingCopy) => workingCopy === testWorkingCopy, "handles"),
      isOpen: /* @__PURE__ */ __name((workingCopy, editor) => workingCopy === testWorkingCopy, "isOpen"),
      createEditor: /* @__PURE__ */ __name((workingCopy) => {
        throw new Error();
      }, "createEditor")
    };
