...
suite("Preferences Validation", () => {
  ...
  class Tester {
    ...
    rejects(input) {
      ...
      return {
        withMessage: /* @__PURE__ */ __name((message) => {
  ...
  test("getInvalidTypeError", () => {
    ...
    __name(testInvalidTypeError, "testInvalidTypeError");
...
//# sourceMappingURL=preferencesValidation.test.js.map
