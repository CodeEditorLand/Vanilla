...
suite("KeybindingsEditorModel", () => {
  ...
  __name(prepareKeybindingService, "prepareKeybindingService");
  ...
  __name(registerCommandWithTitle, "registerCommandWithTitle");
  ...
  __name(assertKeybindingItems, "assertKeybindingItems");
  ...
  __name(assertKeybindingItem, "assertKeybindingItem");
  function aResolvedKeybindingItem({ command, when, isDefault, firstChord, secondChord, extensionId }) {
    ...
    return new ResolvedKeybindingItem(keybinding, command || "some command", null, when ? ContextKeyExpr.deserialize(when) : void 0, isDefault === void 0 ? true : isDefault, extensionId ?? null, false);
  }
  ...
  __name(asResolvedKeybindingItems, "asResolvedKeybindingItems");
});
