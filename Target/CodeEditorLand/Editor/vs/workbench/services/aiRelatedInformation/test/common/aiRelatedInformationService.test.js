...
suite("AiRelatedInformationService", () => {
  ...
  test("should check if providers are registered", () => {
    ...
    store.add(service.registerAiRelatedInformationProvider(RelatedInformationType.CommandInformation, { provideAiRelatedInformation: /* @__PURE__ */ __name(() => Promise.resolve([]), "provideAiRelatedInformation") }));
    assert.equal(service.isEnabled(), true);
  });
  test("should register and unregister providers", () => {
    const provider = { provideAiRelatedInformation: /* @__PURE__ */ __name(() => Promise.resolve([]), "provideAiRelatedInformation") };
  ...
  test("should get related information", async () => {
    ...
    const provider = {
      provideAiRelatedInformation: /* @__PURE__ */ __name(() => Promise.resolve([{ type: RelatedInformationType.CommandInformation, command, weight: 1 }]), "provideAiRelatedInformation")
    };
  ...
  test("should get different types of related information", async () => {
    ...
    const settingProvider = {
      provideAiRelatedInformation: /* @__PURE__ */ __name(() => Promise.resolve([{ type: RelatedInformationType.SettingInformation, setting, weight: 1 }]), "provideAiRelatedInformation")
    };
  ...
  test("should return empty array on timeout", async () => {
    ...
    const provider = {
      provideAiRelatedInformation: /* @__PURE__ */ __name(() => new Promise((resolve) => {
        setTimeout(() => {
