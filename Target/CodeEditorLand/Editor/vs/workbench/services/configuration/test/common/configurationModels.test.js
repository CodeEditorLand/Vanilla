...
suite("FolderSettingsModelParser", () => {
  ...
  test("parse all folder settings", () => {
    ...
    expected["FolderSettingsModelParser"] = /* @__PURE__ */ Object.create(null);
  ...
  test("parse resource folder settings", () => {
    ...
    testObject.parse(
      ...
      { scopes: [ConfigurationScope.RESOURCE] }
    );
    const expected = /* @__PURE__ */ Object.create(null);
    expected["FolderSettingsModelParser"] = /* @__PURE__ */ Object.create(null);
    expected["FolderSettingsModelParser"]["resource"] = "resource";
  ...
  test("reparse folder settings excludes application and machine setting", () => {
    const parseOptions = {
      scopes: [ConfigurationScope.RESOURCE, ConfigurationScope.WINDOW]
    };
    const testObject = new ConfigurationModelParser(
      "settings",
      new NullLogService()
    ...
    let expected = /* @__PURE__ */ Object.create(null);
    expected["FolderSettingsModelParser"] = /* @__PURE__ */ Object.create(null);
    expected["FolderSettingsModelParser"]["resource"] = "resource";
    ...
    expected = /* @__PURE__ */ Object.create(null);
    expected["FolderSettingsModelParser"] = /* @__PURE__ */ Object.create(null);
    expected["FolderSettingsModelParser"]["resource"] = "resource";
    assert.deepStrictEqual(
      testObject.configurationModel.contents,
...
suite("StandaloneConfigurationModelParser", () => {
  ...
  test("parse tasks stand alone configuration model", () => {
    const testObject = new StandaloneConfigurationModelParser(
      "tasks",
      "tasks",
      new NullLogService()
    );
    ...
    const expected = /* @__PURE__ */ Object.create(null);
    expected["tasks"] = /* @__PURE__ */ Object.create(null);
...
suite("Workspace Configuration", () => {
  ...
  test("Test compare same configurations", () => {
    ...
    configuration1.updateLocalUserConfiguration(
      toConfigurationModel({
        "window.title": "native",
        "[typescript]": { "editor.insertSpaces": false }
      })
    );
    configuration1.updateWorkspaceConfiguration(
      toConfigurationModel({ "editor.lineNumbers": "on" })
    );
    configuration1.updateFolderConfiguration(
      URI.file("folder1"),
      toConfigurationModel({ "editor.fontSize": 14 })
    );
    configuration1.updateFolderConfiguration(
      URI.file("folder2"),
      toConfigurationModel({ "editor.wordWrap": "on" })
    );
    ...
    configuration2.updateLocalUserConfiguration(
      toConfigurationModel({
        "window.title": "native",
        "[typescript]": { "editor.insertSpaces": false }
      })
    );
    configuration2.updateWorkspaceConfiguration(
      toConfigurationModel({ "editor.lineNumbers": "on" })
    );
    configuration2.updateFolderConfiguration(
      URI.file("folder1"),
      toConfigurationModel({ "editor.fontSize": 14 })
    );
    configuration2.updateFolderConfiguration(
  ...
  test("Test compare different configurations", () => {
    ...
    configuration2.updateWorkspaceConfiguration(
      toConfigurationModel({ "editor.fontSize": 11 })
    );
    configuration2.updateFolderConfiguration(
      URI.file("folder1"),
      toConfigurationModel({ "editor.insertSpaces": true })
    );
    configuration2.updateFolderConfiguration(
      URI.file("folder2"),
      toConfigurationModel({
