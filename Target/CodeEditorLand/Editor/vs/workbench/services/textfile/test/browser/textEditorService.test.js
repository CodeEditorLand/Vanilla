...
suite("TextEditorService", () => {
  ...
  let FileServiceProvider = class extends Disposable {
    static {
      __name(this, "FileServiceProvider");
    }
  ...
  test("createTextEditor - basics", async function() {
    ...
    input = disposables.add(service.createTextEditor({ resource: toResource.call(this, "/index.html"), languageId }));
    assert(input instanceof FileEditorInput);
    contentInput = input;
    ...
    input = disposables.add(service.createTextEditor({ resource: void 0, options: { selection: { startLineNumber: 1, startColumn: 1 } } }));
    ...
    input = disposables.add(service.createTextEditor({ resource: void 0, languageId, options: { selection: { startLineNumber: 1, startColumn: 1 } } }));
    assert(input instanceof UntitledTextEditorInput);
