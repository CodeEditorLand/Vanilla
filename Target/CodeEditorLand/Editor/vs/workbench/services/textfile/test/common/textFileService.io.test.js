...
function createSuite(params) {
  ...
  __name(createTextModelSnapshot, "createTextModelSnapshot");
  ...
  __name(testEncoding, "testEncoding");
  ...
  __name(testEncodingKeepsData, "testEncodingKeepsData");
  ...
  __name(testReadStream, "testReadStream");
  ...
  __name(testLargeEncoding, "testLargeEncoding");
