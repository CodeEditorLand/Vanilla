...
fixtures["some_cyrillic.txt"] = Uint8Array.from([
  ...range(128, 175 + 1),
  ...range(224, 239 + 1)
]);
...
fixtures["some_shiftjis.txt"] = Uint8Array.from([
  146,
  134,
  149,
  182,
...
fixtures["small.txt"] = Uint8Array.from([
  83,
  109,
  97,
  108,
...
fixtures["some.shiftjis.1.txt"] = Uint8Array.from([
  82,
  177,
  82,
  241,
...
fixtures["lorem_cp1252.txt"] = getTestData(
  Uint8Array.from([246, 228, 252, 223])
);
fixtures["lorem_big5.txt"] = getTestData(
  Uint8Array.from([164, 164, 164, 229, 97, 98, 99])
);
fixtures["lorem_shiftjis.txt"] = getTestData(
  Uint8Array.from([146, 134, 149, 182, 97, 98, 99])
);
fixtures["lorem_gbk.txt"] = getTestData(
  Uint8Array.from([214, 208, 185, 250, 97, 98, 99])
);
...
fixtures["lorem_utf8bom.txt"] = VSBuffer.concat([
  ...
  VSBuffer.wrap(
    getTestData(Uint8Array.from([195, 182, 195, 164, 195, 188, 195, 159]))
  )
]).buffer;
