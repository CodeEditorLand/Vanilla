...
suite("Files - TextFileEditorModelManager", () => {
  ...
  test("add, remove, clear, get, getAll", function() {
    ...
    const model1 = disposables.add(
      instantiationService.createInstance(
        TextFileEditorModel,
        toResource.call(this, "/path/random1.txt"),
        "utf8",
        void 0
      )
    );
    const model2 = disposables.add(
      instantiationService.createInstance(
        TextFileEditorModel,
        toResource.call(this, "/path/random2.txt"),
        "utf8",
        void 0
      )
    );
    const model3 = disposables.add(
      instantiationService.createInstance(
        TextFileEditorModel,
        toResource.call(this, "/path/random3.txt"),
        "utf8",
        void 0
      )
    );
  ...
  test("canDispose with dirty model", async function() {
    ...
    const canDisposePromise = manager.canDispose(
      model
    );
  ...
  test("language", async function() {
    ...
    const manager = accessor.textFileService.files;
    const resource = toResource.call(
      this,
