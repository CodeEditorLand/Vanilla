...
suite("EditorGroupsService", () => {
  ...
  __name(createParts, "createParts");
  ...
  test("selection: setSelection, isSelected, selectedEditors", async () => {
    ...
    __name(isSelection, "isSelection");
  ...
  test("context key provider", async function() {
    ...
    const instantiationService = workbenchInstantiationService({ contextKeyService: /* @__PURE__ */ __name((instantiationService2) => instantiationService2.createInstance(MockScopableContextKeyService), "contextKeyService") }, disposables2);
    ...
    const contextKeyProvider = {
      ...
      getGroupContextKeyValue: /* @__PURE__ */ __name((group) => group.id, "getGroupContextKeyValue")
    };
  ...
  test("context key provider: onDidChange", async function() {
    ...
    const contextKeyProvider = {
      contextKey: rawContextKey,
      getGroupContextKeyValue: /* @__PURE__ */ __name((group) => group.id + offset, "getGroupContextKeyValue"),
  ...
  test("context key provider: active editor change", async function() {
    ...
    const contextKeyProvider = {
      contextKey: rawContextKey,
      getGroupContextKeyValue: /* @__PURE__ */ __name((group) => group.activeEditor?.resource?.toString() ?? "", "getGroupContextKeyValue")
    };
    disposables2.add(parts.registerContextKeyProvider(contextKeyProvider));
