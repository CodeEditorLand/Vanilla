...
suite("EditorsObserver", function() {
  ...
  async function createEditorObserver(scoped = false) {
    ...
    const observer = disposables.add(new EditorsObserver(scoped ? part : void 0, part, disposables.add(new TestStorageService())));
    return [part, observer, instantiationService];
  }
  __name(createEditorObserver, "createEditorObserver");
  ...
  __name(testSingleGroupBasics, "testSingleGroupBasics");
  ...
  test("hasEditor/hasEditors - side by side editor support", async () => {
    ...
    const input = instantiationService.createInstance(SideBySideEditorInput, "name", void 0, secondary, primary);
  ...
  test("initial editors are part of observer and state is persisted & restored (single group)", async () => {
    ...
    const observer = disposables.add(new EditorsObserver(void 0, part, storage));
    ...
    const restoredObserver = disposables.add(new EditorsObserver(void 0, part, storage));
    await part.whenReady;
