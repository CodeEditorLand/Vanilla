...
suite("EditorResolverService", () => {
  ...
  __name(createEditorResolverService, "createEditorResolverService");
  function constructDisposableFileEditorInput(uri, typeId, store) {
    const editor = new TestFileEditorInput(uri, typeId);
    store.add(editor);
    return editor;
  }
  __name(constructDisposableFileEditorInput, "constructDisposableFileEditorInput");
  test("Simple Resolve", async () => {
    ...
    const registeredEditor = service.registerEditor(
      ...
      {},
      {
        createEditorInput: /* @__PURE__ */ __name(({ resource, options }, group) => ({ editor: new TestFileEditorInput(URI.parse(resource.toString()), TEST_EDITOR_INPUT_ID) }), "createEditorInput")
      }
    );
  ...
  test("Untitled Resolve", async () => {
    ...
    const registeredEditor = service.registerEditor(
      ...
      {
        createEditorInput: /* @__PURE__ */ __name(({ resource, options }, group) => ({ editor: new TestFileEditorInput(URI.parse(resource.toString()), TEST_EDITOR_INPUT_ID) }), "createEditorInput"),
        createUntitledEditorInput: /* @__PURE__ */ __name(({ resource, options }, group) => ({ editor: new TestFileEditorInput(resource ? resource : URI.from({ scheme: Schemas.untitled }), UNTITLED_TEST_EDITOR_INPUT_ID) }), "createUntitledEditorInput")
      }
    );
  ...
  test("Side by side Resolve", async () => {
    ...
    const registeredEditorPrimary = service.registerEditor(
      ...
      {},
      {
        createEditorInput: /* @__PURE__ */ __name(({ resource, options }, group) => ({ editor: constructDisposableFileEditorInput(URI.parse(resource.toString()), TEST_EDITOR_INPUT_ID, disposables) }), "createEditorInput")
      }
    );
  ...
  test("Diff editor Resolve", async () => {
    ...
    const registeredEditor = service.registerEditor(
      ...
      {
        createEditorInput: /* @__PURE__ */ __name(({ resource, options }, group) => ({ editor: constructDisposableFileEditorInput(URI.parse(resource.toString()), TEST_EDITOR_INPUT_ID, disposables) }), "createEditorInput"),
        createDiffEditorInput: /* @__PURE__ */ __name(({ modified, original, options }, group) => ({
