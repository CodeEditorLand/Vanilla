...
suite("Custom Editor Label Service", () => {
  ...
  async function createCustomLabelService(instantiationService = workbenchInstantiationService(
    void 0,
    disposables
  )) {
    const configService = new TestConfigurationService();
    await configService.setUserConfiguration(
  ...
  test("Custom Labels: filename", async () => {
    ...
    assert.strictEqual(
      customLabelService.getName(URI.file("file")),
      "file"
    );
    assert.strictEqual(
      customLabelService.getName(URI.file("file.txt")),
      "file"
    );
    assert.strictEqual(
      customLabelService.getName(URI.file("file.txt1.txt2")),
      "file"
    );
    assert.strictEqual(
      customLabelService.getName(URI.file("folder/file.txt1.txt2")),
      "file"
    );
    assert.strictEqual(
      customLabelService.getName(URI.file(".file")),
  ...
  test("Custom Labels: extname(N)", async () => {
    ...
    function assertExtname(filename, ext) {
      ...
      assert.strictEqual(
        customLabelService.getName(
          URI.file(`test/extMinus1/${filename}`)
        ),
      ...
      assert.strictEqual(
        customLabelService.getName(
          URI.file(`test/extMinus2/${filename}`)
        ),
  ...
  test("Custom Labels: no pattern match", async () => {
    ...
    assert.strictEqual(
      customLabelService.getName(URI.file("folder1/file.txt1.txt2")),
      void 0
    );
    assert.strictEqual(
      customLabelService.getName(URI.file(".file")),
