...
suite("Custom Editor Label Service", () => {
  ...
  __name(createCustomLabelService, "createCustomLabelService");
  async function updatePattern(configService, value) {
    ...
    configService.onDidChangeConfigurationEmitter.fire({
      affectsConfiguration: /* @__PURE__ */ __name((key) => key === CustomEditorLabelService.SETTING_ID_PATTERNS, "affectsConfiguration"),
  ...
  test("Custom Labels: extname(N)", async () => {
    ...
    __name(assertExtname, "assertExtname");
...
//# sourceMappingURL=customEditorLabelService.test.js.map
