...
suite("EditorService", () => {
  ...
  __name(createTestFileEditorInput, "createTestFileEditorInput");
  ...
  __name(testOpenBasics, "testOpenBasics");
  ...
  test("openEditor() - locked groups", async () => {
    ...
    disposables.add(accessor.editorResolverService.registerEditor(
      ...
      {},
      {
        createEditorInput: /* @__PURE__ */ __name((editor) => ({ editor: createTestFileEditorInput(editor.resource, TEST_EDITOR_INPUT_ID) }), "createEditorInput")
      }
    ));
  ...
  async function testOpenEditors(useOpenEditors) {
    ...
    __name(resetTestState, "resetTestState");
  ...
  __name(testOpenEditors, "testOpenEditors");
  ...
  test("active editor change / visible editor change events", async function() {
    ...
    __name(assertActiveEditorChangedEvent, "assertActiveEditorChangedEvent");
    ...
    __name(assertVisibleEditorsChangedEvent, "assertVisibleEditorsChangedEvent");
    async function closeEditorAndWaitForNextToOpen(group2, input2) {
      await group2.closeEditor(input2);
      await timeout(0);
    }
    __name(closeEditorAndWaitForNextToOpen, "closeEditorAndWaitForNextToOpen");
  ...
  test("editors change event", async function() {
    ...
    __name(assertEditorsChangeEvent, "assertEditorsChangeEvent");
  ...
  __name(testSaveRevertUntitled, "testSaveRevertUntitled");
  ...
  __name(testFileDeleteEditorClose, "testFileDeleteEditorClose");
  ...
  __name(awaitActiveEditorChange, "awaitActiveEditorChange");
  ...
  test("activeEditorPane scopedContextKeyService", async function() {
    const instantiationService = workbenchInstantiationService({ contextKeyService: /* @__PURE__ */ __name((instantiationService2) => instantiationService2.createInstance(MockScopableContextKeyService), "contextKeyService") }, disposables);
  ...
  test("editorResolverService - openEditor", async function() {
    ...
    const registrationDisposable = editorResolverService.registerEditor(
      ...
      {},
      {
        createEditorInput: /* @__PURE__ */ __name((editorInput) => {
          editorCount++;
          return { editor: textEditorService.createTextEditor(editorInput) };
        }, "createEditorInput"),
        createDiffEditorInput: /* @__PURE__ */ __name((diffEditor) => ({ editor: textEditorService.createTextEditor(diffEditor) }), "createDiffEditorInput")
      }
    );
