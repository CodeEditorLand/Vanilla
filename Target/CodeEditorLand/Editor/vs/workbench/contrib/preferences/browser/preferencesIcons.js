...
const keybindingsRecordKeysIcon = registerIcon(
...
const keybindingsSortIcon = registerIcon(
  "keybindings-sort",
...
const keybindingsEditIcon = registerIcon(
  "keybindings-edit",
  Codicon.edit,
  localize(
    "keybindingsEditIcon",
...
const keybindingsAddIcon = registerIcon(
  "keybindings-add",
  Codicon.add,
  localize(
    "keybindingsAddIcon",
...
const settingsEditIcon = registerIcon(
  "settings-edit",
  Codicon.edit,
  localize(
    "settingsEditIcon",
...
const settingsRemoveIcon = registerIcon(
  "settings-remove",
  Codicon.close,
  localize(
    "settingsRemoveIcon",
...
const settingsDiscardIcon = registerIcon(
  "settings-discard",
  Codicon.discard,
  localize(
...
const preferencesClearInputIcon = registerIcon(
...
const preferencesFilterIcon = registerIcon(
  "preferences-filter",
  Codicon.filter,
  localize(
    "settingsFilter",
...
const preferencesOpenSettingsIcon = registerIcon(
  "preferences-open-settings",
  Codicon.goToFile,
  localize("preferencesOpenSettings", "Icon for open settings commands.")
);
export {
  keybindingsAddIcon,
  keybindingsEditIcon,
