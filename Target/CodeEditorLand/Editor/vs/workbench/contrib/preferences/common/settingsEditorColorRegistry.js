...
const settingsHeaderForeground = registerColor(
...
const settingsHeaderHoverForeground = registerColor(
...
const modifiedItemIndicator = registerColor(
...
const settingsHeaderBorder = registerColor(
...
const settingsSashBorder = registerColor(
  "settings.sashBorder",
  PANEL_BORDER,
  localize(
    "settingsSashBorder",
...
const settingsSelectBackground = registerColor(
...
const settingsSelectForeground = registerColor(
...
const settingsSelectBorder = registerColor(
  "settings.dropdownBorder",
  selectBorder,
  localize("settingsDropdownBorder", "Settings editor dropdown border.")
);
const settingsSelectListBorder = registerColor(
...
const settingsCheckboxBackground = registerColor(
...
const settingsCheckboxBorder = registerColor(
  "settings.checkboxBorder",
  checkboxBorder,
  localize("settingsCheckboxBorder", "Settings editor checkbox border.")
);
const settingsTextInputBackground = registerColor(
...
const settingsTextInputForeground = registerColor(
...
const settingsTextInputBorder = registerColor(
  "settings.textInputBorder",
  inputBorder,
  localize("textInputBoxBorder", "Settings editor text input box border.")
);
const settingsNumberInputBackground = registerColor(
...
const settingsNumberInputForeground = registerColor(
...
const settingsNumberInputBorder = registerColor(
...
const focusedRowBackground = registerColor(
...
const rowHoverBackground = registerColor(
...
const focusedRowBorder = registerColor(
