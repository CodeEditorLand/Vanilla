      ...
      this.workspaceTrustRequestService.onDidInitiateOpenFilesTrustRequest(
        async () => {
          ...
          await this.dialogService.prompt({
            ...
            buttons: [
              {
                ...
                run: ({ checkboxChecked }) => this.workspaceTrustRequestService.completeOpenFilesTrustRequest(
            ...
            cancelButton: {
              run: () => this.workspaceTrustRequestService.completeOpenFilesTrustRequest(
