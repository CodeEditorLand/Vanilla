...
suite("MarkersModel Test", () => {
  ...
  __name(compareResource, "compareResource");
  ...
  __name(anErrorWithRange, "anErrorWithRange");
  ...
  __name(aWarningWithRange, "aWarningWithRange");
  ...
  __name(anInfoWithRange, "anInfoWithRange");
  ...
  __name(anIgnoreWithRange, "anIgnoreWithRange");
