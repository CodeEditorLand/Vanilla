...
class Messages {
  ...
  static MARKERS_PANEL_NO_PROBLEMS_BUILT = nls.localize(
    "markers.panel.no.problems.build",
    "No problems have been detected in the workspace."
  );
  static MARKERS_PANEL_NO_PROBLEMS_ACTIVE_FILE_BUILT = nls.localize(
    "markers.panel.no.problems.activeFile.build",
    "No problems have been detected in the current file."
  );
  static MARKERS_PANEL_NO_PROBLEMS_FILTERS = nls.localize(
  ...
  static MARKERS_PANEL_FILTER_LABEL_SHOW_ERRORS = nls.localize(
  ...
  static MARKERS_PANEL_FILTER_LABEL_SHOW_INFOS = nls.localize(
    "markers.panel.filter.showInfos",
    "Show Infos"
  );
  static MARKERS_PANEL_FILTER_LABEL_EXCLUDED_FILES = nls.localize(
    "markers.panel.filter.useFilesExclude",
    "Hide Excluded Files"
  );
  static MARKERS_PANEL_FILTER_LABEL_ACTIVE_FILE = nls.localize(
    "markers.panel.filter.activeFile",
    "Show Active File Only"
  );
  static MARKERS_PANEL_ACTION_TOOLTIP_FILTER = nls.localize(
    "markers.panel.action.filter",
    "Filter Problems"
  );
  static MARKERS_PANEL_ACTION_TOOLTIP_QUICKFIX = nls.localize(
    "markers.panel.action.quickfix",
    "Show fixes"
  );
  static MARKERS_PANEL_FILTER_ARIA_LABEL = nls.localize(
    "markers.panel.filter.ariaLabel",
    "Filter Problems"
  );
  static MARKERS_PANEL_FILTER_PLACEHOLDER = nls.localize(
    "markers.panel.filter.placeholder",
    "Filter (e.g. text, **/*.ts, !**/node_modules/**)"
  );
  static MARKERS_PANEL_FILTER_ERRORS = nls.localize(
    "markers.panel.filter.errors",
    "errors"
  );
  static MARKERS_PANEL_FILTER_WARNINGS = nls.localize(
    "markers.panel.filter.warnings",
    "warnings"
  );
  static MARKERS_PANEL_FILTER_INFOS = nls.localize(
    "markers.panel.filter.infos",
    "infos"
  );
  static MARKERS_PANEL_SINGLE_ERROR_LABEL = nls.localize(
    "markers.panel.single.error.label",
    "1 Error"
  );
  static MARKERS_PANEL_MULTIPLE_ERRORS_LABEL = (noOfErrors) => {
    return nls.localize(
  ...
  static MARKERS_PANEL_SINGLE_WARNING_LABEL = nls.localize(
    "markers.panel.single.warning.label",
    "1 Warning"
  );
  static MARKERS_PANEL_MULTIPLE_WARNINGS_LABEL = (noOfWarnings) => {
    return nls.localize(
  ...
  static MARKERS_PANEL_SINGLE_INFO_LABEL = nls.localize(
    "markers.panel.single.info.label",
    "1 Info"
  );
  static MARKERS_PANEL_MULTIPLE_INFOS_LABEL = (noOfInfos) => {
    return nls.localize(
  ...
  static MARKERS_PANEL_SINGLE_UNKNOWN_LABEL = nls.localize(
    "markers.panel.single.unknown.label",
    "1 Unknown"
  );
  static MARKERS_PANEL_MULTIPLE_UNKNOWNS_LABEL = (noOfUnknowns) => {
    return nls.localize(
  ...
  static MARKERS_PANEL_AT_LINE_COL_NUMBER = (ln, col) => {
    return nls.localize(
  ...
  static MARKERS_TREE_ARIA_LABEL_RESOURCE = (noOfProblems, fileName, folder) => {
    return nls.localize(
  ...
  static MARKERS_TREE_ARIA_LABEL_RELATED_INFORMATION = (relatedInformation) => nls.localize(
  ...
  static SHOW_ERRORS_WARNINGS_ACTION_LABEL = nls.localize(
