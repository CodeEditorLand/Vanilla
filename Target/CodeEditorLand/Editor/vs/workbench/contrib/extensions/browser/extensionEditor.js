...
let ExtensionEditor = class extends EditorPane {
          ...
          onClick(
            ...
            () => {
              this.paneCompositeService.openPaneComposite(
                ...
                (viewlet) => viewlet.search(`@category:"${category}"`)
              );
            }
          )
        );
  ...
  async openFeatures(template, token) {
    ...
    const layout = () => extensionFeaturesTab.layout(
...
ExtensionEditor = __decorateClass([
  ...
  __decorateParam(12, IWebviewService),
  ...
  __decorateParam(20, IHoverService)
], ExtensionEditor);
