  ...
  render() {
    ...
    if (this.small) {
      ...
      if (this.extension.ratingCount) {
        const ratingCountElemet = append(this.container, $("span", void 0, ` (${this.extension.ratingCount})`));
...
let ExtensionStatusWidget = class extends ExtensionWidget {
  ...
  renderDisposables = this._register(new MutableDisposable());
...
const extensionRatingIconColor = registerColor("extensionIcon.starForeground", { light: "#DF6100", dark: "#FF8E00", hcDark: "#FF8E00", hcLight: textLinkForeground }, localize("extensionIconStarForeground", "The icon color for extension ratings."), true);
const extensionVerifiedPublisherIconColor = registerColor("extensionIcon.verifiedForeground", textLinkForeground, localize("extensionIconVerifiedForeground", "The icon color for extension verified publisher."), true);
const extensionPreReleaseIconColor = registerColor("extensionIcon.preReleaseForeground", { dark: "#1d9271", light: "#1d9271", hcDark: "#1d9271", hcLight: textLinkForeground }, localize("extensionPreReleaseForeground", "The icon color for pre-release extension."), true);
const extensionSponsorIconColor = registerColor("extensionIcon.sponsorForeground", { light: "#B51E78", dark: "#D758B3", hcDark: null, hcLight: "#B51E78" }, localize("extensionIcon.sponsorForeground", "The icon color for extension sponsor."), true);
