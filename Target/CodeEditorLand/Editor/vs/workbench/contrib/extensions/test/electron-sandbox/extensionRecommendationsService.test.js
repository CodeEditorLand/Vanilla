...
suite("ExtensionRecommendationsService Test", () => {
  ...
  setup(() => {
    ...
    class TestNotificationService2 extends TestNotificationService {
      static {
        __name(this, "TestNotificationService2");
      }
  ...
  __name(setUpFolderWorkspace, "setUpFolderWorkspace");
  ...
  __name(setUpFolder, "setUpFolder");
  ...
  __name(testNoPromptForValidRecommendations, "testNoPromptForValidRecommendations");
  ...
  __name(testNoPromptOrRecommendationsForValidRecommendations, "testNoPromptOrRecommendationsForValidRecommendations");
  test("ExtensionRecommendationsService: No Prompt for valid workspace recommendations when galleryService is absent", () => runWithFakedTimers({ useFakeTimers: true }, async () => {
    ...
    instantiationService.stub(IExtensionGalleryService, { query: galleryQuerySpy, isEnabled: /* @__PURE__ */ __name(() => false, "isEnabled") });
