...
function setupTest(disposables) {
  ...
  didInstallEvent = disposables.add(
    new Emitter()
  );
  uninstallEvent = disposables.add(new Emitter());
  didUninstallEvent = disposables.add(
    new Emitter()
  );
  ...
  instantiationService.stub(
    IFileService,
    disposables.add(new FileService(new NullLogService()))
  );
  instantiationService.stub(
  ...
  instantiationService.stub(ILabelService, {
    onDidChangeFormatters: disposables.add(
      new Emitter()
    ).event
  });
  instantiationService.stub(
  ...
  instantiationService.stub(
    ...
    disposables.add(
      instantiationService.createInstance(UserDataSyncEnablementService)
    )
  );
...
suite("ExtensionsActions", () => {
  ...
  test("Install action is disabled when there is no extension", () => {
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.InstallAction,
  ...
  test("Test Install action when state is installed", () => {
    ...
    disposables.add(
      instantiationService.createInstance(ExtensionContainers, [
        testObject
      ])
    );
    ...
    return workbenchService.queryLocal().then(() => {
      instantiationService.stubPromise(
        IExtensionGalleryService,
        "query",
        aPage(aGalleryExtension("a", { identifier: local.identifier }))
      );
      return workbenchService.queryGallery(CancellationToken.None).then((paged) => {
        ...
        assert.strictEqual(
          "extension-action label prominent install hide",
          testObject.class
        );
      });
    });
  ...
  test("Test InstallingLabelAction when state is installing", () => {
    ...
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.InstallingLabelAction
      )
    );
    disposables.add(
      instantiationService.createInstance(ExtensionContainers, [
    ...
    return workbenchService.queryGallery(CancellationToken.None).then((paged) => {
      ...
      assert.strictEqual(
        "extension-action label install installing",
        testObject.class
      );
    });
  });
  test("Test Install action when state is uninstalled", async () => {
    ...
    const paged = await workbenchService.queryGallery(
      CancellationToken.None
    );
    const promise = Event.toPromise(
      Event.filter(testObject.onDidChange, (e) => e.enabled === true)
    );
    testObject.extension = paged.firstPage[0];
    await promise;
    assert.ok(testObject.enabled);
  ...
  test("Uninstall action is disabled when there is no extension", () => {
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.UninstallAction
      )
    );
    disposables.add(
      instantiationService.createInstance(ExtensionContainers, [
  ...
  test("Test Uninstall action when state is uninstalling", () => {
    ...
    return instantiationService.get(IExtensionsWorkbenchService).queryLocal().then((extensions) => {
      ...
      assert.strictEqual(
        "extension-action label uninstall uninstalling",
        testObject.class
      );
    });
  });
  ...
  test("Test UpdateAction when there is no extension", () => {
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.UpdateAction,
        false
      )
    );
    disposables.add(
  ...
  test("Test ManageExtensionAction when there is no extension", () => {
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.ManageExtensionAction
      )
    );
    disposables.add(
      instantiationService.createInstance(ExtensionContainers, [
  ...
  test("Test ManageExtensionAction when extension is installed", () => {
    ...
    return instantiationService.get(IExtensionsWorkbenchService).queryLocal().then((extensions) => {
      ...
      assert.ok(testObject.enabled);
      assert.strictEqual(
        "extension-action icon manage codicon codicon-extensions-manage",
        testObject.class
      );
  ...
  test("Test ManageExtensionAction when extension is uninstalled", () => {
    ...
    return instantiationService.get(IExtensionsWorkbenchService).queryGallery(CancellationToken.None).then((page) => {
      ...
      assert.ok(!testObject.enabled);
      assert.strictEqual(
        "extension-action icon manage codicon codicon-extensions-manage hide",
        testObject.class
      );
      assert.strictEqual("Manage", testObject.tooltip);
    });
  ...
  test("Test EnableForWorkspaceAction when there is no extension", () => {
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.EnableForWorkspaceAction
      )
    );
    assert.ok(!testObject.enabled);
  });
  ...
  test("Test EnableForWorkspaceAction when the extension is disabled globally and workspace", () => {
    const local = aLocalExtension("a");
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([local], EnablementState.DisabledGlobally).then(
      () => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([local], EnablementState.DisabledWorkspace)
    ).then(() => {
      instantiationService.stubPromise(
        IExtensionManagementService,
        "getInstalled",
  ...
  test("Test EnableGloballyAction when there is no extension", () => {
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.EnableGloballyAction
      )
    );
    assert.ok(!testObject.enabled);
  });
  ...
  test("Test EnableAction when there is no extension", () => {
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.EnableDropDownAction
      )
    );
    assert.ok(!testObject.enabled);
  });
  ...
  test("Test DisableForWorkspaceAction when there is no extension", () => {
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.DisableForWorkspaceAction
      )
    );
    assert.ok(!testObject.enabled);
  });
  ...
  test("Test DisableGloballyAction when there is no extension", () => {
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.DisableGloballyAction
      )
    );
    assert.ok(!testObject.enabled);
  });
...
suite("ExtensionRuntimeStateAction", () => {
  ...
  test("Test Runtime State when there is no extension", () => {
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.ExtensionRuntimeStateAction
      )
    );
    disposables.add(
      instantiationService.createInstance(ExtensionContainers, [
  ...
  test("Test Runtime State when extension is newly installed", async () => {
    ...
    assert.strictEqual(
      testObject.tooltip,
      `Please restart extensions to enable this extension.`
    );
  });
  ...
  test("Test Runtime State when extension is uninstalled", async () => {
    instantiationService.stub(IExtensionService, {
      extensions: [
        toExtensionDescription(
          aLocalExtension("a", { version: "1.0.0" })
        )
      ],
      onDidChangeExtensions: Event.None,
      canRemoveExtension: (extension) => false,
    ...
    assert.strictEqual(
      testObject.tooltip,
      `Please restart extensions to complete the uninstallation of this extension.`
    );
  });
  ...
  test("Test Runtime State when extension is updated while running", async () => {
    instantiationService.stub(IExtensionService, {
      extensions: [
        toExtensionDescription(
          aLocalExtension("a", { version: "1.0.1" })
        )
      ],
      onDidChangeExtensions: Event.None,
      canRemoveExtension: (extension) => true,
  ...
  test("Test Runtime State when extension is disabled when running", async () => {
    ...
    const extensions = await workbenchService.queryLocal();
    testObject.extension = extensions[0];
    await workbenchService.setEnablement(
      extensions[0],
    ...
    assert.ok(testObject.enabled);
    assert.strictEqual(
      `Please restart extensions to disable this extension.`,
      testObject.tooltip
    );
  });
  ...
  test("Test Runtime State when extension is not installed but extension from different server is installed and running", async () => {
    const gallery = aGalleryExtension("a");
    const localExtension = aLocalExtension(
      "a",
      { extensionKind: ["workspace"] },
      { location: URI.file("pub.a") }
    );
    const remoteExtension = aLocalExtension(
      "a",
      { extensionKind: ["workspace"] },
      {
    ...
    const extensionManagementServerService = aMultiExtensionManagementServerService(
      instantiationService,
      createExtensionManagementService([localExtension]),
      createExtensionManagementService([remoteExtension])
    );
    instantiationService.stub(
      IExtensionManagementServerService,
    ...
    const workbenchService = disposables.add(
      instantiationService.createInstance(ExtensionsWorkbenchService)
    );
  ...
  test("Test Runtime State when workspace extension is disabled on local server and installed in remote server", async () => {
    ...
    assert.strictEqual(
      testObject.tooltip,
      `Please reload window to enable this extension.`
    );
  });
  test("Test Runtime State when ui extension is disabled on remote server and installed in local server", async () => {
    ...
    const promise = Event.toPromise(
      Event.filter(testObject.onDidChange, () => testObject.enabled)
    );
    onDidInstallEvent.fire([
      {
        identifier: localExtension.identifier,
  ...
  test("Test Runtime State when ui+workspace+web extension is installed in web and remote and running in remote", async () => {
    const gallery = aGalleryExtension("a");
    const webExtension = aLocalExtension(
      "a",
      { extensionKind: ["ui", "workspace"], browser: "browser.js" },
      {
        location: URI.file("pub.a").with({
    ...
    const extensionManagementServerService = aMultiExtensionManagementServerService(
      ...
      null,
      createExtensionManagementService([remoteExtension]),
      createExtensionManagementService([webExtension])
    );
    instantiationService.stub(
      IExtensionManagementServerService,
      extensionManagementServerService
  ...
  test("Test Runtime State when workspace+ui+web extension is installed in web and local and running in local", async () => {
    ...
    const webExtension = aLocalExtension(
      "a",
      { extensionKind: ["workspace", "ui"], browser: "browser.js" },
      {
        location: URI.file("pub.a").with({
          scheme: Schemas.vscodeUserData
        })
...
suite("RemoteInstallAction", () => {
  ...
  test("Test remote install action is enabled for local workspace extension", async () => {
    const localWorkspaceExtension = aLocalExtension(
      "a",
      { extensionKind: ["workspace"] },
      { location: URI.file(`pub.a`) }
    );
    const extensionManagementServerService = aMultiExtensionManagementServerService(
      instantiationService,
      createExtensionManagementService([localWorkspaceExtension])
    );
    instantiationService.stub(
      IExtensionManagementServerService,
      extensionManagementServerService
    ...
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.RemoteInstallAction,
        false
      )
    );
    disposables.add(
    ...
    assert.strictEqual(
      "extension-action label prominent install-other-server",
      testObject.class
    );
  });
  test("Test remote install action when installing local workspace extension", async () => {
    ...
    assert.strictEqual("Installing", testObject.label);
    assert.strictEqual(
      "extension-action label install-other-server installing",
      testObject.class
    );
  });
  test("Test remote install action when installing local workspace extension is finished", async () => {
    ...
    const installedExtension = aLocalExtension(
      "a",
      { extensionKind: ["workspace"] },
      {
        location: URI.file(`pub.a`).with({
  ...
  test("Test remote install action is enabled for disabled local workspace extension", async () => {
    ...
    instantiationService.set(IExtensionsWorkbenchService, workbenchService);
    const remoteWorkspaceExtension = aLocalExtension(
      "a",
      { extensionKind: ["workspace"] },
      {
        location: URI.file(`pub.a`).with({
  ...
  test("Test remote install action is disabled for extension which is not installed", async () => {
    ...
    const pager = await workbenchService.queryGallery(
      CancellationToken.None
    );
  ...
  test("Test remote install action is disabled when remote server is not available", async () => {
    ...
    const extensionManagementServerService = instantiationService.get(
      IExtensionManagementServerService
    );
    const localWorkspaceExtension = aLocalExtension(
      "a",
  ...
  test("Test remote install action is disabled for local workspace extension if it is uninstalled locally", async () => {
    const extensionManagementService = instantiationService.get(
      IExtensionManagementService
    );
    const extensionManagementServerService = aMultiExtensionManagementServerService(
      instantiationService,
  ...
  test("Test remote install action is disabled for local workspace extension if it is installed in remote", async () => {
    ...
    const extensionManagementServerService = aMultiExtensionManagementServerService(
      instantiationService,
      createExtensionManagementService([localWorkspaceExtension]),
      createExtensionManagementService([remoteWorkspaceExtension])
    );
    instantiationService.stub(
      IExtensionManagementServerService,
      extensionManagementServerService
  ...
  test("Test remote install action is disabled for local workspace system extension", async () => {
    const localWorkspaceSystemExtension = aLocalExtension(
      "a",
      { extensionKind: ["workspace"] },
      { location: URI.file(`pub.a`), type: ExtensionType.System }
    );
    const extensionManagementServerService = aMultiExtensionManagementServerService(
      instantiationService,
      createExtensionManagementService([
        localWorkspaceSystemExtension
      ])
    );
    instantiationService.stub(
      IExtensionManagementServerService,
    ...
    instantiationService.stubPromise(
      ...
      aPage(
        aGalleryExtension("a", {
          identifier: localWorkspaceSystemExtension.identifier
        })
      )
    );
    const testObject = disposables.add(
  ...
  test("Test remote install action is disabled for local ui extension if it is not installed in remote", async () => {
    const localUIExtension = aLocalExtension(
      "a",
      { extensionKind: ["ui"] },
      { location: URI.file(`pub.a`) }
    );
    const extensionManagementServerService = aMultiExtensionManagementServerService(
      instantiationService,
      createExtensionManagementService([localUIExtension])
    );
    instantiationService.stub(
      IExtensionManagementServerService,
      extensionManagementServerService
    ...
    instantiationService.stubPromise(
      ...
      aPage(
        aGalleryExtension("a", {
          identifier: localUIExtension.identifier
        })
      )
    );
    const testObject = disposables.add(
  ...
  test("Test remote install action is disabled for local ui extension if it is also installed in remote", async () => {
    ...
    const remoteUIExtension = aLocalExtension(
      "a",
      { extensionKind: ["ui"] },
      {
        location: URI.file(`pub.a`).with({
    ...
    const extensionManagementServerService = aMultiExtensionManagementServerService(
      instantiationService,
      createExtensionManagementService([localUIExtension]),
      createExtensionManagementService([remoteUIExtension])
    );
    instantiationService.stub(
      IExtensionManagementServerService,
      extensionManagementServerService
  ...
  test("Test remote install action is enabled for locally installed language pack extension", async () => {
    const languagePackExtension = aLocalExtension(
      "a",
      {
        contributes: {
          localizations: [{ languageId: "de", translations: [] }]
    ...
    const extensionManagementServerService = aMultiExtensionManagementServerService(
      instantiationService,
      createExtensionManagementService([languagePackExtension])
    );
    instantiationService.stub(
      IExtensionManagementServerService,
      extensionManagementServerService
    ...
    instantiationService.stubPromise(
      ...
      aPage(
        aGalleryExtension("a", {
          identifier: languagePackExtension.identifier
        })
      )
    );
    const testObject = disposables.add(
...
suite("LocalInstallAction", () => {
  ...
  test("Test local install action is enabled for remote ui extension", async () => {
    ...
    const testObject = disposables.add(
      instantiationService.createInstance(
        ExtensionsActions.LocalInstallAction
      )
    );
    disposables.add(
      instantiationService.createInstance(ExtensionContainers, [
  ...
  test("Test local install action is disabled when local server is not available", async () => {
    ...
    const extensionManagementServerService = aSingleRemoteExtensionManagementServerService(
      instantiationService,
      createExtensionManagementService([remoteUIExtension])
    );
    instantiationService.stub(
  ...
  test("Test local install action is disabled for remote UI system extension", async () => {
    const remoteUISystemExtension = aLocalExtension(
      "a",
      { extensionKind: ["ui"] },
      {
        location: URI.file(`pub.a`).with({
    ...
    const extensionManagementServerService = aMultiExtensionManagementServerService(
      instantiationService,
      createExtensionManagementService(),
      createExtensionManagementService([remoteUISystemExtension])
    );
    instantiationService.stub(
      IExtensionManagementServerService,
      extensionManagementServerService
    ...
    instantiationService.stubPromise(
      ...
      aPage(
        aGalleryExtension("a", {
          identifier: remoteUISystemExtension.identifier
        })
      )
    );
    const testObject = disposables.add(
  ...
  test("Test local install action is disabled for remote workspace extension if it is not installed in local", async () => {
    ...
    instantiationService.stubPromise(
      ...
      aPage(
        aGalleryExtension("a", {
          identifier: remoteWorkspaceExtension.identifier
        })
      )
    );
    const testObject = disposables.add(
