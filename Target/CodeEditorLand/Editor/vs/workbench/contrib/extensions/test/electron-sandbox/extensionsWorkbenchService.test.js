...
suite("ExtensionsWorkbenchServiceTest", () => {
  ...
  setup(async () => {
    ...
    instantiationService.stub(IWorkbenchExtensionManagementService, {
      ...
      getTargetPlatform: /* @__PURE__ */ __name(async () => getTargetPlatform(platform, arch), "getTargetPlatform"),
    ...
    instantiationService.stub(INotificationService, { prompt: /* @__PURE__ */ __name(() => null, "prompt") });
  ...
  test("test gallery extension", async () => {
    ...
    return testObject.queryGallery(CancellationToken.None).then((pagedResponse) => {
      ...
      assert.strictEqual(1e3, actual.installCount);
  ...
  test("test for installed extensions", async () => {
    ...
    assert.strictEqual(void 0, actual.licenseUrl);
    assert.strictEqual(ExtensionState.Installed, actual.state);
    assert.strictEqual(void 0, actual.installCount);
    assert.strictEqual(void 0, actual.rating);
    assert.strictEqual(void 0, actual.ratingCount);
    assert.strictEqual(false, actual.outdated);
    assert.deepStrictEqual(["pub.1", "pub.2"], actual.dependencies);
    actual = actuals[1];
  ...
  test("test uninstalled extensions are always enabled", async () => {
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("b")], EnablementState.DisabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("c")], EnablementState.DisabledWorkspace)).then(async () => {
      testObject = await aWorkbenchService();
  ...
  test("test workspace disabled extension", async () => {
    ...
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("b")], EnablementState.DisabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("d")], EnablementState.DisabledGlobally)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionA], EnablementState.DisabledWorkspace)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("e")], EnablementState.DisabledWorkspace)).then(async () => {
  ...
  test("test globally disabled extension", async () => {
    ...
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([localExtension], EnablementState.DisabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("d")], EnablementState.DisabledGlobally)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("c")], EnablementState.DisabledWorkspace)).then(async () => {
  ...
  test("test enablement state is updated for user extensions", async () => {
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("c")], EnablementState.DisabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("b")], EnablementState.DisabledWorkspace)).then(async () => {
      instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [aLocalExtension("a")]);
      testObject = await aWorkbenchService();
      return testObject.setEnablement(testObject.local[0], EnablementState.DisabledWorkspace).then(() => {
        const actual = testObject.local[0];
        assert.strictEqual(actual.enablementState, EnablementState.DisabledWorkspace);
      });
    });
  ...
  test("test enable extension globally when extension is disabled for workspace", async () => {
    const localExtension = aLocalExtension("a");
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([localExtension], EnablementState.DisabledWorkspace).then(async () => {
      instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [localExtension]);
      testObject = await aWorkbenchService();
      return testObject.setEnablement(testObject.local[0], EnablementState.EnabledGlobally).then(() => {
        const actual = testObject.local[0];
        assert.strictEqual(actual.enablementState, EnablementState.EnabledGlobally);
      });
    });
  ...
  test("test disable extension globally", async () => {
    instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [aLocalExtension("a")]);
    testObject = await aWorkbenchService();
    return testObject.setEnablement(testObject.local[0], EnablementState.DisabledGlobally).then(() => {
      const actual = testObject.local[0];
      assert.strictEqual(actual.enablementState, EnablementState.DisabledGlobally);
    });
  });
  ...
  test("test enablement state is updated on change from outside", async () => {
    ...
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("c")], EnablementState.DisabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("b")], EnablementState.DisabledWorkspace)).then(async () => {
      instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [localExtension]);
      testObject = await aWorkbenchService();
      return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([localExtension], EnablementState.DisabledGlobally).then(() => {
        const actual = testObject.local[0];
        assert.strictEqual(actual.enablementState, EnablementState.DisabledGlobally);
      });
    });
  ...
  test("test disable extension with dependencies disable only itself", async () => {
    ...
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionA], EnablementState.EnabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionB], EnablementState.EnabledGlobally)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionC], EnablementState.EnabledGlobally)).then(async () => {
  ...
  test("test disable extension when extension is part of a pack", async () => {
    ...
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionA], EnablementState.EnabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionB], EnablementState.EnabledGlobally)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionC], EnablementState.EnabledGlobally)).then(async () => {
      instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [extensionA, extensionB, extensionC]);
      testObject = await aWorkbenchService();
      return testObject.setEnablement(testObject.local[1], EnablementState.DisabledGlobally).then(() => {
        assert.strictEqual(testObject.local[1].enablementState, EnablementState.DisabledGlobally);
      });
    });
  });
  test("test disable both dependency and dependent do not promot and do not fail", async () => {
    ...
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionA], EnablementState.EnabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionB], EnablementState.EnabledGlobally)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionC], EnablementState.EnabledGlobally)).then(async () => {
      ...
      const target = sinon.spy();
      testObject = await aWorkbenchService();
      return testObject.setEnablement([testObject.local[1], testObject.local[0]], EnablementState.DisabledGlobally).then(() => {
  ...
  test("test enable both dependency and dependent do not promot and do not fail", async () => {
    ...
    const extensionB = aLocalExtension("b");
    const extensionC = aLocalExtension("c");
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionA], EnablementState.DisabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionB], EnablementState.DisabledGlobally)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionC], EnablementState.DisabledGlobally)).then(async () => {
      instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [extensionA, extensionB, extensionC]);
      const target = sinon.spy();
      testObject = await aWorkbenchService();
      return testObject.setEnablement([testObject.local[1], testObject.local[0]], EnablementState.EnabledGlobally).then(() => {
        assert.ok(!target.called);
  ...
  test("test disable extension if its dependency is a dependent of other disabled extension", async () => {
    ...
    const extensionB = aLocalExtension("b");
    const extensionC = aLocalExtension("c", { extensionDependencies: ["pub.b"] });
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionA], EnablementState.EnabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionB], EnablementState.EnabledGlobally)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionC], EnablementState.DisabledGlobally)).then(async () => {
      instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [extensionA, extensionB, extensionC]);
      testObject = await aWorkbenchService();
      return testObject.setEnablement(testObject.local[0], EnablementState.DisabledGlobally).then(() => {
        assert.strictEqual(testObject.local[0].enablementState, EnablementState.DisabledGlobally);
  ...
  test("test disable extension if its dependencys dependency is itself", async () => {
    ...
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionA], EnablementState.EnabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionB], EnablementState.EnabledGlobally)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionC], EnablementState.EnabledGlobally)).then(async () => {
      instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [extensionA, extensionB, extensionC]);
      testObject = await aWorkbenchService();
      return testObject.setEnablement(testObject.local[0], EnablementState.DisabledGlobally).then(() => assert.fail("An extension with dependent should not be disabled"), () => null);
    });
  });
  test("test disable extension if its dependency is dependent and is disabled", async () => {
    ...
    const extensionB = aLocalExtension("b");
    const extensionC = aLocalExtension("c", { extensionDependencies: ["pub.b"] });
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionA], EnablementState.EnabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionB], EnablementState.DisabledGlobally)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionC], EnablementState.EnabledGlobally)).then(async () => {
      instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [extensionA, extensionB, extensionC]);
      testObject = await aWorkbenchService();
      return testObject.setEnablement(testObject.local[0], EnablementState.DisabledGlobally).then(() => assert.strictEqual(testObject.local[0].enablementState, EnablementState.DisabledGlobally));
    });
  });
  ...
  test("test enable extension with dependencies does not prompt if dependency is enabled already", async () => {
    ...
    const extensionB = aLocalExtension("b");
    const extensionC = aLocalExtension("c");
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionA], EnablementState.DisabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionB], EnablementState.EnabledGlobally)).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([extensionC], EnablementState.DisabledGlobally)).then(async () => {
      instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [extensionA, extensionB, extensionC]);
      const target = sinon.spy();
      testObject = await aWorkbenchService();
      return testObject.setEnablement(testObject.local[0], EnablementState.EnabledGlobally).then(() => {
  ...
  test("test change event is fired when disablement flags are changed", async () => {
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("c")], EnablementState.DisabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("b")], EnablementState.DisabledWorkspace)).then(async () => {
      ...
      const target = sinon.spy();
      disposableStore.add(testObject.onChange(target));
      return testObject.setEnablement(testObject.local[0], EnablementState.DisabledGlobally).then(() => assert.ok(target.calledOnce));
    });
  });
  test("test change event is fired when disablement flags are changed from outside", async () => {
    ...
    return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("c")], EnablementState.DisabledGlobally).then(() => instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([aLocalExtension("b")], EnablementState.DisabledWorkspace)).then(async () => {
      ...
      const target = sinon.spy();
      disposableStore.add(testObject.onChange(target));
      return instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([localExtension], EnablementState.DisabledGlobally).then(() => assert.ok(target.calledOnce));
    });
  });
  ...
  test("Test disable autoupdate for extension when auto update is enabled for all", async () => {
    ...
    testObject = await aWorkbenchService();
    assert.strictEqual(testObject.local[0].local?.pinned, void 0);
    assert.strictEqual(testObject.local[1].local?.pinned, void 0);
  ...
  test("Test enable autoupdate for pinned extension when auto update is enabled", async () => {
    const extension1 = aLocalExtension("a", void 0, { pinned: true });
    const extension2 = aLocalExtension("b");
    instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [extension1, extension2]);
    instantiationService.stub(IExtensionManagementService, "updateMetadata", (local, metadata) => {
      local.pinned = !!metadata.pinned;
  ...
  test("Test enable autoupdate for extension when auto update is disabled", async () => {
    stubConfiguration(false);
    const extension1 = aLocalExtension("a", void 0, { pinned: true });
    const extension2 = aLocalExtension("b", void 0, { pinned: true });
    instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [extension1, extension2]);
    instantiationService.stub(IExtensionManagementService, "updateMetadata", (local, metadata) => {
      local.pinned = !!metadata.pinned;
      return local;
  ...
  test("Test reset autoupdate extensions state when auto update is disabled", async () => {
    instantiationService.stub(IDialogService, {
      confirm: /* @__PURE__ */ __name(() => Promise.resolve({ confirmed: true }), "confirm")
    });
    const extension1 = aLocalExtension("a", void 0, { pinned: true });
    const extension2 = aLocalExtension("b", void 0, { pinned: true });
    instantiationService.stubPromise(IExtensionManagementService, "getInstalled", [extension1, extension2]);
  ...
  __name(aWorkbenchService, "aWorkbenchService");
  function stubConfiguration(autoUpdateValue, autoCheckUpdatesValue) {
    ...
    instantiationService.stub(IConfigurationService, {
      ...
      getValue: /* @__PURE__ */ __name((key) => {
        return key ? values[key] : void 0;
      }, "getValue"),
      updateValue: /* @__PURE__ */ __name(async (key, value) => {
        values[key] = value;
        emitter.fire({
  ...
  __name(stubConfiguration, "stubConfiguration");
  ...
  __name(aPage, "aPage");
  function aMultiExtensionManagementServerService(instantiationService2, localExtensionManagementService, remoteExtensionManagementService) {
