...
suite("ExtensionsViews Tests", () => {
  ...
  test("Test @recommended:workspace query", () => {
    ...
    const target = instantiationService.stubPromise(IExtensionGalleryService, "getExtensions", workspaceRecommendedExtensions);
  ...
  test("Test @recommended query", () => {
    ...
    const target = instantiationService.stubPromise(IExtensionGalleryService, "getExtensions", allRecommendedExtensions);
  ...
  test("Test search", () => {
    ...
    const queryTarget = instantiationService.stubPromise(IExtensionGalleryService, "query", aPage(...results));
  ...
  test("Test preferred search experiment", () => {
    ...
    const queryTarget = instantiationService.stubPromise(IExtensionGalleryService, "query", aPage(...actual));
    const experimentTarget = instantiationService.stubPromise(IWorkbenchExtensionManagementService, "getExtensionsControlManifest", {
      malicious: [],
      deprecated: {},
      search: [{
        query: "search-me",
  ...
  test("Skip preferred search experiment when user defines sort order", () => {
    ...
    const queryTarget = instantiationService.stubPromise(IExtensionGalleryService, "query", aPage(...realResults));
