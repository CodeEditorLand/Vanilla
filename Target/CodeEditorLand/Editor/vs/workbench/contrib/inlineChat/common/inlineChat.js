...
Registry.as(
  ...
  properties: {
    ...
    ["inlineChat.acceptedOrDiscardBeforeSave" /* AcceptedOrDiscardBeforeSave */]: {
      description: localize(
...
const CTX_INLINE_CHAT_HAS_AGENT = new RawContextKey(
...
const CTX_INLINE_CHAT_EMPTY = new RawContextKey(
  "inlineChatEmpty",
  false,
  localize(
    "inlineChatEmpty",
...
const CTX_INLINE_CHAT_INNER_CURSOR_FIRST = new RawContextKey(
...
const CTX_INLINE_CHAT_INNER_CURSOR_LAST = new RawContextKey(
...
const CTX_INLINE_CHAT_INNER_CURSOR_START = new RawContextKey(
...
const CTX_INLINE_CHAT_INNER_CURSOR_END = new RawContextKey(
...
const CTX_INLINE_CHAT_OUTER_CURSOR_POSITION = new RawContextKey(
...
const CTX_INLINE_CHAT_HAS_STASHED_SESSION = new RawContextKey(
...
const CTX_INLINE_CHAT_USER_DID_EDIT = new RawContextKey(
...
const CTX_INLINE_CHAT_DOCUMENT_CHANGED = new RawContextKey(
...
const CTX_INLINE_CHAT_CHANGE_HAS_DIFF = new RawContextKey(
...
const CTX_INLINE_CHAT_CHANGE_SHOWS_DIFF = new RawContextKey(
...
const CTX_INLINE_CHAT_EDIT_MODE = new RawContextKey(
  "config.inlineChat.mode",
  "live" /* Live */
);
const CTX_INLINE_CHAT_REQUEST_IN_PROGRESS = new RawContextKey(
...
const CTX_INLINE_CHAT_RESPONSE_TYPE = new RawContextKey(
  "inlineChatResponseType",
  "none" /* None */,
  localize(
...
const MENU_INLINE_CHAT_WIDGET_STATUS = MenuId.for(
  "inlineChatWidget.status"
);
const MENU_INLINE_CHAT_WIDGET_SECONDARY = MenuId.for(
  "inlineChatWidget.secondary"
);
const MENU_INLINE_CHAT_ZONE = MenuId.for("inlineChatWidget.changesZone");
const inlineChatForeground = registerColor(
...
const inlineChatBackground = registerColor(
...
const inlineChatBorder = registerColor(
  "inlineChat.border",
  editorWidgetBorder,
  localize(
    "inlineChat.border",
...
const inlineChatShadow = registerColor(
  "inlineChat.shadow",
  widgetShadow,
  localize(
    "inlineChat.shadow",
...
const inlineChatInputBorder = registerColor(
...
const inlineChatInputFocusBorder = registerColor(
...
const inlineChatInputPlaceholderForeground = registerColor(
...
const inlineChatInputBackground = registerColor(
...
const inlineChatDiffInserted = registerColor(
...
const overviewRulerInlineChatDiffInserted = registerColor(
...
const minimapInlineChatDiffInserted = registerColor(
  "editorOverviewRuler.inlineChatInserted",
  {
    dark: transparent(diffInserted, 0.6),
    light: transparent(diffInserted, 0.8),
...
const inlineChatDiffRemoved = registerColor(
...
const overviewRulerInlineChatDiffRemoved = registerColor(
