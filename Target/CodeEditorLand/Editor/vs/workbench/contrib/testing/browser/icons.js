...
const testingCoverageAllIcon = registerIcon(
...
const testingShowAsList = registerIcon(
...
const testingShowAsTree = registerIcon(
  "testing-show-as-list-icon",
  Codicon.listFlat,
  localize(
    "testingShowAsTree",
...
const testingTurnContinuousRunOff = registerIcon(
...
const testingContinuousIsOn = registerIcon(
...
const testingCancelRefreshTests = registerIcon(
...
const testingCoverageReport = registerIcon(
  "testing-coverage",
  Codicon.coverage,
  localize("testingCoverage", "Icon representing test coverage")
);
const testingWasCovered = registerIcon(
  "testing-was-covered",
  Codicon.check,
  localize(
    "testingWasCovered",
...
const testingCoverageMissingBranch = registerIcon(
