...
const testingColorIconFailed = registerColor(
  "testing.iconFailed",
  {
    dark: "#f14c4c",
    light: "#f14c4c",
...
const testingColorIconErrored = registerColor(
  "testing.iconErrored",
  {
    dark: "#f14c4c",
    light: "#f14c4c",
...
const testingColorIconPassed = registerColor(
  "testing.iconPassed",
  {
    dark: "#73c991",
    light: "#73c991",
...
const testingColorRunAction = registerColor(
  "testing.runAction",
  testingColorIconPassed,
  localize("testing.runAction", "Color for 'run' icons in the editor.")
);
const testingColorIconQueued = registerColor(
  "testing.iconQueued",
  "#cca700",
  localize(
    "testing.iconQueued",
...
const testingColorIconUnset = registerColor(
  "testing.iconUnset",
  "#848484",
  localize(
    "testing.iconUnset",
...
const testingColorIconSkipped = registerColor(
  "testing.iconSkipped",
  "#848484",
  localize(
    "testing.iconSkipped",
...
const testingPeekBorder = registerColor(
  "testing.peekBorder",
  {
...
const testingMessagePeekBorder = registerColor(
...
const testingPeekHeaderBackground = registerColor(
...
const testingPeekMessageHeaderBackground = registerColor(
...
const testingCoveredBackground = registerColor(
...
const testingCoveredBorder = registerColor(
...
const testingCoveredGutterBackground = registerColor(
...
const testingUncoveredBranchBackground = registerColor(
...
const testingUncoveredBackground = registerColor(
...
const testingUncoveredBorder = registerColor(
...
const testingUncoveredGutterBackground = registerColor(
...
const testingCoverCountBadgeBackground = registerColor(
...
const testingCoverCountBadgeForeground = registerColor(
...
const testingRetiredColorIconErrored = registerColor(
...
const testingRetiredColorIconFailed = registerColor(
...
const testingRetiredColorIconPassed = registerColor(
...
const testingRetiredColorIconQueued = registerColor(
...
const testingRetiredColorIconUnset = registerColor(
...
const testingRetiredColorIconSkipped = registerColor(
