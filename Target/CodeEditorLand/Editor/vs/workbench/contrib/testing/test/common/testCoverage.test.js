...
suite("TestCoverage", () => {
  ...
  setup(() => {
    ...
    testCoverage = new TestCoverage({}, "taskId", { extUri: { ignorePathCasing: /* @__PURE__ */ __name(() => true, "ignorePathCasing") } }, coverageAccessor);
  });
  teardown(() => {
    sandbox.restore();
  });
...
//# sourceMappingURL=testCoverage.test.js.map
