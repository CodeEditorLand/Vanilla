...
function getAccessibilityHelpText(accessor) {
  ...
  content.push(
    makeRequestKeybinding ? localize(
      "inlineChat.input",
  ...
  content.push(
    openAccessibleViewKeybinding ? localize(
  ...
  content.push(
    focusResponseKeybinding ? localize(
  ...
  content.push(
    insertCommandKeybinding ? localize(
