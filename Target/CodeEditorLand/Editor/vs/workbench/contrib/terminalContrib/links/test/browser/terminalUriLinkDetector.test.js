      ...
      [
        {
          ...
          uri: URI.parse("https://en.wikipedia.org/wiki/Z\xFCrich")
        }
      ]
    ],
    [
      ...
      [
        {
          ...
          uri: URI.parse("file://sh\xE4res/foo.bar")
        }
      ],
      URI.parse("file://sh\xE4res/foo.bar")
    ],
    [
      TerminalBuiltinLinkType.Url,
