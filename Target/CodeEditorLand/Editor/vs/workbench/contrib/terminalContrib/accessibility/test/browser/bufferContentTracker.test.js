...
suite("Buffer Content Tracker", () => {
  ...
  setup(async () => {
    ...
    xterm = store.add(instantiationService.createInstance(XtermTerminal, TerminalCtor, 80, 30, { getBackgroundColor: /* @__PURE__ */ __name(() => void 0, "getBackgroundColor") }, capabilities, "", true));
