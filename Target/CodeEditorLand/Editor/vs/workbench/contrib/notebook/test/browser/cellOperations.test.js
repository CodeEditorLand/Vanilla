...
suite("CellOperations", () => {
  ...
  test("Move cells - single cell", async () => {
    await withTestNotebook(
      ...
      async (editor, viewModel) => {
        ...
        assert.ok(cell);
        await moveCellRange(
          { notebookEditor: editor, cell },
          "down"
        );
        assert.strictEqual(
          viewModel.cellAt(2)?.getText(),
          "var b = 1;"
        );
  ...
  test("Move cells - multiple cells in a selection", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
      ...
      async (editor, viewModel) => {
        ...
        assert.strictEqual(
          viewModel.cellAt(0)?.getText(),
          "# header b"
        );
        assert.strictEqual(
          viewModel.cellAt(1)?.getText(),
          "# header a"
        );
        assert.strictEqual(
          viewModel.cellAt(2)?.getText(),
  ...
  test("Move cells - move with folding ranges", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("Copy/duplicate cells - single cell", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
      ...
      async (editor, viewModel) => {
        ...
        await copyCellRange(
          { notebookEditor: editor, cell: viewModel.cellAt(1) },
          "down"
        );
  ...
  test("Copy/duplicate cells - target and selection are different, #119769", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("Copy/duplicate cells - multiple cells in a selection", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
      ...
      async (editor, viewModel) => {
        ...
        assert.strictEqual(
          viewModel.cellAt(3)?.getText(),
          "var b = 1;"
        );
      }
    );
  });
  test("Copy/duplicate cells - move with folding ranges", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("Copy/duplicate cells - should not share the same text buffer #102423", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}]
  ...
  test("Join cell with below - single cell", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
      ...
      async (editor, viewModel, accessor) => {
        ...
        const ret = await joinNotebookCells(
          editor,
          { start: 3, end: 4 },
          "below"
        );
        ...
        assert.deepStrictEqual(
          ret?.edits[0],
          new ResourceTextEdit(viewModel.cellAt(3).uri, {
  ...
  test("Join cell with above - single cell", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("Join cell with below - multiple cells", async () => {
    await withTestNotebook(
      [
      ...
      async (editor, viewModel, accessor) => {
        ...
        assert.deepStrictEqual(
          ret?.edits[0],
          new ResourceTextEdit(viewModel.cellAt(0).uri, {
            range: new Range(1, 11, 1, 11),
  ...
  test("Join cell with above - multiple cells", async () => {
    await withTestNotebook(
      [
        ["var a = 1;", "javascript", CellKind.Code, [], {}],
        ["var b = 2;", "javascript", CellKind.Code, [], {}],
  ...
  test("Delete selected cells", async () => {
    await withTestNotebook(
      [
        ["var a = 1;", "javascript", CellKind.Code, [], {}],
        ["var b = 2;", "javascript", CellKind.Code, [], {}],
  ...
  test("Delete focus cell out of a selection", async () => {
    await withTestNotebook(
      [
        ["var a = 1;", "javascript", CellKind.Code, [], {}],
        ["var b = 2;", "javascript", CellKind.Code, [], {}],
  ...
  test("Delete last cell sets selection correctly", async () => {
    await withTestNotebook(
      [
        ["var a = 1;", "javascript", CellKind.Code, [], {}],
        ["var b = 2;", "javascript", CellKind.Code, [], {}],
  ...
  test("#120187. Delete should work on multiple distinct selection", async () => {
    await withTestNotebook(
      [
        ["var a = 1;", "javascript", CellKind.Code, [], {}],
        ["var b = 2;", "javascript", CellKind.Code, [], {}],
  ...
  test("#120187. Delete should work on multiple distinct selection 2", async () => {
    await withTestNotebook(
      [
        ["var a = 1;", "javascript", CellKind.Code, [], {}],
        ["var b = 2;", "javascript", CellKind.Code, [], {}],
  ...
  test("Change cell kind - single cell", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
      ...
      async (editor, viewModel) => {
        ...
        assert.strictEqual(
          viewModel.cellAt(1)?.cellKind,
          CellKind.Markup
        );
      }
    );
  });
  test("Change cell kind - multi cells", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
      ...
      async (editor, viewModel) => {
        ...
        assert.strictEqual(
          viewModel.cellAt(3)?.cellKind,
          CellKind.Markup
        );
        assert.strictEqual(
          viewModel.cellAt(4)?.cellKind,
          CellKind.Markup
        );
      }
    );
  ...
  test("split cell", async () => {
    await withTestNotebook(
      ...
      (editor, viewModel) => {
        assert.deepStrictEqual(
          computeCellLinesContents(viewModel.cellAt(0), [
  ...
  test("Insert cell", async () => {
    await withTestNotebook(
      ...
      async (editor, viewModel, _ds, accessor) => {
        ...
        const insertedCellAbove = insertCell(
          languageService,
          editor,
          4,
          CellKind.Code,
        ...
        const insertedCellBelow = insertCell(
          languageService,
          editor,
          1,
          CellKind.Code,
