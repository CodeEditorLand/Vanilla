...
suite("Notebook Folding", () => {
  ...
  test("Folding based on markdown cells", async () => {
  ...
  test("Folding not based on code cells", async () => {
    await withTestNotebook(
      [
        ["# header 1", "markdown", CellKind.Markup, [], {}],
        ["body", "markdown", CellKind.Markup, [], {}],
  ...
  test("Top level header in a cell wins", async () => {
    await withTestNotebook(
      [
        ["# header 1", "markdown", CellKind.Markup, [], {}],
        ["body", "markdown", CellKind.Markup, [], {}],
