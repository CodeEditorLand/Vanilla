...
suite("NotebookCellList focus/selection", () => {
  ...
  test("notebook cell list setFocus", async () => {
    await withTestNotebook(
      ...
      (editor, viewModel, ds) => {
        ...
        cellList.setFocus([0]);
        assert.deepStrictEqual(viewModel.getFocus(), {
          start: 0,
          end: 1
        });
        cellList.setFocus([1]);
  ...
  test("notebook cell list setSelections", async () => {
    await withTestNotebook(
      [
        ["var a = 1;", "javascript", CellKind.Code, [], {}],
        ["var b = 2;", "javascript", CellKind.Code, [], {}]
  ...
  test("notebook cell list setFocus2", async () => {
    await withTestNotebook(
      [
        ["var a = 1;", "javascript", CellKind.Code, [], {}],
        ["var b = 2;", "javascript", CellKind.Code, [], {}]
  ...
  test("notebook cell list focus/selection from UI", async () => {
    await withTestNotebook(
      [
  ...
  test("notebook cell list focus/selection with folding regions", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("notebook cell list focus/selection with folding regions and applyEdits", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("notebook cell list getModelIndex", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
    ...
    await withTestNotebook(
      ...
      (editor, viewModel) => {
        ...
        assert.deepStrictEqual(
          viewModel.validateRange(void 0),
          null
        );
        assert.deepStrictEqual(
          viewModel.validateRange({ start: 0, end: 0 }),
          { start: 0, end: 0 }
        );
        assert.deepStrictEqual(
          viewModel.validateRange({ start: 0, end: 2 }),
          { start: 0, end: 2 }
        );
        assert.deepStrictEqual(
          viewModel.validateRange({ start: 0, end: 3 }),
          { start: 0, end: 2 }
        );
        assert.deepStrictEqual(
          viewModel.validateRange({ start: -1, end: 3 }),
          { start: 0, end: 2 }
        );
        assert.deepStrictEqual(
          viewModel.validateRange({ start: -1, end: 1 }),
          { start: 0, end: 1 }
        );
        assert.deepStrictEqual(
          viewModel.validateRange({ start: 2, end: 1 }),
          { start: 1, end: 2 }
        );
        assert.deepStrictEqual(
          viewModel.validateRange({ start: 2, end: -1 }),
  ...
  test("notebook updateSelectionState", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}]
  ...
  test("notebook cell selection w/ cell deletion", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}]
  ...
  test("notebook cell selection w/ cell deletion from applyEdits", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
