...
suite("NotebookCellList", () => {
  ...
  test("revealElementsInView: reveal fully visible cell should not scroll", async () => {
  ...
  test("revealElementsInView: reveal partially visible cell", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("revealElementsInView: reveal cell out of viewport", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("updateElementHeight", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("updateElementHeight with anchor", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("updateElementHeight with no scrolling", async () => {
  ...
  test("updateElementHeight with no scroll setting and cell editor focused", async () => {
    config.setUserConfiguration(NotebookSetting.scrollToRevealCell, "none");
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
      ...
      async (editor, viewModel, disposables) => {
        ...
        assert.deepStrictEqual(cellList.getViewScrollBottom(), 210);
        cellList.setFocus([1]);
        editor.focusNotebookCell(
          cellList.viewModel?.cellAt(1),
          "editor"
        );
        cellList.updateElementHeight2(viewModel.cellAt(0), 100);
        assert.deepStrictEqual(cellList.scrollHeight, 400);
  ...
  test("updateElementHeight with focused element out of viewport", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("updateElementHeight of cells out of viewport should not trigger scroll #121140", async () => {
    await withTestNotebook(
      [
        ["# header a", "markdown", CellKind.Markup, [], {}],
        ["var b = 1;", "javascript", CellKind.Code, [], {}],
  ...
  test("visibleRanges should be exclusive of end 2", async () => {
    await withTestNotebook(
      [["# header a", "markdown", CellKind.Markup, [], {}]],
      async (editor, viewModel, disposables) => {
        viewModel.restoreEditorViewState({
