...
registerAction2(
  class FocusNextCellAction extends NotebookCellAction {
    constructor() {
      super({
        ...
        keybinding: [
          ...
          },
          {
            ...
            mac: {
              primary: KeyMod.WinCtrl | KeyMod.CtrlCmd | KeyCode.DownArrow
            },
            weight: KeybindingWeight.WorkbenchContrib
          },
          {
...
registerAction2(
  class FocusPreviousCellAction extends NotebookCellAction {
    constructor() {
      super({
    ...
    async runWithContext(accessor, context) {
      ...
      const foundEditor = findTargetCellEditor(
        context,
        newCell
      );
    ...
    constructor() {
      super({
        ...
        keybinding: {
          ...
          mac: {
            primary: KeyMod.WinCtrl | KeyMod.CtrlCmd | KeyCode.UpArrow
          },
          weight: KeybindingWeight.WorkbenchContrib
        }
      });
...
registerAction2(
  class CenterActiveCellAction extends NotebookCellAction {
    constructor() {
      super({
