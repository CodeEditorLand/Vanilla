...
registerAction2(
  class extends Action2 {
    ...
    run(accessor, context) {
      ...
      const modifiedCellIndex = context.cell.mainDocumentTextModel.cells.indexOf(
        modified.textModel
      );
      if (modifiedCellIndex === -1) {
        return;
      ...
      if (context.cell.original.language && context.cell.modified.language !== context.cell.original.language) {
        rawEdits.push({
          ...
          index: modifiedCellIndex,
          language: context.cell.original.language
        });
      }
      context.cell.modifiedDocument.applyEdits(
        rawEdits,
        true,
        void 0,
        () => void 0,
