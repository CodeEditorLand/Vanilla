  ...
  updateSourceEditor() {
    ...
    this._cellHeader = this._register(this.instantiationService.createInstance(
      ...
      this.notebookEditor,
      {
        ...
        checkIfModified: /* @__PURE__ */ __name((_) => ({ reason: void 0 }), "checkIfModified"),
        getFoldingState: /* @__PURE__ */ __name((cell) => cell.cellFoldingState, "getFoldingState"),
        updateFoldingState: /* @__PURE__ */ __name((cell, state) => cell.cellFoldingState = state, "updateFoldingState"),
  ...
  _buildMetadata() {
    ...
    this._metadataHeader = this.instantiationService.createInstance(
      ...
      this.notebookEditor,
      {
        ...
        checkIfModified: /* @__PURE__ */ __name((cell) => {
          return cell.checkMetadataIfModified();
        }, "checkIfModified"),
        getFoldingState: /* @__PURE__ */ __name((cell) => {
          return cell.metadataFoldingState;
        }, "getFoldingState"),
        updateFoldingState: /* @__PURE__ */ __name((cell, state) => {
