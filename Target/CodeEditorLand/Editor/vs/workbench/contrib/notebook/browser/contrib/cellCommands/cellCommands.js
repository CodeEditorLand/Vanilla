...
registerAction2(
  class ChangeCellToCodeAction extends NotebookMultiCellAction {
    constructor() {
      super({
...
registerAction2(
  class ChangeCellToMarkdownAction extends NotebookMultiCellAction {
    constructor() {
      super({
...
registerAction2(
  class CollapseCellInputAction extends NotebookMultiCellAction {
    constructor() {
      super({
    ...
    async runWithContext(accessor, context) {
      if (context.ui) {
        ...
        context.selectedCells.forEach(
          (cell) => cell.isInputCollapsed = true
        );
      }
    }
  }
...
registerAction2(
  class ExpandCellInputAction extends NotebookMultiCellAction {
    constructor() {
      super({
    ...
    async runWithContext(accessor, context) {
      if (context.ui) {
        ...
        context.selectedCells.forEach(
          (cell) => cell.isInputCollapsed = false
        );
      }
    }
  }
...
registerAction2(
  class CollapseCellOutputAction extends NotebookMultiCellAction {
    constructor() {
      super({
    ...
    async runWithContext(accessor, context) {
      if (context.ui) {
        ...
        context.selectedCells.forEach(
          (cell) => cell.isOutputCollapsed = true
        );
      }
    }
  }
...
registerAction2(
  class ExpandCellOuputAction extends NotebookMultiCellAction {
    constructor() {
      super({
    ...
    async runWithContext(accessor, context) {
      if (context.ui) {
        ...
        context.selectedCells.forEach(
          (cell) => cell.isOutputCollapsed = false
        );
      }
    }
  }
...
registerAction2(
  class CollapseAllCellInputsAction extends NotebookMultiCellAction {
    constructor() {
      super({
...
registerAction2(
  class ExpandAllCellInputsAction extends NotebookMultiCellAction {
    constructor() {
      super({
...
registerAction2(
  class CollapseAllCellOutputsAction extends NotebookMultiCellAction {
    constructor() {
      super({
...
registerAction2(
  class ExpandAllCellOutputsAction extends NotebookMultiCellAction {
    constructor() {
      super({
...
registerAction2(
  class ToggleCellOutputScrolling extends NotebookMultiCellAction {
    constructor() {
      super({
