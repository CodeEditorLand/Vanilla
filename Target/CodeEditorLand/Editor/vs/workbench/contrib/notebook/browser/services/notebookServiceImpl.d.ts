...
import { INotebookContributionData, INotebookRendererInfo, INotebookStaticPreloadInfo, IOrderedMimeType, IOutputDto, NotebookExtensionDescription } from "vs/workbench/contrib/notebook/common/notebookCommon";
...
export declare class NotebookService extends Disposable implements INotebookService {
    ...
    readonly onDidChangeOutputRenderers: any;
    ...
    readonly onWillAddNotebookDocument: any;
    readonly onDidAddNotebookDocument: any;
    readonly onDidRemoveNotebookDocument: any;
    readonly onWillRemoveNotebookDocument: any;
    private readonly _onAddViewType;
    readonly onAddViewType: any;
    private readonly _onWillRemoveViewType;
    readonly onWillRemoveViewType: any;
