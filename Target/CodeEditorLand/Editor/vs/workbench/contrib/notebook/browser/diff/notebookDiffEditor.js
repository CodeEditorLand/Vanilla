...
let NotebookTextDiffEditor = class extends EditorPane {
  constructor(group, instantiationService, themeService, contextKeyService, notebookEditorWorkerService, configurationService, telemetryService, storageService, notebookService, editorWorkerService, textModelResolverService, textConfigurationService) {
  ...
  _attachModel() {
    ...
    if (this._model) {
      ...
      const vm = this.notebookDiffViewModel = this._register(new NotebookDiffViewModel(this._model, this.notebookEditorWorkerService, this.configurationService, this._eventDispatcher, this.notebookService, unchangedEditorRegions, this.fontInfo, void 0));
