...
class MarkdownConfigurationService extends TestConfigurationService {
  static {
    __name(this, "MarkdownConfigurationService");
  }
...
suite("Markdown Setting Renderer Test", () => {
  ...
  suiteSetup(() => {
    ...
    preferencesService = {
      getSetting: /* @__PURE__ */ __name((setting) => {
        let type = "boolean";
    ...
    settingRenderer = new SimpleSettingRenderer(configurationService, contextMenuService, preferencesService, { publicLog2: /* @__PURE__ */ __name(() => {
    }, "publicLog2") }, { writeText: /* @__PURE__ */ __name(async () => {
    }, "writeText") });
  });
  suiteTeardown(() => {
  ...
  test("actions with value + updating and restoring", async () => {
    ...
    const verifyOriginalState = /* @__PURE__ */ __name((actions2) => {
...
//# sourceMappingURL=markdownSettingRenderer.test.js.map
