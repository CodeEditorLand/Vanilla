...
const JavaLibrariesToLookFor = [
  ...
  // spring boot
  {
    predicate: (groupId, artifactId) => groupId === "org.springframework.boot",
    tag: "springboot"
  },
  // sql
  ...
  {
    predicate: (groupId, artifactId) => groupId === "dev.langchain4j",
    tag: "langchain4j"
  },
  {
    predicate: (groupId, artifactId) => groupId === "io.springboot.ai",
    tag: "springboot-ai"
  },
  {
