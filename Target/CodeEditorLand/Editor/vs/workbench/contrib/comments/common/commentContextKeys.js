...
((CommentContextKeys2) => {
  CommentContextKeys2.activeCursorHasCommentingRange = new RawContextKey(
  ...
  CommentContextKeys2.activeEditorHasCommentingRange = new RawContextKey(
  ...
  CommentContextKeys2.WorkspaceHasCommenting = new RawContextKey(
  ...
  CommentContextKeys2.commentIsEmpty = new RawContextKey(
    "commentIsEmpty",
    false,
    {
      type: "boolean",
  ...
  CommentContextKeys2.commentContext = new RawContextKey(
    "comment",
    void 0,
    {
      type: "string",
  ...
  CommentContextKeys2.commentThreadContext = new RawContextKey(
    "commentThread",
    void 0,
    {
      type: "string",
  ...
  CommentContextKeys2.commentFocused = new RawContextKey(
    "commentFocused",
    false,
    {
      type: "boolean",
