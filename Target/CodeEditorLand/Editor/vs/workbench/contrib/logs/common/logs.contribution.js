  ...
  registerLogChannel(logger) {
    ...
    const promise = createCancelablePromise(async (token) => {
      ...
      try {
        ...
        const remoteLogger = existingChannel?.file?.scheme === Schemas.vscodeRemote ? this.loggerService.getRegisteredLogger(existingChannel.file) : void 0;
        if (remoteLogger) {
...
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(LogLevelMigration, LifecyclePhase.Eventually);
