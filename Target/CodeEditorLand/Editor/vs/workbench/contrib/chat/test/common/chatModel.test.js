...
suite("ChatModel", () => {
  ...
  test("Waits for initialization", async () => {
    const model = testDisposables.add(instantiationService.createInstance(ChatModel, void 0, ChatAgentLocation.Panel));
  ...
  test("adoptRequest", async function() {
    const model1 = testDisposables.add(instantiationService.createInstance(ChatModel, void 0, ChatAgentLocation.Editor));
    const model2 = testDisposables.add(instantiationService.createInstance(ChatModel, void 0, ChatAgentLocation.Panel));
