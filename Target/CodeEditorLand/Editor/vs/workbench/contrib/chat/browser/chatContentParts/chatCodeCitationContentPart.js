...
`).join(`
`);this.editorService.openEditor({resource:void 0,contents:p,languageId:"markdown"}),this.telemetryService.publicLog2("openedChatCodeCitations")})),this.domNode=c.root}domNode;hasSameContent(e,n,t){return e.kind==="codeCitations"}};d=C([m(2,S),m(3,v)],d);export{d as ChatCodeCitationContentPart};
