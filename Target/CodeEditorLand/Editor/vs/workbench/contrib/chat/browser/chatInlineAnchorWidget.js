    ...
    if (data.kind === "symbol") {
      ...
      iconClasses = [
        ...
        ...getIconClasses(
          ...
          void 0,
          void 0,
          SymbolKinds.toIcon(data.symbol.kind)
        )
      ];
      const model = modelService.getModel(location.uri);
      if (model) {
        const hasDefinitionProvider = EditorContextKeys.hasDefinitionProvider.bindTo(
          contextKeyService
        );
        const hasReferenceProvider = EditorContextKeys.hasReferenceProvider.bindTo(
          contextKeyService
        );
        const updateContents = /* @__PURE__ */ __name(() => {
          ...
          hasDefinitionProvider.set(
            languageFeaturesService.definitionProvider.has(model)
          );
          hasReferenceProvider.set(
            languageFeaturesService.definitionProvider.has(model)
          );
        }, "updateContents");
        updateContents();
        this._register(
          languageFeaturesService.definitionProvider.onDidChange(
            updateContents
          )
        );
        this._register(
          languageFeaturesService.referenceProvider.onDidChange(
            updateContents
          )
        );
      }
...
registerAction2(
  class GoToDefinitionAction extends Action2 {
    static {
...
registerAction2(
  class GoToDefinitionAction2 extends Action2 {
    static {
      __name(this, "GoToDefinitionAction");
    }
...
registerAction2(
  class GoToReferencesAction extends Action2 {
    static {
