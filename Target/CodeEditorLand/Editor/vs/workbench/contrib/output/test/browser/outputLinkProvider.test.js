...
suite("OutputLinkProvider", () => {
  ...
  test("OutputLinkProvider - Link detection", () => {
    const rootFolder = isWindows ? URI.file(
    ...
    let result = OutputLinkComputer.detectLinks(
      line,
      1,
      patterns,
      contextService
    ...
    result = OutputLinkComputer.detectLinks(
      line,
      1,
      patterns,
      contextService
    ...
    assert.strictEqual(
      result[0].url,
      contextService.toResource("/Game.ts").toString()
    );
    ...
    assert.strictEqual(
      result[0].url,
      contextService.toResource("/Game.ts").toString() + "#336"
    );
    assert.strictEqual(result[0].range.startColumn, 5);
    ...
    assert.strictEqual(
      result[0].url,
      contextService.toResource("/Game.ts").toString() + "#336,9"
    );
    assert.strictEqual(result[0].range.startColumn, 5);
    ...
    assert.strictEqual(
      result[0].url,
      contextService.toResource("/Game.ts").toString() + "#8"
    );
    ...
    assert.strictEqual(
      result[0].url,
      contextService.toResource("/Game.ts").toString() + "#8,13"
    );
    assert.strictEqual(result[0].range.startColumn, 1);
    ...
    assert.strictEqual(
      result[0].url,
      contextService.toResource("/Game.ts").toString() + "#278"
    );
    assert.strictEqual(result[0].range.startColumn, 15);
    ...
    assert.strictEqual(
      result[0].url,
      contextService.toResource("/Game.ts").toString() + "#278,34"
    );
    assert.strictEqual(result[0].range.startColumn, 15);
    assert.strictEqual(result[0].range.endColumn, 101);
    line = toOSPath(
  ...
  test("OutputLinkProvider - #106847", () => {
    ...
    const result = OutputLinkComputer.detectLinks(
      line,
      1,
      patterns,
      contextService
