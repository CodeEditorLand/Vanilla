...
MarketplaceThemesPicker = __decorateClass([
  ...
  __decorateParam(7, IPaneCompositePartService),
...
registerAction2(
  class extends Action2 {
    ...
    async run(accessor) {
      ...
      const setTheme = (theme, settingsTarget) => themeService.setColorTheme(
        theme,
        settingsTarget
      );
      const getMarketplaceColorThemes = (publisher, name, version) => themeService.getMarketplaceColorThemes(
        publisher,
        name,
        version
      );
...
registerAction2(
  class extends Action2 {
    ...
    async run(accessor) {
      ...
      const setTheme = (theme, settingsTarget) => themeService.setFileIconTheme(
        theme,
        settingsTarget
      );
      const getMarketplaceColorThemes = (publisher, name, version) => themeService.getMarketplaceFileIconThemes(
        publisher,
        name,
        version
      );
...
registerAction2(
  class extends Action2 {
    ...
    async run(accessor) {
      ...
      const setTheme = (theme, settingsTarget) => themeService.setProductIconTheme(
        theme,
        settingsTarget
      );
      const getMarketplaceColorThemes = (publisher, name, version) => themeService.getMarketplaceProductIconThemes(
        publisher,
        name,
        version
      );
