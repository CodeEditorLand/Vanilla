...
import { DebugConfigurationProviderTriggerKind, IAdapterManager, IConfig, IConfigPresentation, IConfigurationManager, IDebugConfigurationProvider, ILaunch } from "vs/workbench/contrib/debug/common/debug";
...
export declare class ConfigurationManager implements IConfigurationManager {
    ...
    readonly onDidChangeConfigurationProviders: any;
