...
import { type IAdapterManager, type IBreakpoint, type IBreakpointData, type IBreakpointUpdateData, type IConfig, type IConfigurationManager, type IDebugModel, type IDebugService, type IDebugSession, type IDebugSessionOptions, type IEnablement, type IExceptionBreakpoint, type ILaunch, type IStackFrame, type IThread, type IViewModel, State } from "../common/debug.js";
import { type IDataBreakpointOptions, type IFunctionBreakpointOptions, type IInstructionBreakpointOptions } from "../common/debugModel.js";
