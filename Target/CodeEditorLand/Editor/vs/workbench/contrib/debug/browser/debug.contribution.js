...
registerDebugCommandPaletteItem(
  TERMINATE_THREAD_ID,
  nls.localize2("terminateThread", "Terminate Thread"),
  CONTEXT_IN_DEBUG_MODE
);
registerDebugCommandPaletteItem(
  STEP_OVER_ID,
...
registerDebugCommandPaletteItem(
  JUMP_TO_CURSOR_ID,
  nls.localize2("jumpToCursor", "Jump to Cursor"),
  CONTEXT_JUMP_TO_CURSOR_SUPPORTED
);
registerDebugCommandPaletteItem(
  JUMP_TO_CURSOR_ID,
  nls.localize2("SetNextStatement", "Set Next Statement"),
  CONTEXT_JUMP_TO_CURSOR_SUPPORTED
);
registerDebugCommandPaletteItem(
  RunToCursorAction.ID,
  RunToCursorAction.LABEL,
  CONTEXT_DEBUGGERS_AVAILABLE
);
registerDebugCommandPaletteItem(
  SelectionToReplAction.ID,
  SelectionToReplAction.LABEL,
  CONTEXT_IN_DEBUG_MODE
);
registerDebugCommandPaletteItem(
...
registerDebugCommandPaletteItem(
  TOGGLE_INLINE_BREAKPOINT_ID,
  nls.localize2("inlineBreakpoint", "Inline Breakpoint")
);
registerDebugCommandPaletteItem(
  DEBUG_START_COMMAND_ID,
  DEBUG_START_LABEL,
...
registerDebugViewMenuItem(
  MenuId.DebugCallStackContext,
  TERMINATE_THREAD_ID,
  nls.localize("terminateThread", "Terminate Thread"),
  10,
  CONTEXT_CALLSTACK_ITEM_TYPE.isEqualTo("thread"),
  void 0,
  "termination"
...
registerDebugViewMenuItem(
  MenuId.DebugCallStackContext,
  RESTART_FRAME_ID,
  nls.localize("restartFrame", "Restart Frame"),
  10,
  ContextKeyExpr.and(
...
registerDebugViewMenuItem(
  MenuId.DebugCallStackContext,
  COPY_STACK_TRACE_ID,
  nls.localize("copyStackTrace", "Copy Call Stack"),
  20,
  CONTEXT_CALLSTACK_ITEM_TYPE.isEqualTo("stackFrame"),
  void 0,
  "3_modification"
...
registerDebugViewMenuItem(
  ...
  VIEW_MEMORY_ID,
  nls.localize("viewMemory", "View Binary Data"),
  15,
  CONTEXT_CAN_VIEW_MEMORY,
  CONTEXT_IN_DEBUG_MODE,
  "inline",
  icons.debugInspectMemory
);
registerDebugViewMenuItem(
  MenuId.DebugVariablesContext,
  SET_VARIABLE_ID,
  nls.localize("setValue", "Set Value"),
  10,
  ContextKeyExpr.or(
    CONTEXT_SET_VARIABLE_SUPPORTED,
    ContextKeyExpr.and(
  ...
  CONTEXT_VARIABLE_IS_READONLY.toNegated(),
  "3_modification"
);
registerDebugViewMenuItem(
  MenuId.DebugVariablesContext,
...
registerDebugViewMenuItem(
  MenuId.DebugVariablesContext,
  BREAK_WHEN_VALUE_IS_READ_ID,
  nls.localize("breakWhenValueIsRead", "Break on Value Read"),
  200,
  CONTEXT_BREAK_WHEN_VALUE_IS_READ_SUPPORTED,
  void 0,
  "z_commands"
...
registerDebugViewMenuItem(
  MenuId.DebugVariablesContext,
  BREAK_WHEN_VALUE_CHANGES_ID,
  nls.localize("breakWhenValueChanges", "Break on Value Change"),
  210,
  CONTEXT_BREAK_WHEN_VALUE_CHANGES_SUPPORTED,
  void 0,
  "z_commands"
...
registerDebugViewMenuItem(
  MenuId.DebugVariablesContext,
  BREAK_WHEN_VALUE_IS_ACCESSED_ID,
  nls.localize("breakWhenValueIsAccessed", "Break on Value Access"),
  220,
  CONTEXT_BREAK_WHEN_VALUE_IS_ACCESSED_SUPPORTED,
  void 0,
  "z_commands"
...
registerDebugViewMenuItem(
  MenuId.DebugWatchContext,
  EDIT_EXPRESSION_COMMAND_ID,
  nls.localize("editWatchExpression", "Edit Expression"),
  20,
...
registerDebugViewMenuItem(
  MenuId.DebugWatchContext,
  COPY_VALUE_ID,
  nls.localize("copyValue", "Copy Value"),
  40,
  ContextKeyExpr.or(
    CONTEXT_WATCH_ITEM_TYPE.isEqualTo("expression"),
    CONTEXT_WATCH_ITEM_TYPE.isEqualTo("variable")
...
registerDebugViewMenuItem(
  MenuId.DebugWatchContext,
  REMOVE_EXPRESSION_COMMAND_ID,
  nls.localize("removeWatchExpression", "Remove Expression"),
  20,
  CONTEXT_WATCH_ITEM_TYPE.isEqualTo("expression"),
  void 0,
  "inline",
  icons.watchExpressionRemove
);
registerDebugViewMenuItem(
  MenuId.DebugWatchContext,
  REMOVE_WATCH_EXPRESSIONS_COMMAND_ID,
...
if (isMacintosh) {
  ...
  registerTouchBarEntry(
    ...
    DEBUG_RUN_LABEL,
    0,
    CONTEXT_IN_DEBUG_MODE.toNegated(),
...
Registry.as(
  ...
  EditorPaneDescriptor.create(
    DisassemblyView,
    DISASSEMBLY_VIEW_ID,
    nls.localize("disassembly", "Disassembly")
  ),
