...
import { type AdapterEndEvent, type IBreakpoint, type IConfig, type IDataBreakpoint, type IDataBreakpointInfoResponse, type IDebugLocationReferenced, IDebugService, type IDebugSession, type IDebugSessionOptions, type IDebugger, type IExceptionBreakpoint, type IExceptionInfo, type IFunctionBreakpoint, type IInstructionBreakpoint, type IMemoryRegion, type IRawModelUpdate, type IRawStoppedDetails, type IReplElement, type IStackFrame, type IThread, type LoadedSourceEvent, State } from "../common/debug.js";
import type { DebugCompoundRoot } from "../common/debugCompoundRoot.js";
import { type DebugModel, Thread } from "../common/debugModel.js";
import { Source } from "../common/debugSource.js";
import { type INewReplElementData } from "../common/replModel.js";
