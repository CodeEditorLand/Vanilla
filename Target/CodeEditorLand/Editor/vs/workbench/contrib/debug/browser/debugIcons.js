...
const debugBreakpointHint = registerIcon(
  "debug-hint",
  Codicon.debugHint,
  localize(
    "debugBreakpointHint",
...
const debugStackframe = registerIcon(
  "debug-stackframe",
...
const debugConsole = registerIcon(
  "debug-console",
  Codicon.gear,
...
const debugCollapseAll = registerIcon(
  "debug-collapse-all",
  Codicon.collapseAll,
  localize(
    "debugCollapseAll",
...
const callstackViewSession = registerIcon(
...
const debugConsoleClearAll = registerIcon(
...
const watchExpressionsRemoveAll = registerIcon(
...
const watchExpressionRemove = registerIcon(
...
const watchExpressionsAdd = registerIcon(
...
const breakpointsRemoveAll = registerIcon(
...
const debugConsoleEvaluationInput = registerIcon(
...
const debugConsoleEvaluationPrompt = registerIcon(
...
const debugInspectMemory = registerIcon(
