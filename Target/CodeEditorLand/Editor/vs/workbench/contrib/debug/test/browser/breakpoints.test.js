...
__name(addBreakpointsAndCheckEvents, "addBreakpointsAndCheckEvents");
suite("Debug - Breakpoints", () => {
  ...
  test("updates when storage changes", () => {
    ...
    const model1 = disposables.add(new DebugModel(debugStorage1, { isDirty: /* @__PURE__ */ __name((e) => false, "isDirty") }, mockUriIdentityService, new NullLogService()));
    const modelUri = uri.file("/myfolder/my file first.js");
    const first = [
      { lineNumber: 1, enabled: true, condition: "x > 5" },
      { lineNumber: 2, column: 4, enabled: false }
    ...
    const model2 = disposables.add(new DebugModel(disposables.add(new MockDebugStorage(storage2)), { isDirty: /* @__PURE__ */ __name((e) => false, "isDirty") }, mockUriIdentityService, new NullLogService()));
    storage2.store(
      "debug.breakpoint",
      stored,
