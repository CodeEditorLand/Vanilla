...
suite("Debug - ANSI Handling", () => {
  ...
  __name(getSequenceOutput, "getSequenceOutput");
  ...
  __name(assertSingleSequenceElement, "assertSingleSequenceElement");
  ...
  __name(assertInlineColor, "assertInlineColor");
  test("Expected single sequence operation", () => {
    ...
    for (let i = 30; i <= 37; i++) {
      ...
      assertSingleSequenceElement("\x1B[" + i + ";39m", (child) => {
        ...
        assertInlineColor(child, "foreground", void 0, "Custom color style still found after foreground cancellation code.");
      });
    }
    for (let i = 40; i <= 47; i++) {
      ...
      assertSingleSequenceElement("\x1B[" + i + ";49m", (child) => {
        ...
        assertInlineColor(child, "foreground", void 0, "Custom color style still found after background cancellation code.");
      });
    }
    for (let i = 0; i <= 255; i++) {
      ...
      assertSingleSequenceElement("\x1B[58;5;" + i + "m\x1B[59m", (child) => {
        ...
        assertInlineColor(child, "underline", void 0, "Custom underline color style still found after underline color cancellation code 59m.");
      });
    }
    ...
    assertSingleSequenceElement("\x1B[1;4;30;41;32;43;34;45;36;47;0m", (child) => {
      ...
      assertInlineColor(child, "background", void 0, "Cancellation ANSI code should clear ALL formatting.");
      assertInlineColor(child, "foreground", void 0, "Cancellation ANSI code should clear ALL formatting.");
    });
  });
  ...
  __name(assertMultipleSequenceElements, "assertMultipleSequenceElements");
  test("Expected multiple sequence operation", () => {
    ...
    assertMultipleSequenceElements("\x1B[58;2;101;102;103m24bitUnderline101,102,103\x1B[58;5;3m8bitsimpleUnderline\x1B[58;2;104;105;106m24bitUnderline104,105,106\x1B[58;5;101m8bitadvanced\x1B[58;2;200;200;200munderline200,200,200\x1B[59mUnderlineColorResetToDefault", [
      ...
      (underlineColorResetToDefault) => {
        ...
        assertInlineColor(underlineColorResetToDefault, "underline", void 0, "after RESET TO DEFAULT underline color SHOULD NOT BE SET (no color inline style.)");
      }
    ], 6);
  ...
  __name(assertSequencestrictEqualToContent, "assertSequencestrictEqualToContent");
  ...
  __name(assertEmptyOutput, "assertEmptyOutput");
  ...
  test("calcANSI8bitColor", () => {
    for (let i = -10; i <= 15; i += 0.5) {
      assert(calcANSI8bitColor(i) === void 0, "Values less than 16 passed to calcANSI8bitColor should return undefined.");
    }
    for (let i = 16.5; i < 254; i += 1) {
      assert(calcANSI8bitColor(i) === void 0, "Floats passed to calcANSI8bitColor should return undefined.");
    }
    for (let i = 256; i < 300; i += 0.5) {
      assert(calcANSI8bitColor(i) === void 0, "Values grather than 255 passed to calcANSI8bitColor should return undefined.");
    }
