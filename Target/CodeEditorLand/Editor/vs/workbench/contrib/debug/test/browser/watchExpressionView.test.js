...
__name(assertWatchVariable, "assertWatchVariable");
suite("Debug - Watch Debug View", () => {
  ...
  setup(() => {
    ...
    debugService.getViewModel = () => ({ focusedStackFrame: void 0, getSelectedExpression: /* @__PURE__ */ __name(() => void 0, "getSelectedExpression") });
...
//# sourceMappingURL=watchExpressionView.test.js.map
