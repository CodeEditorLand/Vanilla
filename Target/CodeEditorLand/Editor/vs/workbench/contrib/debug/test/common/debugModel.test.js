  ...
  suite("DebugModel", () => {
    test("refreshTopOfCallstack resolves all returned promises when called multiple times", async () => {
      ...
      const fakeThread = mockObject()({
        ...
        getCallStack: /* @__PURE__ */ __name(() => [], "getCallStack"),
        getStaleCallStack: /* @__PURE__ */ __name(() => [], "getStaleCallStack")
      });
      ...
      const model = new DebugModel(disposable.add(new MockDebugStorage(storage)), { isDirty: /* @__PURE__ */ __name((e) => false, "isDirty") }, void 0, new NullLogService());
