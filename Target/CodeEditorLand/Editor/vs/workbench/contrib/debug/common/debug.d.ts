...
import { URI, URI as uri, UriComponents } from "vs/base/common/uri";
...
export declare const CONTEXT_DEBUG_TYPE: any;
export declare const CONTEXT_DEBUG_CONFIGURATION_TYPE: any;
export declare const CONTEXT_DEBUG_STATE: any;
export declare const CONTEXT_DEBUG_UX_KEY = "debugUx";
export declare const CONTEXT_DEBUG_UX: any;
export declare const CONTEXT_HAS_DEBUGGED: any;
export declare const CONTEXT_IN_DEBUG_MODE: any;
export declare const CONTEXT_IN_DEBUG_REPL: any;
export declare const CONTEXT_BREAKPOINT_WIDGET_VISIBLE: any;
export declare const CONTEXT_IN_BREAKPOINT_WIDGET: any;
export declare const CONTEXT_BREAKPOINTS_FOCUSED: any;
export declare const CONTEXT_WATCH_EXPRESSIONS_FOCUSED: any;
export declare const CONTEXT_WATCH_EXPRESSIONS_EXIST: any;
export declare const CONTEXT_VARIABLES_FOCUSED: any;
export declare const CONTEXT_EXPRESSION_SELECTED: any;
export declare const CONTEXT_BREAKPOINT_INPUT_FOCUSED: any;
export declare const CONTEXT_CALLSTACK_ITEM_TYPE: any;
export declare const CONTEXT_CALLSTACK_SESSION_IS_ATTACH: any;
export declare const CONTEXT_CALLSTACK_ITEM_STOPPED: any;
export declare const CONTEXT_CALLSTACK_SESSION_HAS_ONE_THREAD: any;
export declare const CONTEXT_WATCH_ITEM_TYPE: any;
export declare const CONTEXT_CAN_VIEW_MEMORY: any;
export declare const CONTEXT_BREAKPOINT_ITEM_TYPE: any;
export declare const CONTEXT_BREAKPOINT_ITEM_IS_DATA_BYTES: any;
export declare const CONTEXT_BREAKPOINT_HAS_MODES: any;
export declare const CONTEXT_BREAKPOINT_SUPPORTS_CONDITION: any;
export declare const CONTEXT_LOADED_SCRIPTS_SUPPORTED: any;
export declare const CONTEXT_LOADED_SCRIPTS_ITEM_TYPE: any;
export declare const CONTEXT_FOCUSED_SESSION_IS_ATTACH: any;
export declare const CONTEXT_FOCUSED_SESSION_IS_NO_DEBUG: any;
export declare const CONTEXT_STEP_BACK_SUPPORTED: any;
export declare const CONTEXT_RESTART_FRAME_SUPPORTED: any;
export declare const CONTEXT_STACK_FRAME_SUPPORTS_RESTART: any;
export declare const CONTEXT_JUMP_TO_CURSOR_SUPPORTED: any;
export declare const CONTEXT_STEP_INTO_TARGETS_SUPPORTED: any;
export declare const CONTEXT_BREAKPOINTS_EXIST: any;
export declare const CONTEXT_DEBUGGERS_AVAILABLE: any;
export declare const CONTEXT_DEBUG_EXTENSION_AVAILABLE: any;
export declare const CONTEXT_DEBUG_PROTOCOL_VARIABLE_MENU_CONTEXT: any;
export declare const CONTEXT_SET_VARIABLE_SUPPORTED: any;
export declare const CONTEXT_SET_DATA_BREAKPOINT_BYTES_SUPPORTED: any;
export declare const CONTEXT_SET_EXPRESSION_SUPPORTED: any;
export declare const CONTEXT_BREAK_WHEN_VALUE_CHANGES_SUPPORTED: any;
export declare const CONTEXT_BREAK_WHEN_VALUE_IS_ACCESSED_SUPPORTED: any;
export declare const CONTEXT_BREAK_WHEN_VALUE_IS_READ_SUPPORTED: any;
export declare const CONTEXT_TERMINATE_DEBUGGEE_SUPPORTED: any;
export declare const CONTEXT_SUSPEND_DEBUGGEE_SUPPORTED: any;
export declare const CONTEXT_VARIABLE_EVALUATE_NAME_PRESENT: any;
export declare const CONTEXT_VARIABLE_IS_READONLY: any;
export declare const CONTEXT_VARIABLE_VALUE: any;
export declare const CONTEXT_VARIABLE_TYPE: any;
export declare const CONTEXT_VARIABLE_INTERFACES: any;
export declare const CONTEXT_VARIABLE_NAME: any;
export declare const CONTEXT_VARIABLE_LANGUAGE: any;
export declare const CONTEXT_VARIABLE_EXTENSIONID: any;
export declare const CONTEXT_EXCEPTION_WIDGET_VISIBLE: any;
export declare const CONTEXT_MULTI_SESSION_REPL: any;
export declare const CONTEXT_MULTI_SESSION_DEBUG: any;
export declare const CONTEXT_DISASSEMBLE_REQUEST_SUPPORTED: any;
export declare const CONTEXT_DISASSEMBLY_VIEW_FOCUS: any;
export declare const CONTEXT_LANGUAGE_SUPPORTS_DISASSEMBLE_REQUEST: any;
export declare const CONTEXT_FOCUSED_STACK_FRAME_HAS_INSTRUCTION_POINTER_REFERENCE: any;
export declare const debuggerDisabledMessage: (debugType: string) => any;
...
export declare const IDebugService: any;
