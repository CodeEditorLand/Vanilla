var g=Object.defineProperty;var v=Object.getOwnPropertyDescriptor;var l=(r,i,t,e)=>{for(var o=e>1?void 0:e?v(i,t):i,s=r.length-1,n;s>=0;s--)(n=r[s])&&(o=(e?n(i,t,o):n(o))||o);return e&&o&&g(i,t,o),o},a=(r,i)=>(t,e)=>i(t,e,r);import{VSBuffer as p}from"../../../../base/common/buffer.js";import{Event as h}from"../../../../base/common/event.js";import{parse as O}from"../../../../base/common/json.js";import"../../../../base/common/lifecycle.js";import{assertIsDefined as T}from"../../../../base/common/types.js";import"../../../../base/common/uri.js";import{FileSystemProviderCapabilities as P,FileType as y,IFileService as D}from"../../../../platform/files/common/files.js";import{IInstantiationService as R}from"../../../../platform/instantiation/common/instantiation.js";import{IStorageService as C,StorageScope as m,StorageTarget as f}from"../../../../platform/storage/common/storage.js";import"../../../common/contributions.js";import{readTrustedDomains as E,TRUSTED_DOMAINS_CONTENT_STORAGE_KEY as d,TRUSTED_DOMAINS_STORAGE_KEY as F}from"./trustedDomains.js";const b="trustedDomains",_={type:y.File,ctime:Date.now(),mtime:Date.now(),size:0},u=`// Links matching one or more entries in the list below can be opened without link protection.
