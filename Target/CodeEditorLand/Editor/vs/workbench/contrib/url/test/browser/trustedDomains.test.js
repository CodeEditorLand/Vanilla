...
suite("Link protection domain matching", () => {
  ...
  test("simple", () => {
    ...
    linkAllowedByRules("https://www.x.org", [
      "https://www.x.org",
      "https://y.org"
    ]);
  });
  ...
  test("sub paths", () => {
    ...
    linkAllowedByRules("https://github.com", [
      "https://github.com/foo/bar",
      "https://github.com"
    ]);
  });
  test("ports", () => {
    linkNotAllowedByRules("https://x.org:8080/foo/bar", [
      "https://x.org:8081/foo"
    ]);
    linkAllowedByRules("https://x.org:8080/foo/bar", [
      "https://x.org:*/foo"
    ]);
    linkAllowedByRules("https://x.org/foo/bar", ["https://x.org:*/foo"]);
    linkAllowedByRules("https://x.org:8080/foo/bar", [
      "https://x.org:8080/foo"
    ]);
  });
  test("ip addresses", () => {
    ...
    linkNotAllowedByRules("http://192.168.1.7:3000/", [
      "http://192.168.*.6:*"
    ]);
    linkAllowedByRules("http://192.168.1.7:3000/", [
