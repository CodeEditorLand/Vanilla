  ...
  properties: {
    ...
    [TerminalSettingId.DefaultLocation]: {
      ...
      enum: [
        ...
        TerminalLocationString.TerminalView
      ],
      enumDescriptions: [
        localize(
    ...
    [TerminalSettingId.ExperimentalWindowsUseConptyDll]: {
      markdownDescription: localize(
        "terminal.integrated.experimentalWindowsUseConptyDll",
        "Whether to use the experimental conpty.dll shipped with VS Code, instead of the one bundled with Windows."
      ),
      type: "boolean",
      default: false
    },
...
__name(registerTerminalConfiguration, "registerTerminalConfiguration");
Registry.as(
  WorkbenchExtensions.ConfigurationMigration
).registerConfigurationMigrations([
  {
    key: TerminalSettingId.EnableBell,
    migrateFn: /* @__PURE__ */ __name((enableBell, accessor) => {
