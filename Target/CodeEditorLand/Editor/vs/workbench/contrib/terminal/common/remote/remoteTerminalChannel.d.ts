...
import { ITerminalLogService, type IProcessDataEvent, type IProcessProperty, type IProcessPropertyMap, type IProcessReadyEvent, type IPtyHostController, type IPtyHostLatencyMeasurement, type IRequestResolveVariablesEvent, type ISerializedTerminalState, type IShellLaunchConfigDto, type ITerminalLaunchError, type ITerminalProcessOptions, type ITerminalProfile, type ITerminalsLayoutInfo, type ITerminalsLayoutInfoById, type ProcessPropertyType, type TerminalIcon, type TitleEventSource } from "../../../../../platform/terminal/common/terminal.js";
