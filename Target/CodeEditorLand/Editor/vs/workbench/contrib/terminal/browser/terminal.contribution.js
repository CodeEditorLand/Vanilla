...
if (isWindows) {
  registerSendSequenceKeybinding(
    String.fromCharCode("V".charCodeAt(0) - 64 /* CtrlLetterOffset */),
    {
      // ctrl+v
...
if (isIOS) {
  registerSendSequenceKeybinding(
    String.fromCharCode("C".charCodeAt(0) - 64 /* CtrlLetterOffset */),
    {
      // ctrl+c
...
registerSendSequenceKeybinding(
  String.fromCharCode("W".charCodeAt(0) - 64 /* CtrlLetterOffset */),
  {
...
if (isWindows) {
  registerSendSequenceKeybinding(
    String.fromCharCode("H".charCodeAt(0) - 64 /* CtrlLetterOffset */),
    {
      when: ContextKeyExpr.and(
        TerminalContextKeys.focus,
        ContextKeyExpr.equals(
