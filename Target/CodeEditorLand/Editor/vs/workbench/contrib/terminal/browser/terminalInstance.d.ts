...
import { type IMarkProperties, type ITerminalCommand } from "../../../../platform/terminal/common/capabilities/capabilities.js";
...
import { ITerminalLogService, TerminalExitReason, TerminalLocation, TitleEventSource, type IReconnectionProperties, type IShellLaunchConfig, type ITerminalDimensionsOverride, type ITerminalLaunchError, type TerminalIcon, type TerminalShellType } from "../../../../platform/terminal/common/terminal.js";
...
import { ITerminalConfigurationService, type IRequestAddInstanceToGroupEvent, type ITerminalContribution, type ITerminalInstance, type IXtermColorProvider } from "./terminal.js";
...
declare enum TerminalLabelType {
    Title = "title",
