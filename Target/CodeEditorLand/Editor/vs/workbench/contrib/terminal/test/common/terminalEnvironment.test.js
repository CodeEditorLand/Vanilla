...
suite("Workbench - TerminalEnvironment", () => {
  ...
  suite("shouldSetLangEnvVariable", () => {
    test("auto", () => {
      ...
      strictEqual(
        shouldSetLangEnvVariable({ LANG: "en-US" }, "auto"),
        true
      );
      strictEqual(
    ...
    test("off", () => {
      ...
      strictEqual(
        shouldSetLangEnvVariable({ LANG: "en-US" }, "off"),
        false
      );
      strictEqual(
    ...
    test("on", () => {
      ...
      strictEqual(
        shouldSetLangEnvVariable({ LANG: "en-US" }, "on"),
        true
      );
      strictEqual(
    ...
    const wslPathBackend = {
      getWslPath: async (original, direction) => {
        if (direction === "unix-to-win") {
          const match2 = original.match(
            /^\/mnt\/(?<drive>[a-zA-Z])\/(?<path>.+)$/
          );
  ...
  suite("createTerminalEnvironment", () => {
    ...
    test("should retain variables equal to the empty string", async () => {
      deepStrictEqual(
        await createTerminalEnvironment(
          {},
          void 0,
          void 0,
          void 0,
