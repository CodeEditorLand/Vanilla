...
class MockTerminalProfileService {
  static {
    __name(this, "MockTerminalProfileService");
  }
  hasRefreshedProfiles;
  _defaultProfileName;
  availableProfiles = [];
...
class TestTerminalInstanceService {
  ...
  async getBackend(remoteAuthority) {
    return {
      getProfiles: /* @__PURE__ */ __name(async () => {
...
suite("TerminalProfileService", () => {
  ...
  setup(async () => {
    ...
    environmentService = { remoteAuthority: void 0 };
  ...
  suite("Contributed Profiles", () => {
    test("should filter out contributed profiles set to null (Linux)", async () => {
      ...
      configurationService.onDidChangeConfigurationEmitter.fire({ affectsConfiguration: /* @__PURE__ */ __name(() => true, "affectsConfiguration"), source: ConfigurationTarget.USER });
