...
suite("Workbench - TerminalConfigurationService", () => {
  ...
  suite("config", () => {
    test("should update on any change to terminal.integrated", () => {
      ...
      configurationService.onDidChangeConfigurationEmitter.fire({
        affectsConfiguration: /* @__PURE__ */ __name((configuration) => configuration.startsWith("terminal.integrated"), "affectsConfiguration"),
  ...
  __name(createTerminalConfigationService, "createTerminalConfigationService");
  suite("getFont", () => {
    test("fontFamily", () => {
...
//# sourceMappingURL=terminalConfigurationService.test.js.map
