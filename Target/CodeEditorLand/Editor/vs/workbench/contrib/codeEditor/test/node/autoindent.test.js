...
suite('Auto-Reindentation - TypeScript/JavaScript', () => {
	...
	test('Issue #29886', () => {
		...
		// explanation: Positive lookahead: (?= \xABpattern\xBB) matches if pattern matches what comes after the current location in the input string.
		// Negative lookahead: (?! \xABpattern\xBB) matches if pattern does not match what comes after the current location in the input string
