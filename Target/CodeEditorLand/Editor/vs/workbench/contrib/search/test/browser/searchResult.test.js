...
suite("SearchResult", () => {
  ...
  __name(aSearchResult, "aSearchResult");
  ...
  __name(aRawFileMatchWithCells, "aRawFileMatchWithCells");
  ...
  __name(getPopulatedSearchResult, "getPopulatedSearchResult");
