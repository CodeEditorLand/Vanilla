...
let SearchView = class extends ViewPane {
  ...
  async setAIResultsVisible(visible) {
    ...
    if (visible) {
      ...
      if (this._stashedQueryDetailsVisibility) {
        this.toggleQueryDetails(void 0, this._stashedQueryDetailsVisibility);
      }
    }
    ...
    }, void 0, void 0, this.viewModel.searchResult.getCachedSearchComplete(visible));
  }
  get state() {
  ...
  async replaceSearchModel(searchModel, asyncResults) {
    ...
    asyncResults.then((complete) => {
      ...
      this.onSearchComplete(progressComplete, void 0, void 0, complete);
    }, (e) => {
      clearTimeout(slowTimer);
