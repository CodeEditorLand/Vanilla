...
let ReplEditor = class extends EditorPane {
  ...
  _updateInputHint() {
    ...
    const shouldHide = !this._codeEditorWidget.hasModel() || this._configurationService.getValue(InteractiveWindowSetting.showExecutionHint) === false || this._codeEditorWidget.getModel().getValueLength() !== 0;
