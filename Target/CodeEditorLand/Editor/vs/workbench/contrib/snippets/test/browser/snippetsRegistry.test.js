...
suite("getNonWhitespacePrefix", () => {
  ...
  function assertGetNonWhitespacePrefix(line, column, expected) {
    const model = {
      getLineContent: /* @__PURE__ */ __name((lineNumber) => line, "getLineContent")
    };
    const actual = getNonWhitespacePrefix(model, new Position(1, column));
    assert.strictEqual(actual, expected);
  }
  __name(assertGetNonWhitespacePrefix, "assertGetNonWhitespacePrefix");
  test("empty line", () => {
...
//# sourceMappingURL=snippetsRegistry.test.js.map
