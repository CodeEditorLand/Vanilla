...
let CodeActionsContribution = class extends Disposable {
  constructor(codeActionsExtensionPoint, keybindingService, languageFeatures) {
    ...
    keybindingService.registerSchemaContribution({
      getSchemaAdditions: /* @__PURE__ */ __name(() => this.getSchemaAdditions(), "getSchemaAdditions"),
  ...
  getSchemaAdditions() {
    const conditionalSchema = /* @__PURE__ */ __name((command, actions) => {
      return {
        if: {
          required: ["command"],
          properties: {
    ...
    const getActions = /* @__PURE__ */ __name((ofKind) => {
