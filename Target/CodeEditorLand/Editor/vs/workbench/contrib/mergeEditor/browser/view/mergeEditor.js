...
let MergeEditor = class extends AbstractTextEditor {
  ...
  baseView = observableValue(this, void 0);
  ...
  _layoutModeObs = observableValue(this, this._layoutMode.value);
  ...
  showNonConflictingChanges = observableValue(this, this.showNonConflictingChangesStore.get() ?? false);
