...
import {
  ...
  PreTrie,
  SufTrie
} from "../../common/explorerFileNestingTrie.js";
...
suite("SufTrie", () => {
  ...
  test("multiMatches", () => {
    ...
    assert.deepStrictEqual(t.get("npmrc", fakeFilenameAttributes), []);
    assert.deepStrictEqual(t.get(".npmrcs", fakeFilenameAttributes), []);
    assert.deepStrictEqual(t.get(".json", fakeFilenameAttributes), [
      "Key2"
    ]);
    assert.deepStrictEqual(t.get("a.json", fakeFilenameAttributes), [
      "Key2"
    ]);
    assert.deepStrictEqual(t.get("a.npmrc", fakeFilenameAttributes), [
      "Key1"
...
suite("PreTrie", () => {
  ...
  test("emptyMatches", () => {
    ...
    assert.deepStrictEqual(t.get("package.json", fakeFilenameAttributes), [
      "package"
    ]);
    assert.deepStrictEqual(t.get("packagejson", fakeFilenameAttributes), [
      "package"
    ]);
    assert.deepStrictEqual(
      t.get("package-lock.json", fakeFilenameAttributes),
      ["package"]
    );
  });
});
suite("StarTrie", () => {
  ...
  const assertMapEquals = (actual, expected) => {
    const actualStr = [...actual.entries()].map(
      (e) => `${e[0]} => [${[...e[1].keys()].join()}]`
    );
    const expectedStr = Object.entries(expected).map(
      (e) => `${e[0]}: [${[e[1]].join()}]`
    );
  ...
  test("does general bidirectional suffix matching", () => {
    ...
    const nesting = t.nest(
      ["a-vsdoc.js", "a.js", "b.js", "b-vscdoc.js"],
      "mydir"
    );
    assertMapEquals(nesting, {
      "a-vsdoc.js": ["a.js"],
  ...
  test("does general bidirectional prefix matching", () => {
    ...
    const nesting = t.nest(
      ["vsdoc-a.js", "a.js", "b.js", "vscdoc-b.js"],
      "mydir"
    );
    assertMapEquals(nesting, {
      "vsdoc-a.js": ["a.js"],
  ...
  test("does general bidirectional general matching", () => {
    ...
    const nesting = t.nest(
      ["foo-a-bar.js", "a.js", "b.js", "bib-b-bap.js"],
      "mydir"
    );
    assertMapEquals(nesting, {
      "foo-a-bar.js": ["a.js"],
  ...
  test("does extension specific path segment matching", () => {
    ...
    const nesting = t.nest(
      ["foo.js", "foo.test.js", "fooTest.js", "bar.js.js"],
      "mydir"
    );
    assertMapEquals(nesting, {
      "foo.js": ["foo.test.js"],
  ...
  test("basename expansion", () => {
    ...
    const nesting1 = t.nest(
      ["boop-vsdoc.js", "boop-vsdoc.doc", "boop.doc"],
      "mydir"
    );
    assertMapEquals(nesting1, {
  ...
  test("dirname matching", () => {
    ...
    const nesting1 = t.nest(
      ["otherFile.ts", "MyComponent.ts", "index.ts"],
      "MyComponent"
    );
    assertMapEquals(nesting1, {
  ...
  test.skip("is fast", () => {
    ...
    const bigFiles = Array.from({ length: 5e4 / 6 }).flatMap((_, i) => [
      "file" + i + ".js",
      "file" + i + ".map",
      "file" + i + ".css",
      "file" + i + ".ts",
