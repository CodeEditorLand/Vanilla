...
suite("Files - View Model", function() {
  ...
  function createStat(path, name, isFolder, hasChildren, size, mtime) {
    return new ExplorerItem(toResource.call(this, path), fileService, configService, NullFilesConfigurationService, void 0, isFolder, false, false, false, name, mtime);
  }
  ...
  test("Merge Local with Disk", function() {
    const merge1 = new ExplorerItem(URI.file(join("C:\\", "/path/to")), fileService, configService, NullFilesConfigurationService, void 0, true, false, false, false, "to", Date.now());
    const merge2 = new ExplorerItem(URI.file(join("C:\\", "/path/to")), fileService, configService, NullFilesConfigurationService, void 0, true, false, false, false, "to", Date.now());
    ExplorerItem.mergeLocalWithDisk(merge2, merge1);
    assert.strictEqual(merge1.mtime, merge2.mtime);
    merge2.addChild(new ExplorerItem(URI.file(join("C:\\", "/path/to/foo.html")), fileService, configService, NullFilesConfigurationService, void 0, true, false, false, false, "foo.html", Date.now()));
    ExplorerItem.mergeLocalWithDisk(merge2, merge1);
    const child = new ExplorerItem(URI.file(join("C:\\", "/path/to/foo.html")), fileService, configService, NullFilesConfigurationService, void 0, true, false, false, false, "foo.html", Date.now());
