...
suite("Files - FileEditorInput", () => {
  ...
  class TestTextEditorService extends TextEditorService {
    static {
      __name(this, "TestTextEditorService");
    }
  ...
  setup(() => {
    instantiationService = workbenchInstantiationService({
      textEditorService: /* @__PURE__ */ __name((instantiationService2) => instantiationService2.createInstance(TestTextEditorService), "textEditorService")
    }, disposables);
