...
} from "./editors/fileEditorHandler.js";
...
let FileUriLabelContribution = class {
  static {
    __name(this, "FileUriLabelContribution");
  }
  static ID = "workbench.contrib.fileUriLabel";
  ...
  properties: {
    ...
    "files.candidateGuessEncodings": {
      ...
      items: {
        ...
        enumDescriptions: Object.keys(GUESSABLE_ENCODINGS).map(
          (key) => GUESSABLE_ENCODINGS[key].labelLong
        )
      },
      default: [],
      markdownDescription: nls.localize(
    ...
    "files.experimentalWatcherNext": {
      // TODO@bpasero decide on default and experiment enlisting
      type: "boolean",
      default: false,
      markdownDescription: nls.localize(
        "experimentalWatcherNext",
        "Enables a newer, experimental version of the file watcher."
      ),
      scope: ConfigurationScope.APPLICATION
    },
  ...
  properties: {
    ...
    "explorer.confirmUndo": {
      ...
      enum: [
        ...
        UndoConfirmLevel.Default,
        UndoConfirmLevel.Light
      ],
      description: nls.localize(
        "confirmUndo",
