...
import { IAsyncDataSource, ITreeDragAndDrop, ITreeDragOverReaction, ITreeFilter, ITreeNode, ITreeSorter, TreeVisibility } from "vs/base/browser/ui/tree/tree";
...
export declare const explorerRootErrorEmitter: any;
...
export declare class FilesRenderer implements ICompressibleTreeRenderer<ExplorerItem, FuzzyScore, IFileTemplateData>, IListAccessibilityProvider<ExplorerItem>, IDisposable {
    ...
    readonly onDidChangeActiveDescendant: any;
