...
let SCMHistoryViewModel = class extends Disposable {
  ...
  historyItemsFilter = observableValue(
    this,
    "auto"
  );
    ...
    this.onDidChangeBodyVisibility(async (visible) => {
      ...
      this._visibilityDisposables.add(
        autorunWithStore((reader, store) => {
          ...
          const historyItemRemoteRefIdSignal = signalFromObservable(
            this,
            derived((reader2) => {
              return historyProvider.historyItemRemoteRef.read(
                reader2
              )?.id;
            })
          );
            ...
            autorunWithStoreHandleChanges(
              {
                ...
                handleChange(context, changeSummary) {
                  changeSummary.refresh = context.didChange(
                    historyItemRemoteRefRevision
                  ) ? "ifScrollTop" : true;
                  return true;
                }
              },
