...
import type { ITextResourcePropertiesService } from "../../../editor/common/services/textResourceConfiguration.js";
import { IConfigurationService } from "../../../platform/configuration/common/configuration.js";
import type { IResourceEditorInput } from "../../../platform/editor/common/editor.js";
import type { IBaseFileStat, IFileStatWithMetadata } from "../../../platform/files/common/files.js";
import { AbstractLoggerService, type ILogger } from "../../../platform/log/common/log.js";
import type { IMarker, IMarkerData, IMarkerService, IResourceMarker, MarkerStatistics } from "../../../platform/markers/common/markers.js";
import type { IProgress, IProgressStep } from "../../../platform/progress/common/progress.js";
import { InMemoryStorageService, type WillSaveStateReason } from "../../../platform/storage/common/storage.js";
import { type ISingleFolderWorkspaceIdentifier, type IWorkspace, type IWorkspaceContextService, type IWorkspaceFolder, type IWorkspaceFoldersChangeEvent, type IWorkspaceFoldersWillChangeEvent, type IWorkspaceIdentifier, WorkbenchState } from "../../../platform/workspace/common/workspace.js";
import { type IWorkspaceTrustEnablementService, type IWorkspaceTrustManagementService, type IWorkspaceTrustRequestService, type IWorkspaceTrustTransitionParticipant, type IWorkspaceTrustUriInfo, type WorkspaceTrustRequestOptions, WorkspaceTrustUriResponse } from "../../../platform/workspace/common/workspaceTrust.js";
import { type GroupIdentifier, type IRevertOptions, type ISaveOptions } from "../../common/editor.js";
import type { EditorInput } from "../../common/editor/editorInput.js";
import type { IActivity, IActivityService } from "../../services/activity/common/activity.js";
import { NullExtensionService } from "../../services/extensions/common/extensions.js";
import type { IAutoSaveConfiguration, IAutoSaveMode } from "../../services/filesConfiguration/common/filesConfigurationService.js";
import type { IHistoryService } from "../../services/history/common/history.js";
import type { IStoredFileWorkingCopySaveEvent } from "../../services/workingCopy/common/storedFileWorkingCopy.js";
import { type IWorkingCopy, type IWorkingCopyBackup, WorkingCopyCapabilities } from "../../services/workingCopy/common/workingCopy.js";
import type { ICopyOperation, ICreateFileOperation, ICreateOperation, IDeleteOperation, IFileOperationUndoRedoInfo, IMoveOperation, IStoredFileWorkingCopySaveParticipant, IStoredFileWorkingCopySaveParticipantContext, IWorkingCopyFileOperationParticipant, IWorkingCopyFileService, WorkingCopyFileEvent } from "../../services/workingCopy/common/workingCopyFileService.js";
