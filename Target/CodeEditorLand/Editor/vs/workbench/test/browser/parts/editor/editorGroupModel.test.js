...
suite("EditorGroupModel", () => {
  ...
  test("isActive - untyped", () => {
    ...
    const input2 = disposables.add(
      new TestFileEditorInput("testInput", URI.file("fake"))
    );
    const input22 = disposables.add(
      new TestFileEditorInput("testInput2", URI.file("fake2"))
    );
    const untypedInput = {
      resource: URI.file("/fake"),
      options: { override: "testInput" }
    };
  ...
  test("openEditor - prefers existing side by side editor if same", () => {
    ...
    const input1 = disposables.add(
      new TestFileEditorInput("testInput", URI.file("fake1"))
    );
    const input2 = disposables.add(
      new TestFileEditorInput("testInput", URI.file("fake2"))
    );
    const sideBySideInputSame = instantiationService.createInstance(
    ...
    const sideBySideInputDifferent = instantiationService.createInstance(
      SideBySideEditorInput,
      void 0,
      void 0,
      input1,
    ...
    let res = group.openEditor(sideBySideInputSame, {
      pinned: true,
      active: true
    });
    ...
    res = group.openEditor(sideBySideInputDifferent, {
      pinned: true,
      active: true
    });
  ...
  test("contains() - untyped", () => {
    ...
    const untypedInput1 = {
      resource: URI.file("/input1"),
      options: { override: "input1" }
    };
    const untypedInput2 = {
      resource: URI.file("/input2"),
      options: { override: "input2" }
    };
    const diffInput1 = instantiationService.createInstance(
      DiffEditorInput,
      "name",
      "description",
      input1,
    ...
    const diffInput2 = instantiationService.createInstance(
      DiffEditorInput,
      "name",
      "description",
      input2,
    ...
    assert.strictEqual(
      group.contains(untypedInput1, { strictEquals: true }),
      false
    );
    assert.strictEqual(
      group.contains(untypedInput1, {
        supportSideBySide: SideBySideEditor.ANY
      }),
      true
    );
    ...
    assert.strictEqual(
      group.contains(untypedInput2, { strictEquals: true }),
      false
    );
    assert.strictEqual(
      group.contains(untypedInput2, {
        supportSideBySide: SideBySideEditor.ANY
      }),
      false
    );
    ...
    group.closeEditor(sideBySideInputSame);
    assert.strictEqual(group.count, 0);
    group.openEditor(sideBySideInputDifferent, {
      pinned: true,
      active: true
    });
    assert.strictEqual(
      group.contains(untypedSideBySideInputDifferent),
      true
    );
    assert.strictEqual(
      group.contains(untypedInput1, {
  ...
  test("contains()", () => {
    ...
    assert.strictEqual(
      group.contains(input1, { strictEquals: true }),
      true
    );
    assert.strictEqual(
      group.contains(input1, { supportSideBySide: SideBySideEditor.ANY }),
      true
    );
    assert.strictEqual(group.contains(input2), false);
    assert.strictEqual(
      group.contains(input2, { strictEquals: true }),
      false
    );
    assert.strictEqual(
      group.contains(input2, { supportSideBySide: SideBySideEditor.ANY }),
      false
    );
  ...
  test("group serialization", () => {
    ...
    assert.strictEqual(
      deserialized.getEditors(EditorsOrder.SEQUENTIAL).length,
      3
    );
    assert.strictEqual(
      deserialized.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE).length,
      3
    );
  ...
  test("group serialization (sticky editor)", () => {
    inst().invokeFunction(
      (accessor) => Registry.as(
        EditorExtensions.EditorFactory
      ).start(accessor)
  ...
  test("group serialization (locked group)", () => {
    const group = createEditorGroupModel();
  ...
  test("One Editor", () => {
    ...
    assert.strictEqual(group.count, 0);
    assert.strictEqual(
      group.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE).length,
      0
    );
    const input1 = input();
    const { editor: openedEditor, isNew } = group.openEditor(input1, {
      active: true,
      pinned: true
    });
    ...
    assert.strictEqual(
      events.closed[0].context === EditorCloseContext.UNPIN,
      true
    );
    const input2 = input();
    ...
    assert.strictEqual(
      events.closed[1].context === EditorCloseContext.REPLACE,
      false
    );
  ...
  test("Multiple Editors - Pinned and Active", () => {
    const group = createEditorGroupModel();
    const events = groupListener(group);
  ...
  test("Multiple Editors - Preview editor moves to the side of the active one", () => {
    const group = createEditorGroupModel();
    const input1 = input();
    const input2 = input();
    const input3 = input();
    ...
    assert.strictEqual(
      input3,
      group.getEditors(EditorsOrder.SEQUENTIAL)[2]
    );
    const input4 = input();
  ...
  test("Multiple Editors - Pinned and Active (DEFAULT_OPEN_EDITOR_DIRECTION = Direction.LEFT)", () => {
    ...
    const group = disposables.add(
      inst2.createInstance(EditorGroupModel, void 0)
    );
    const events = groupListener(group);
    const input1 = input();
    const input2 = input();
    ...
    group.openEditor(input3, { pinned: true, active: true });
    assert.strictEqual(
      group.getEditors(EditorsOrder.SEQUENTIAL)[0],
      input3
    );
    assert.strictEqual(
      group.getEditors(EditorsOrder.SEQUENTIAL)[1],
      input2
    );
    assert.strictEqual(
      group.getEditors(EditorsOrder.SEQUENTIAL)[2],
  ...
  test("Multiple Editors - Pinned and Not Active", () => {
    const group = createEditorGroupModel();
    const input1 = input();
    const input2 = input();
    const input3 = input();
  ...
  test("Multiple Editors - Preview gets overwritten", () => {
    const group = createEditorGroupModel();
    const events = groupListener(group);
    const input1 = input();
    const input2 = input();
    ...
    assert.strictEqual(events.closed[1].editor, input2);
    assert.strictEqual(
      events.closed[0].context === EditorCloseContext.REPLACE,
      true
    );
    assert.strictEqual(
      events.closed[1].context === EditorCloseContext.REPLACE,
  ...
  test("Multiple Editors - set active", () => {
    const group = createEditorGroupModel();
    const events = groupListener(group);
    const input1 = input();
    const input2 = input();
  ...
  test("Multiple Editors - pin and unpin", () => {
    const group = createEditorGroupModel();
    const events = groupListener(group);
    const input1 = input();
    const input2 = input();
  ...
  test("Multiple Editors - closing picks next from MRU list", () => {
    const group = createEditorGroupModel();
    const events = groupListener(group);
    const input1 = input();
    const input2 = input();
    ...
    assert.strictEqual(
      group.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[0],
      input5
    );
  ...
  test("Multiple Editors - closing picks next to the right", () => {
    const inst2 = new TestInstantiationService();
    inst2.stub(IStorageService, disposables.add(new TestStorageService()));
    inst2.stub(
      ILifecycleService,
    ...
    const config = new TestConfigurationService();
    config.setUserConfiguration("workbench", {
      editor: { focusRecentEditorAfterClose: false }
    });
    inst2.stub(IConfigurationService, config);
    const group = disposables.add(
      inst2.createInstance(EditorGroupModel, void 0)
  ...
  test("Multiple Editors - move editor", () => {
    const group = createEditorGroupModel();
    const events = groupListener(group);
    const input1 = input();
    const input2 = input();
    ...
    assert.strictEqual(
      group.getEditors(EditorsOrder.SEQUENTIAL)[3],
      input3
    );
    assert.strictEqual(
      group.getEditors(EditorsOrder.SEQUENTIAL)[4],
      input5
    );
  ...
  test("Multiple Editors - move editor across groups", () => {
    ...
    assert.strictEqual(
      group1.getEditors(EditorsOrder.SEQUENTIAL)[0],
      g1_input1
    );
    assert.strictEqual(
      group1.getEditors(EditorsOrder.SEQUENTIAL)[1],
      g2_input1
    );
    assert.strictEqual(
      group1.getEditors(EditorsOrder.SEQUENTIAL)[2],
      g1_input2
    );
  });
  test("Multiple Editors - move editor across groups (input already exists in group 1)", () => {
    const group1 = createEditorGroupModel();
    const group2 = createEditorGroupModel();
    const g1_input1 = input();
    const g1_input2 = input();
  ...
  test("Multiple Editors - Pinned & Non Active", () => {
    const group = createEditorGroupModel();
    const input1 = input();
    group.openEditor(input1);
    assert.strictEqual(group.activeEditor, input1);
  ...
  test("Multiple Editors - Close Others, Close Left, Close Right", () => {
    const group = createEditorGroupModel();
    const input1 = input();
    const input2 = input();
    const input3 = input();
  ...
  test("Multiple Editors - real user example", () => {
    const group = createEditorGroupModel();
    ...
    openedEditor = group.openEditor(testJs, {
      active: true,
      pinned: true
    }).editor;
    ...
    assert.ok(
      group.getEditors(EditorsOrder.SEQUENTIAL)[2].matches(indexHtml)
    );
  ...
  test("Single Group, Single Editor - persist", () => {
    const inst2 = new TestInstantiationService();
    inst2.stub(IStorageService, disposables.add(new TestStorageService()));
    inst2.stub(IWorkspaceContextService, new TestContextService());
    ...
    assert.strictEqual(group.isActive(input1), true);
    group = disposables.add(
      inst2.createInstance(EditorGroupModel, group.serialize())
    );
    assert.strictEqual(group.count, 1);
    assert.strictEqual(group.activeEditor.matches(input1), true);
    assert.strictEqual(group.previewEditor.matches(input1), true);
  ...
  test("Multiple Groups, Multiple editors - persist", () => {
    const inst2 = new TestInstantiationService();
    inst2.stub(IStorageService, disposables.add(new TestStorageService()));
    inst2.stub(IWorkspaceContextService, new TestContextService());
    const lifecycle = disposables.add(new TestLifecycleService());
    ...
    assert.strictEqual(
      group1.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[0].matches(g1_input2),
      true
    );
    assert.strictEqual(
      group1.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[1].matches(g1_input3),
      true
    );
    assert.strictEqual(
      group1.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[2].matches(g1_input1),
      true
    );
    assert.strictEqual(
      group2.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[0].matches(g2_input1),
      true
    );
    assert.strictEqual(
      group2.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[1].matches(g2_input3),
      true
    );
    assert.strictEqual(
      group2.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[2].matches(g2_input2),
      true
    );
    group1 = disposables.add(
      inst2.createInstance(EditorGroupModel, group1.serialize())
    );
    group2 = disposables.add(
      inst2.createInstance(EditorGroupModel, group2.serialize())
    );
    assert.strictEqual(group1.count, 3);
    assert.strictEqual(group2.count, 3);
    assert.strictEqual(group1.activeEditor.matches(g1_input2), true);
  ...
  test("Single group, multiple editors - persist (some not persistable)", () => {
    const inst2 = new TestInstantiationService();
    inst2.stub(IStorageService, disposables.add(new TestStorageService()));
    inst2.stub(IWorkspaceContextService, new TestContextService());
    const lifecycle = disposables.add(new TestLifecycleService());
    ...
    group.openEditor(nonSerializableInput2, {
      active: true,
      pinned: false
    });
    ...
    assert.strictEqual(group.count, 3);
    assert.strictEqual(
      group.activeEditor.matches(nonSerializableInput2),
      true
    );
    assert.strictEqual(
      group.previewEditor.matches(nonSerializableInput2),
      true
    );
    assert.strictEqual(
      group.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[0].matches(nonSerializableInput2),
      true
    );
    assert.strictEqual(
      group.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[1].matches(serializableInput2),
      true
    );
    assert.strictEqual(
      group.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[2].matches(serializableInput1),
      true
    );
    group = disposables.add(
      inst2.createInstance(EditorGroupModel, group.serialize())
    ...
    assert.strictEqual(group.count, 2);
    assert.strictEqual(
      group.activeEditor.matches(serializableInput2),
      true
    );
    assert.strictEqual(group.previewEditor, null);
    assert.strictEqual(
      group.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[0].matches(serializableInput2),
      true
    );
    assert.strictEqual(
      group.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE)[1].matches(serializableInput1),
      true
    );
    inst2.dispose();
  });
  test("Single group, multiple editors - persist (some not persistable, sticky editors)", () => {
    const inst2 = new TestInstantiationService();
    inst2.stub(IStorageService, disposables.add(new TestStorageService()));
    inst2.stub(IWorkspaceContextService, new TestContextService());
    const lifecycle = disposables.add(new TestLifecycleService());
  ...
  test("Multiple groups, multiple editors - persist (some not persistable, causes empty group)", () => {
    const inst2 = new TestInstantiationService();
    inst2.stub(IStorageService, disposables.add(new TestStorageService()));
    inst2.stub(IWorkspaceContextService, new TestContextService());
    const lifecycle = disposables.add(new TestLifecycleService());
    ...
    assert.strictEqual(
      group1.getEditors(EditorsOrder.SEQUENTIAL)[0].matches(serializableInput1),
      true
    );
    assert.strictEqual(
      group1.getEditors(EditorsOrder.SEQUENTIAL)[1].matches(serializableInput2),
      true
    );
    inst2.dispose();
  });
  test("Multiple Editors - Editor Dispose", () => {
    const group1 = createEditorGroupModel();
    const group2 = createEditorGroupModel();
  ...
  test("Preview tab does not have a stable position (https://github.com/microsoft/vscode/issues/8245)", () => {
    const group1 = createEditorGroupModel();
    const input1 = input();
    const input2 = input();
    const input3 = input();
  ...
  test("Multiple Editors - Editor Emits Dirty and Label Changed", () => {
    const group1 = createEditorGroupModel();
    const group2 = createEditorGroupModel();
    const input1 = input();
    const input2 = input();
  ...
  test("Sticky Editors", () => {
    ...
    assert.strictEqual(
      group.getEditors(EditorsOrder.SEQUENTIAL, { excludeSticky: true }).length,
      3
    );
    assert.strictEqual(
      group.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE).length,
    ...
    assert.strictEqual(
      group.getEditors(EditorsOrder.MOST_RECENTLY_ACTIVE, {
        excludeSticky: true
      }).length,
      3
    );
    ...
    let sequentialEditorsExcludingSticky = group.getEditors(
    ...
    let mruEditorsExcludingSticky = group.getEditors(
      EditorsOrder.MOST_RECENTLY_ACTIVE,
      { excludeSticky: true }
    );
    ...
    assert.strictEqual(sequentialAllEditors.length, 3);
    sequentialEditorsExcludingSticky = group.getEditors(
      EditorsOrder.SEQUENTIAL,
      { excludeSticky: true }
    );
    ...
    assert.strictEqual(mruAllEditors.length, 3);
    mruEditorsExcludingSticky = group.getEditors(
      EditorsOrder.MOST_RECENTLY_ACTIVE,
      { excludeSticky: true }
    );
  ...
  test("Sticky/Unsticky Editors sends correct editor index", () => {
    const group = createEditorGroupModel();
    const input1 = input();
    const input2 = input();
    const input3 = input();
  ...
  test("onDidMoveEditor Event", () => {
    ...
    group1.openEditor(input1group1, {
      pinned: true,
      active: true,
      index: 0
    });
    group1.openEditor(input2group1, {
      pinned: true,
      active: false,
      index: 1
    });
    group2.openEditor(input1group2, {
      pinned: true,
      active: true,
      index: 0
    });
    group2.openEditor(input2group2, {
      pinned: true,
      active: false,
      index: 1
    });
  ...
  test("moving editor sends sticky event when sticky changes", () => {
    ...
    group1.openEditor(input3group1, {
      pinned: true,
      active: false,
      index: 2
    });
    ...
    group2.openEditor(input3group2, {
      pinned: true,
      active: false,
      index: 2
    });
  ...
  test("editor selection: openEditor with inactive selection", () => {
    ...
    group.openEditor(input2, {
      active: true,
      inactiveSelection: [input3, input1]
    });
    assertSelection(group, input2, [input1, input2, input3]);
    group.openEditor(input1, {
      active: true,
      inactiveSelection: [input3, input1, input3]
    });
    ...
    group.openEditor(input4, {
      pinned: true,
      active: false,
      inactiveSelection: [input2],
      index: 3
    });
    assertSelection(group, input1, [input1, input2]);
    const input5 = input();
    group.openEditor(input5, {
      pinned: true,
      active: true,
      inactiveSelection: [input4],
      index: 4
    });
