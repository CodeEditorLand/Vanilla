...
suite("Resolving Editor Commands Context", () => {
  ...
  async function createServices() {
    const instantiationService2 = workbenchInstantiationService(void 0, disposables);
    const part = await createEditorPart(instantiationService2, disposables);
    instantiationService2.stub(IEditorGroupsService, part);
    const editorService = disposables.add(instantiationService2.createInstance(EditorService, void 0));
  ...
  test("use editor group selection", async () => {
    ...
    const resolvedContext1 = resolveCommandsContext([editorCommandContext], accessor2.editorService, accessor2.editorGroupService, testListService);
    ...
    const resolvedContext2 = resolveCommandsContext([input2.resource], accessor2.editorService, accessor2.editorGroupService, testListService);
    ...
    const resolvedContext3 = resolveCommandsContext([editor1CommandContext], accessor2.editorService, accessor2.editorGroupService, testListService);
  ...
  test("don't use editor group selection", async () => {
    ...
    assert.strictEqual(resolvedContext1.preserveFocus, true);
    const resolvedContext2 = resolveCommandsContext([input3.resource], accessor2.editorService, accessor2.editorGroupService, testListService);
    assert.strictEqual(resolvedContext2.groupedEditors.length, 1);
    assert.strictEqual(resolvedContext2.groupedEditors[0].group.id, activeGroup.id);
  ...
  test("inactive edior group command context", async () => {
    ...
    const resolvedContext1 = resolveCommandsContext([editorCommandContext1], accessor2.editorService, accessor2.editorGroupService, testListService);
    assert.strictEqual(resolvedContext1.groupedEditors.length, 1);
    ...
    const resolvedContext2 = resolveCommandsContext([editorCommandContext2], accessor2.editorService, accessor2.editorGroupService, testListService);
    assert.strictEqual(resolvedContext2.groupedEditors.length, 1);
...
//# sourceMappingURL=editorCommandsContext.test.js.map
