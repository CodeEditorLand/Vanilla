...
suite("EditorInput", () => {
  ...
  const stripOverrides = /* @__PURE__ */ __name(() => {
  ...
  test("Untpyed inputs properly match TextResourceEditorInput", () => {
    const textResourceEditorInput = instantiationService.createInstance(TextResourceEditorInput, testResource, void 0, void 0, void 0, void 0);
  ...
  test("Untyped inputs properly match FileEditorInput", () => {
    const fileEditorInput = instantiationService.createInstance(FileEditorInput, testResource, void 0, void 0, void 0, void 0, void 0, void 0);
  ...
  test("Untyped inputs properly match MergeEditorInput", () => {
    const mergeData = { uri: testResource, description: void 0, detail: void 0, title: void 0 };
  ...
  test("Untyped inputs properly match DiffEditorInput", () => {
    const fileEditorInput1 = instantiationService.createInstance(FileEditorInput, testResource, void 0, void 0, void 0, void 0, void 0, void 0);
    const fileEditorInput2 = instantiationService.createInstance(FileEditorInput, testResource, void 0, void 0, void 0, void 0, void 0, void 0);
    const diffEditorInput = instantiationService.createInstance(DiffEditorInput, void 0, void 0, fileEditorInput1, fileEditorInput2, false);
