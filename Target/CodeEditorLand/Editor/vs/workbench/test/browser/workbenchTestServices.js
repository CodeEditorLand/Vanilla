...
__name(createFileEditorInput, "createFileEditorInput");
Registry.as(EditorExtensions.EditorFactory).registerFileEditorFactory({
  typeId: FILE_EDITOR_INPUT_ID,
  createFileEditor: /* @__PURE__ */ __name((resource, preferredResource, preferredName, preferredDescription, preferredEncoding, preferredLanguageId, preferredContents, instantiationService) => {
  ...
  isFileEditor: /* @__PURE__ */ __name((obj) => {
    return obj instanceof FileEditorInput;
  }, "isFileEditor")
});
class TestTextResourceEditor extends TextResourceEditor {
  static {
    __name(this, "TestTextResourceEditor");
  }
...
class TestTextFileEditor extends TextFileEditor {
  static {
    __name(this, "TestTextFileEditor");
  }
  createEditorControl(parent, configuration) {
...
class TestWorkingCopyService extends WorkingCopyService {
  static {
    __name(this, "TestWorkingCopyService");
  }
...
let TestTextFileService = class extends BrowserTextFileService {
  static {
    __name(this, "TestTextFileService");
  }
...
class TestBrowserTextFileServiceWithEncodingOverrides extends BrowserTextFileService {
  static {
    __name(this, "TestBrowserTextFileServiceWithEncodingOverrides");
  }
  _testEncoding;
  get encoding() {
...
class TestEncodingOracle extends EncodingOracle {
  static {
    __name(this, "TestEncodingOracle");
  }
...
class TestEnvironmentServiceWithArgs extends BrowserWorkbenchEnvironmentService {
  static {
    __name(this, "TestEnvironmentServiceWithArgs");
  }
  args = [];
}
...
class TestProgressService {
  static {
    __name(this, "TestProgressService");
  }
...
class TestDecorationsService {
  static {
    __name(this, "TestDecorationsService");
  }
...
let TestFileDialogService = class {
  ...
  static {
    __name(this, "TestFileDialogService");
  }
  confirmResult;
...
class TestPaneCompositeService extends Disposable {
  static {
    __name(this, "TestPaneCompositeService");
  }
...
class TestEditorGroupsService {
  ...
  static {
    __name(this, "TestEditorGroupsService");
  }
  parts = [this];
...
class TestEditorGroupView {
  ...
  static {
    __name(this, "TestEditorGroupView");
  }
  windowId = mainWindow.vscodeWindowId;
  groupsView = void 0;
  activeEditorPane;
...
class TestEditorGroupAccessor {
  static {
    __name(this, "TestEditorGroupAccessor");
  }
  label = "";
  windowId = mainWindow.vscodeWindowId;
  groups = [];
...
class TestFileService {
  ...
  async activateProvider(_scheme) {
    this._onWillActivateFileSystemProvider.fire({ scheme: _scheme, join: /* @__PURE__ */ __name(() => {
    }, "join") });
  }
...
class TestWorkingCopyBackupService extends InMemoryWorkingCopyBackupService {
  static {
    __name(this, "TestWorkingCopyBackupService");
  }
...
class TestLifecycleService extends Disposable {
  static {
    __name(this, "TestLifecycleService");
  }
  usePhases = false;
  _phase;
  get phase() {
...
class TestBeforeShutdownEvent {
  static {
    __name(this, "TestBeforeShutdownEvent");
  }
  value;
  finalValue;
...
class TestWillShutdownEvent {
  static {
    __name(this, "TestWillShutdownEvent");
  }
  value = [];
  joiners = /* @__PURE__ */ __name(() => [], "joiners");
  reason = ShutdownReason.CLOSE;
...
class TestTextResourceConfigurationService {
  ...
  static {
    __name(this, "TestTextResourceConfigurationService");
  }
...
class TestInMemoryFileSystemProvider extends InMemoryFileSystemProvider {
  static {
    __name(this, "TestInMemoryFileSystemProvider");
  }
  get capabilities() {
...
class TestFilesConfigurationService extends FilesConfigurationService {
  static {
    __name(this, "TestFilesConfigurationService");
  }
...
class TestReadonlyTextFileEditorModel extends TextFileEditorModel {
  static {
    __name(this, "TestReadonlyTextFileEditorModel");
  }
  isReadonly() {
    return true;
  }
...
function registerTestEditor(id, inputs, serializerInputId) {
  ...
  if (serializerInputId) {
    class EditorsObserverTestEditorInputSerializer {
      static {
        __name(this, "EditorsObserverTestEditorInputSerializer");
      }
...
__name(registerTestEditor, "registerTestEditor");
...
__name(registerTestFileEditor, "registerTestFileEditor");
...
__name(registerTestResourceEditor, "registerTestResourceEditor");
...
__name(registerTestSideBySideEditor, "registerTestSideBySideEditor");
...
class TestSingletonFileEditorInput extends TestFileEditorInput {
  static {
    __name(this, "TestSingletonFileEditorInput");
  }
  get capabilities() {
...
__name(createEditorParts, "createEditorParts");
...
__name(createEditorPart, "createEditorPart");
class TestListService {
  static {
    __name(this, "TestListService");
  }
...
__name(getLastResolvedFileStat, "getLastResolvedFileStat");
class TestWorkspacesService {
  static {
    __name(this, "TestWorkspacesService");
  }
  _serviceBrand;
...
class TestTerminalEditorService {
  static {
    __name(this, "TestTerminalEditorService");
  }
  _serviceBrand;
  activeInstance;
  instances = [];
...
class TestTerminalGroupService {
  static {
    __name(this, "TestTerminalGroupService");
  }
  _serviceBrand;
  activeInstance;
  instances = [];
...
class TestTerminalProfileService {
  static {
    __name(this, "TestTerminalProfileService");
  }
  _serviceBrand;
  availableProfiles = [];
  contributedProfiles = [];
...
class TestTerminalProfileResolverService {
  static {
    __name(this, "TestTerminalProfileResolverService");
  }
  _serviceBrand;
  defaultProfileName = "";
...
class TestTerminalConfigurationService extends TerminalConfigurationService {
  static {
    __name(this, "TestTerminalConfigurationService");
  }
  get fontMetrics() {
...
class TestQuickInputService {
  static {
    __name(this, "TestQuickInputService");
  }
  onShow = Event.None;
  onHide = Event.None;
...
class TestLanguageDetectionService {
  static {
    __name(this, "TestLanguageDetectionService");
  }
...
class TestRemoteAgentService {
  static {
    __name(this, "TestRemoteAgentService");
  }
  getConnection() {
    return null;
  }
...
class TestRemoteExtensionsScannerService {
  static {
    __name(this, "TestRemoteExtensionsScannerService");
  }
...
class TestWorkbenchExtensionEnablementService {
  static {
    __name(this, "TestWorkbenchExtensionEnablementService");
  }
  _serviceBrand;
...
class TestWorkbenchExtensionManagementService {
  static {
    __name(this, "TestWorkbenchExtensionManagementService");
  }
  _serviceBrand;
...
class TestUserDataProfileService {
  static {
    __name(this, "TestUserDataProfileService");
  }
  _serviceBrand;
  onDidChangeCurrentProfile = Event.None;
  currentProfile = toUserDataProfile("test", "test", URI.file("tests").with({ scheme: "vscode-tests" }), URI.file("tests").with({ scheme: "vscode-tests" }));
...
class TestWebExtensionsScannerService {
  static {
    __name(this, "TestWebExtensionsScannerService");
  }
  _serviceBrand;
  onDidChangeProfile = Event.None;
...
__name(workbenchTeardown, "workbenchTeardown");
export {
